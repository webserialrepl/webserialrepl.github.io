var un=Object.defineProperty;var pn=(e,t,i)=>t in e?un(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var de=(e,t,i)=>(pn(e,typeof t!="symbol"?t+"":t,i),i);import{e as ts,K as fn,a as gn}from"./monaco-editor.6e4fa376.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))s(c);new MutationObserver(c=>{for(const g of c)if(g.type==="childList")for(const b of g.addedNodes)b.tagName==="LINK"&&b.rel==="modulepreload"&&s(b)}).observe(document,{childList:!0,subtree:!0});function i(c){const g={};return c.integrity&&(g.integrity=c.integrity),c.referrerpolicy&&(g.referrerPolicy=c.referrerpolicy),c.crossorigin==="use-credentials"?g.credentials="include":c.crossorigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(c){if(c.ep)return;c.ep=!0;const g=i(c);fetch(c.href,g)}})();class mn{constructor(t,i){de(this,"device");de(this,"terminal");de(this,"selectedFile",null);de(this,"fileTreeDisplayed",!1);de(this,"files",[]);this.device=t,this.terminal=i}async initialize(){document.addEventListener("REPL_STATUS_CHANGED",async t=>{const i=document.getElementById("refreshFileList"),s=document.getElementById("saveFileButton"),c=document.getElementById("newFileButton"),g=document.getElementById("runCodeButton"),b=t,{status:r}=b.detail,o=[i,s,c,g];r==="REPL"?(console.log("<REPL> mode activated"),this.fileTreeDisplayed||await this.fileList(),o.forEach(u=>u.disabled=!1)):o.forEach(u=>u.disabled=!0)}),this.disableAllButtons()}disableAllButtons(){const t=document.getElementById("refreshFileList"),i=document.getElementById("saveFileButton"),s=document.getElementById("newFileButton"),c=document.getElementById("runCodeButton");t.disabled=!0,i.disabled=!0,s.disabled=!0,c.disabled=!0;const g=document.getElementById("file-tree");if(g)for(;g.firstChild;)g.removeChild(g.firstChild);this.fileTreeDisplayed=!1}async fileList(){const t=document.getElementById("file-tree");!t||(this.files=await this.device.getPyFileList(),t.innerHTML="",this.files.forEach(i=>{const s=document.createElement("sl-tree-item");s.textContent=i,s.value=i,t.appendChild(s)}),this.fileTreeDisplayed=!0)}fileExists(t){return this.files.includes(t)}async fileRead(t){try{const i=await this.device.readFile(t);return new TextDecoder("utf-8").decode(i)}catch(i){console.error(`Error reading file ${t}:`,i);try{this.terminal.logToTerminal(`Error reading file "${t}": ${String(i)}`,"error")}catch{}return null}}async fileWrite(t,i){const s=new TextEncoder().encode(i);try{await this.device.writeFile(t,s),console.log(`File saved: ${t}`),this.terminal.logToTerminal(`File saved successfully: ${t}`,"info")}catch(c){const g=c;console.error(`Error saving file ${this.selectedFile}:`,g),this.terminal.logToTerminal(`Error saving file "${this.selectedFile}": ${g.message}`,"error")}}}var Co={exports:{}};(function(e,t){(function(i,s){e.exports=s()})(self,()=>(()=>{var i={4567:function(b,r,o){var u=this&&this.__decorate||function(h,p,v,x){var E,w=arguments.length,k=w<3?p:x===null?x=Object.getOwnPropertyDescriptor(p,v):x;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")k=Reflect.decorate(h,p,v,x);else for(var T=h.length-1;T>=0;T--)(E=h[T])&&(k=(w<3?E(k):w>3?E(p,v,k):E(p,v))||k);return w>3&&k&&Object.defineProperty(p,v,k),k},m=this&&this.__param||function(h,p){return function(v,x){p(v,x,h)}};Object.defineProperty(r,"__esModule",{value:!0}),r.AccessibilityManager=void 0;const l=o(9042),f=o(6114),y=o(9924),C=o(844),S=o(5596),n=o(4725),d=o(3656);let a=r.AccessibilityManager=class extends C.Disposable{constructor(h,p){super(),this._terminal=h,this._renderService=p,this._liveRegionLineCount=0,this._charsToConsume=[],this._charsToAnnounce="",this._accessibilityContainer=document.createElement("div"),this._accessibilityContainer.classList.add("xterm-accessibility"),this._rowContainer=document.createElement("div"),this._rowContainer.setAttribute("role","list"),this._rowContainer.classList.add("xterm-accessibility-tree"),this._rowElements=[];for(let v=0;v<this._terminal.rows;v++)this._rowElements[v]=this._createAccessibilityTreeNode(),this._rowContainer.appendChild(this._rowElements[v]);if(this._topBoundaryFocusListener=v=>this._handleBoundaryFocus(v,0),this._bottomBoundaryFocusListener=v=>this._handleBoundaryFocus(v,1),this._rowElements[0].addEventListener("focus",this._topBoundaryFocusListener),this._rowElements[this._rowElements.length-1].addEventListener("focus",this._bottomBoundaryFocusListener),this._refreshRowsDimensions(),this._accessibilityContainer.appendChild(this._rowContainer),this._liveRegion=document.createElement("div"),this._liveRegion.classList.add("live-region"),this._liveRegion.setAttribute("aria-live","assertive"),this._accessibilityContainer.appendChild(this._liveRegion),this._liveRegionDebouncer=this.register(new y.TimeBasedDebouncer(this._renderRows.bind(this))),!this._terminal.element)throw new Error("Cannot enable accessibility before Terminal.open");this._terminal.element.insertAdjacentElement("afterbegin",this._accessibilityContainer),this.register(this._terminal.onResize(v=>this._handleResize(v.rows))),this.register(this._terminal.onRender(v=>this._refreshRows(v.start,v.end))),this.register(this._terminal.onScroll(()=>this._refreshRows())),this.register(this._terminal.onA11yChar(v=>this._handleChar(v))),this.register(this._terminal.onLineFeed(()=>this._handleChar(`
...
`,si=(e="value")=>(t,i)=>{const s=t.constructor,c=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(g,b,r){var o;const u=s.getPropertyOptions(e),m=typeof u.attribute=="string"?u.attribute:e;if(g===m){const l=u.converter||ei,y=(typeof l=="function"?l:(o=l==null?void 0:l.fromAttribute)!=null?o:ei.fromAttribute)(r,u.type);this[e]!==y&&(this[i]=y)}c.call(this,g,b,r)}},jt=Q`
...
`;function q(e,t){const i=Ct({waitUntilFirstUpdate:!1},t);return(s,c)=>{const{update:g}=s,b=Array.isArray(e)?e:[e];s.update=function(r){b.forEach(o=>{const u=o;if(r.has(u)){const m=r.get(u),l=this[u];m!==l&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[c](m,l)}}),g.call(this,r)}}}var ie=Q`
  :host {
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ua={attribute:!0,type:String,converter:ei,reflect:!1,hasChanged:nr},pa=(e=ua,t,i)=>{const{kind:s,metadata:c}=i;let g=globalThis.litPropertyMetadata.get(c);if(g===void 0&&globalThis.litPropertyMetadata.set(c,g=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),g.set(i.name,e),s==="accessor"){const{name:b}=i;return{set(r){const o=t.get.call(this);t.set.call(this,r),this.requestUpdate(b,o,e)},init(r){return r!==void 0&&this.C(b,void 0,e,r),r}}}if(s==="setter"){const{name:b}=i;return function(r){const o=this[b];t.call(this,r),this.requestUpdate(b,o,e)}}throw Error("Unsupported decorator location: "+s)};function A(e){return(t,i)=>typeof i=="object"?pa(e,t,i):((s,c,g)=>{const b=c.hasOwnProperty(g);return c.constructor.createProperty(g,s),b?Object.getOwnPropertyDescriptor(c,g):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Pi(e){return(t,i)=>{const s=typeof t=="function"?t:t[i];Object.assign(s,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function K(e,t){return(i,s,c)=>{const g=b=>{var r,o;return(o=(r=b.renderRoot)==null?void 0:r.querySelector(e))!=null?o:null};if(t){const{get:b,set:r}=typeof s=="object"?i:c!=null?c:(()=>{const o=Symbol();return{get(){return this[o]},set(u){this[o]=u}}})();return js(i,s,{get(){let o=b.call(this);return o===void 0&&(o=g(this),(o!==null||this.hasUpdated)&&r.call(this,o)),o}})}return js(i,s,{get(){return g(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function fa(e){return(t,i)=>js(t,i,{async get(){var s,c;return await this.updateComplete,(c=(s=this.renderRoot)==null?void 0:s.querySelector(e))!=null?c:null}})}var ss,J=class extends Ci{constructor(){super(),Dn(this,ss,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){const i=new CustomEvent(e,Ct({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){const s=customElements.get(e);if(!s){try{customElements.define(e,t,i)}catch{customElements.define(e,class extends t{},i)}return}let c=" (unknown version)",g=c;"version"in t&&t.version&&(c=" v"+t.version),"version"in s&&s.version&&(g=" v"+s.version),!(c&&g&&c===g)&&console.warn(`Attempted to register <${e}>${c}, but <${e}>${g} has already been registered.`)}attributeChangedCallback(e,t,i){Ln(this,ss)||(this.constructor.elementProperties.forEach((s,c)=>{s.reflect&&this[c]!=null&&this.initialReflectedProperties.set(c,this[c])}),Tn(this,ss,!0)),super.attributeChangedCallback(e,t,i)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,i)=>{e.has(i)&&this[i]==null&&(this[i]=t)})}};ss=new WeakMap;J.version="2.20.1";J.dependencies={};_([A()],J.prototype,"dir",2);_([A()],J.prototype,"lang",2);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ga=(e,t)=>t===void 0?(e==null?void 0:e._$litType$)!==void 0:(e==null?void 0:e._$litType$)===t,Oo=e=>e.strings===void 0,ma={},va=(e,t=ma)=>e._$AH=t;var _i=Symbol(),Gi=Symbol(),Ms,Is=new Map,me=class extends J{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var i;let s;if(t!=null&&t.spriteSheet)return this.svg=V`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(s=await fetch(e,{mode:"cors"}),!s.ok)return s.status===410?_i:Gi}catch{return Gi}try{const c=document.createElement("div");c.innerHTML=await s.text();const g=c.firstElementChild;if(((i=g==null?void 0:g.tagName)==null?void 0:i.toLowerCase())!=="svg")return _i;Ms||(Ms=new DOMParser);const r=Ms.parseFromString(g.outerHTML,"text/html").body.querySelector("svg");return r?(r.part.add("svg"),document.adoptNode(r)):_i}catch{return _i}}connectedCallback(){super.connectedCallback(),ca(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),ha(this)}getIconSource(){const e=Fr(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:i}=this.getIconSource(),s=i?Fr(this.library):void 0;if(!t){this.svg=null;return}let c=Is.get(t);if(c||(c=this.resolveIcon(t,s),Is.set(t,c)),!this.initialRender)return;const g=await c;if(g===Gi&&Is.delete(t),t===this.getIconSource().url){if(ga(g)){if(this.svg=g,s){await this.updateComplete;const b=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&b&&s.mutator(b)}return}switch(g){case Gi:case _i:this.svg=null,this.emit("sl-error");break;default:this.svg=g.cloneNode(!0),(e=s==null?void 0:s.mutator)==null||e.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};me.styles=[ie,da];_([ee()],me.prototype,"svg",2);_([A({reflect:!0})],me.prototype,"name",2);_([A()],me.prototype,"src",2);_([A()],me.prototype,"label",2);_([A({reflect:!0})],me.prototype,"library",2);_([q("label")],me.prototype,"handleLabelChange",1);_([q(["name","src","library"])],me.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},zi=e=>(...t)=>({_$litDirective$:e,values:t});class Fi{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,s){this._$Ct=t,this._$AM=i,this._$Ci=s}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const te=zi(class extends Fi{constructor(e){var t;if(super(e),e.type!==pt.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var s,c;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(g=>g!=="")));for(const g in t)t[g]&&!((s=this.nt)!=null&&s.has(g))&&this.st.add(g);return this.render(t)}const i=e.element.classList;for(const g of this.st)g in t||(i.remove(g),this.st.delete(g));for(const g in t){const b=!!t[g];b===this.st.has(g)||((c=this.nt)==null?void 0:c.has(g))||(b?(i.add(g),this.st.add(g)):(i.remove(g),this.st.delete(g)))}return Ke}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Wt=zi(class extends Fi{constructor(e){if(super(e),e.type!==pt.PROPERTY&&e.type!==pt.ATTRIBUTE&&e.type!==pt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Oo(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Ke||t===ve)return t;const i=e.element,s=e.name;if(e.type===pt.PROPERTY){if(t===i[s])return Ke}else if(e.type===pt.BOOLEAN_ATTRIBUTE){if(!!t===i.hasAttribute(s))return Ke}else if(e.type===pt.ATTRIBUTE&&i.getAttribute(s)===t+"")return Ke;return va(e),t}});var Le=class extends J{constructor(){super(...arguments),this.formControlController=new xt(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new Ne(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return V`
    ...
    `}};Le.styles=[ie,jt,ta];Le.dependencies={"sl-icon":me};_([K('input[type="checkbox"]')],Le.prototype,"input",2);_([ee()],Le.prototype,"hasFocus",2);_([A()],Le.prototype,"title",2);_([A()],Le.prototype,"name",2);_([A()],Le.prototype,"value",2);_([A({reflect:!0})],Le.prototype,"size",2);_([A({type:Boolean,reflect:!0})],Le.prototype,"disabled",2);_([A({type:Boolean,reflect:!0})],Le.prototype,"checked",2);_([A({type:Boolean,reflect:!0})],Le.prototype,"indeterminate",2);_([si("checked")],Le.prototype,"defaultChecked",2);_([A({reflect:!0})],Le.prototype,"form",2);_([A({type:Boolean,reflect:!0})],Le.prototype,"required",2);_([A({attribute:"help-text"})],Le.prototype,"helpText",2);_([q("disabled",{waitUntilFirstUpdate:!0})],Le.prototype,"handleDisabledChange",1);_([q(["checked","indeterminate"],{waitUntilFirstUpdate:!0})],Le.prototype,"handleStateChange",1);var _a=Q`
  :host {
    --track-width: 2px;
...
`;const qs=new Set,Zt=new Map;let Pt,lr="ltr",cr="en";const Mo=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(Mo){const e=new MutationObserver(Po);lr=document.documentElement.dir||"ltr",cr=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Io(...e){e.map(t=>{const i=t.$code.toLowerCase();Zt.has(i)?Zt.set(i,Object.assign(Object.assign({},Zt.get(i)),t)):Zt.set(i,t),Pt||(Pt=t)}),Po()}function Po(){Mo&&(lr=document.documentElement.dir||"ltr",cr=document.documentElement.lang||navigator.language),[...qs.keys()].map(e=>{typeof e.requestUpdate=="function"&&e.requestUpdate()})}class ba{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){qs.add(this.host)}hostDisconnected(){qs.delete(this.host)}dir(){return`${this.host.dir||lr}`.toLowerCase()}lang(){return`${this.host.lang||cr}`.toLowerCase()}getTranslationData(t){var i,s;const c=new Intl.Locale(t.replace(/_/g,"-")),g=c==null?void 0:c.language.toLowerCase(),b=(s=(i=c==null?void 0:c.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&s!==void 0?s:"",r=Zt.get(`${g}-${b}`),o=Zt.get(g);return{locale:c,language:g,region:b,primary:r,secondary:o}}exists(t,i){var s;const{primary:c,secondary:g}=this.getTranslationData((s=i.lang)!==null&&s!==void 0?s:this.lang());return i=Object.assign({includeFallback:!1},i),!!(c&&c[t]||g&&g[t]||i.includeFallback&&Pt&&Pt[t])}term(t,...i){const{primary:s,secondary:c}=this.getTranslationData(this.lang());let g;if(s&&s[t])g=s[t];else if(c&&c[t])g=c[t];else if(Pt&&Pt[t])g=Pt[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof g=="function"?g(...i):g}date(t,i){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),i).format(t)}number(t,i){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),i).format(t)}relativeTime(t,i,s){return new Intl.RelativeTimeFormat(this.lang(),s).format(t,i)}}var zo={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>e===0?"No options selected":e===1?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};Io(zo);var ya=zo,ce=class extends ba{};Io(ya);var Hi=class extends J{constructor(){super(...arguments),this.localize=new ce(this)}render(){return V`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};Hi.styles=[ie,_a];var Fo=new Map,wa=new WeakMap;function Sa(e){return e!=null?e:{keyframes:[],options:{duration:0}}}function Hr(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function ue(e,t){Fo.set(e,Sa(t))}function _e(e,t,i){const s=wa.get(e);if(s!=null&&s[t])return Hr(s[t],i.dir);const c=Fo.get(t);return c?Hr(c,i.dir):{keyframes:[],options:{duration:0}}}function Ce(e,t,i){return new Promise(s=>{if((i==null?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const c=e.animate(t,Mi(Ct({},i),{duration:Ks()?0:i.duration}));c.addEventListener("cancel",s,{once:!0}),c.addEventListener("finish",s,{once:!0})})}function Nr(e){return e=e.toString().toLowerCase(),e.indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?parseFloat(e)*1e3:parseFloat(e)}function Ks(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Ae(e){return Promise.all(e.getAnimations().map(t=>new Promise(i=>{t.cancel(),requestAnimationFrame(i)})))}function as(e,t){return e.map(i=>Mi(Ct({},i),{height:i.height==="auto"?`${t}px`:i.height}))}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ur(e,t,i){return e?t(e):i==null?void 0:i(e)}var xe=class Xs extends J{constructor(){super(...arguments),this.localize=new ce(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}static isTreeItem(t){return t instanceof Element&&t.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange()}async animateCollapse(){this.emit("sl-collapse"),await Ae(this.childrenContainer);const{keyframes:t,options:i}=_e(this,"tree-item.collapse",{dir:this.localize.dir()});await Ce(this.childrenContainer,as(t,this.childrenContainer.scrollHeight),i),this.childrenContainer.hidden=!0,this.emit("sl-after-collapse")}isNestedItem(){const t=this.parentElement;return!!t&&Xs.isTreeItem(t)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0}willUpdate(t){t.has("selected")&&!t.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(){this.emit("sl-expand"),await Ae(this.childrenContainer),this.childrenContainer.hidden=!1;const{keyframes:t,options:i}=_e(this,"tree-item.expand",{dir:this.localize.dir()});await Ce(this.childrenContainer,as(t,this.childrenContainer.scrollHeight),i),this.childrenContainer.style.height="auto",this.emit("sl-after-expand")}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse()}handleLazyChange(){this.emit("sl-lazy-change")}getChildrenItems({includeDisabled:t=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(i=>Xs.isTreeItem(i)&&(t||!i.disabled)):[]}render(){const t=this.localize.dir()==="rtl",i=!this.loading&&(!this.isLeaf||this.lazy);return V`
      <div
        part="base"
...
`;const Tt=Math.min,qe=Math.max,ls=Math.round,Yi=Math.floor,ft=e=>({x:e,y:e}),ka={left:"right",right:"left",bottom:"top",top:"bottom"},Ea={start:"end",end:"start"};function Gs(e,t,i){return qe(e,Tt(t,i))}function ri(e,t){return typeof e=="function"?e(t):e}function Rt(e){return e.split("-")[0]}function oi(e){return e.split("-")[1]}function Ho(e){return e==="x"?"y":"x"}function hr(e){return e==="y"?"height":"width"}const Aa=new Set(["top","bottom"]);function St(e){return Aa.has(Rt(e))?"y":"x"}function dr(e){return Ho(St(e))}function La(e,t,i){i===void 0&&(i=!1);const s=oi(e),c=dr(e),g=hr(c);let b=c==="x"?s===(i?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[g]>t.floating[g]&&(b=cs(b)),[b,cs(b)]}function Da(e){const t=cs(e);return[Ys(e),t,Ys(t)]}function Ys(e){return e.replace(/start|end/g,t=>Ea[t])}const Wr=["left","right"],Vr=["right","left"],Ta=["top","bottom"],Ra=["bottom","top"];function $a(e,t,i){switch(e){case"top":case"bottom":return i?t?Vr:Wr:t?Wr:Vr;case"left":case"right":return t?Ta:Ra;default:return[]}}function Ba(e,t,i,s){const c=oi(e);let g=$a(Rt(e),i==="start",s);return c&&(g=g.map(b=>b+"-"+c),t&&(g=g.concat(g.map(Ys)))),g}function cs(e){return e.replace(/left|right|bottom|top/g,t=>ka[t])}function Oa(e){return{top:0,right:0,bottom:0,left:0,...e}}function No(e){return typeof e!="number"?Oa(e):{top:e,right:e,bottom:e,left:e}}function hs(e){const{x:t,y:i,width:s,height:c}=e;return{width:s,height:c,top:i,left:t,right:t+s,bottom:i+c,x:t,y:i}}function jr(e,t,i){let{reference:s,floating:c}=e;const g=St(t),b=dr(t),r=hr(b),o=Rt(t),u=g==="y",m=s.x+s.width/2-c.width/2,l=s.y+s.height/2-c.height/2,f=s[r]/2-c[r]/2;let y;switch(o){case"top":y={x:m,y:s.y-c.height};break;case"bottom":y={x:m,y:s.y+s.height};break;case"right":y={x:s.x+s.width,y:l};break;case"left":y={x:s.x-c.width,y:l};break;default:y={x:s.x,y:s.y}}switch(oi(t)){case"start":y[b]-=f*(i&&u?-1:1);break;case"end":y[b]+=f*(i&&u?-1:1);break}return y}const Ma=async(e,t,i)=>{const{placement:s="bottom",strategy:c="absolute",middleware:g=[],platform:b}=i,r=g.filter(Boolean),o=await(b.isRTL==null?void 0:b.isRTL(t));let u=await b.getElementRects({reference:e,floating:t,strategy:c}),{x:m,y:l}=jr(u,s,o),f=s,y={},C=0;for(let S=0;S<r.length;S++){const{name:n,fn:d}=r[S],{x:a,y:h,data:p,reset:v}=await d({x:m,y:l,initialPlacement:s,placement:f,strategy:c,middlewareData:y,rects:u,platform:b,elements:{reference:e,floating:t}});m=a!=null?a:m,l=h!=null?h:l,y={...y,[n]:{...y[n],...p}},v&&C<=50&&(C++,typeof v=="object"&&(v.placement&&(f=v.placement),v.rects&&(u=v.rects===!0?await b.getElementRects({reference:e,floating:t,strategy:c}):v.rects),{x:m,y:l}=jr(u,f,o)),S=-1)}return{x:m,y:l,placement:f,strategy:c,middlewareData:y}};async function ur(e,t){var i;t===void 0&&(t={});const{x:s,y:c,platform:g,rects:b,elements:r,strategy:o}=e,{boundary:u="clippingAncestors",rootBoundary:m="viewport",elementContext:l="floating",altBoundary:f=!1,padding:y=0}=ri(t,e),C=No(y),n=r[f?l==="floating"?"reference":"floating":l],d=hs(await g.getClippingRect({element:(i=await(g.isElement==null?void 0:g.isElement(n)))==null||i?n:n.contextElement||await(g.getDocumentElement==null?void 0:g.getDocumentElement(r.floating)),boundary:u,rootBoundary:m,strategy:o})),a=l==="floating"?{x:s,y:c,width:b.floating.width,height:b.floating.height}:b.reference,h=await(g.getOffsetParent==null?void 0:g.getOffsetParent(r.floating)),p=await(g.isElement==null?void 0:g.isElement(h))?await(g.getScale==null?void 0:g.getScale(h))||{x:1,y:1}:{x:1,y:1},v=hs(g.convertOffsetParentRelativeRectToViewportRelativeRect?await g.convertOffsetParentRelativeRectToViewportRelativeRect({elements:r,rect:a,offsetParent:h,strategy:o}):a);return{top:(d.top-v.top+C.top)/p.y,bottom:(v.bottom-d.bottom+C.bottom)/p.y,left:(d.left-v.left+C.left)/p.x,right:(v.right-d.right+C.right)/p.x}}const Ia=e=>({name:"arrow",options:e,async fn(t){const{x:i,y:s,placement:c,rects:g,platform:b,elements:r,middlewareData:o}=t,{element:u,padding:m=0}=ri(e,t)||{};if(u==null)return{};const l=No(m),f={x:i,y:s},y=dr(c),C=hr(y),S=await b.getDimensions(u),n=y==="y",d=n?"top":"left",a=n?"bottom":"right",h=n?"clientHeight":"clientWidth",p=g.reference[C]+g.reference[y]-f[y]-g.floating[C],v=f[y]-g.reference[y],x=await(b.getOffsetParent==null?void 0:b.getOffsetParent(u));let E=x?x[h]:0;(!E||!await(b.isElement==null?void 0:b.isElement(x)))&&(E=r.floating[h]||g.floating[C]);const w=p/2-v/2,k=E/2-S[C]/2-1,T=Tt(l[d],k),B=Tt(l[a],k),R=T,O=E-S[C]-B,z=E/2-S[C]/2+w,F=Gs(R,z,O),W=!o.arrow&&oi(c)!=null&&z!==F&&g.reference[C]/2-(z<R?T:B)-S[C]/2<0,N=W?z<R?z-R:z-O:0;return{[y]:f[y]+N,data:{[y]:F,centerOffset:z-F-N,...W&&{alignmentOffset:N}},reset:W}}});const Pa=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,s;const{placement:c,middlewareData:g,rects:b,initialPlacement:r,platform:o,elements:u}=t,{mainAxis:m=!0,crossAxis:l=!0,fallbackPlacements:f,fallbackStrategy:y="bestFit",fallbackAxisSideDirection:C="none",flipAlignment:S=!0,...n}=ri(e,t);if((i=g.arrow)!=null&&i.alignmentOffset)return{};const d=Rt(c),a=St(r),h=Rt(r)===r,p=await(o.isRTL==null?void 0:o.isRTL(u.floating)),v=f||(h||!S?[cs(r)]:Da(r)),x=C!=="none";!f&&x&&v.push(...Ba(r,S,C,p));const E=[r,...v],w=await ur(t,n),k=[];let T=((s=g.flip)==null?void 0:s.overflows)||[];if(m&&k.push(w[d]),l){const z=La(c,b,p);k.push(w[z[0]],w[z[1]])}if(T=[...T,{placement:c,overflows:k}],!k.every(z=>z<=0)){var B,R;const z=(((B=g.flip)==null?void 0:B.index)||0)+1,F=E[z];if(F&&(!(l==="alignment"?a!==St(F):!1)||T.every(L=>St(L.placement)===a?L.overflows[0]>0:!0)))return{data:{index:z,overflows:T},reset:{placement:F}};let W=(R=T.filter(N=>N.overflows[0]<=0).sort((N,L)=>N.overflows[1]-L.overflows[1])[0])==null?void 0:R.placement;if(!W)switch(y){case"bestFit":{var O;const N=(O=T.filter(L=>{if(x){const $=St(L.placement);return $===a||$==="y"}return!0}).map(L=>[L.placement,L.overflows.filter($=>$>0).reduce(($,M)=>$+M,0)]).sort((L,$)=>L[1]-$[1])[0])==null?void 0:O[0];N&&(W=N);break}case"initialPlacement":W=r;break}if(c!==W)return{reset:{placement:W}}}return{}}}};const za=new Set(["left","top"]);async function Fa(e,t){const{placement:i,platform:s,elements:c}=e,g=await(s.isRTL==null?void 0:s.isRTL(c.floating)),b=Rt(i),r=oi(i),o=St(i)==="y",u=za.has(b)?-1:1,m=g&&o?-1:1,l=ri(t,e);let{mainAxis:f,crossAxis:y,alignmentAxis:C}=typeof l=="number"?{mainAxis:l,crossAxis:0,alignmentAxis:null}:{mainAxis:l.mainAxis||0,crossAxis:l.crossAxis||0,alignmentAxis:l.alignmentAxis};return r&&typeof C=="number"&&(y=r==="end"?C*-1:C),o?{x:y*m,y:f*u}:{x:f*u,y:y*m}}const Ha=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var i,s;const{x:c,y:g,placement:b,middlewareData:r}=t,o=await Fa(t,e);return b===((i=r.offset)==null?void 0:i.placement)&&(s=r.arrow)!=null&&s.alignmentOffset?{}:{x:c+o.x,y:g+o.y,data:{...o,placement:b}}}}},Na=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:s,placement:c}=t,{mainAxis:g=!0,crossAxis:b=!1,limiter:r={fn:n=>{let{x:d,y:a}=n;return{x:d,y:a}}},...o}=ri(e,t),u={x:i,y:s},m=await ur(t,o),l=St(Rt(c)),f=Ho(l);let y=u[f],C=u[l];if(g){const n=f==="y"?"top":"left",d=f==="y"?"bottom":"right",a=y+m[n],h=y-m[d];y=Gs(a,y,h)}if(b){const n=l==="y"?"top":"left",d=l==="y"?"bottom":"right",a=C+m[n],h=C-m[d];C=Gs(a,C,h)}const S=r.fn({...t,[f]:y,[l]:C});return{...S,data:{x:S.x-i,y:S.y-s,enabled:{[f]:g,[l]:b}}}}}};const Ua=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var i,s;const{placement:c,rects:g,platform:b,elements:r}=t,{apply:o=()=>{},...u}=ri(e,t),m=await ur(t,u),l=Rt(c),f=oi(c),y=St(c)==="y",{width:C,height:S}=g.floating;let n,d;l==="top"||l==="bottom"?(n=l,d=f===(await(b.isRTL==null?void 0:b.isRTL(r.floating))?"start":"end")?"left":"right"):(d=l,n=f==="end"?"top":"bottom");const a=S-m.top-m.bottom,h=C-m.left-m.right,p=Tt(S-m[n],a),v=Tt(C-m[d],h),x=!t.middlewareData.shift;let E=p,w=v;if((i=t.middlewareData.shift)!=null&&i.enabled.x&&(w=h),(s=t.middlewareData.shift)!=null&&s.enabled.y&&(E=a),x&&!f){const T=qe(m.left,0),B=qe(m.right,0),R=qe(m.top,0),O=qe(m.bottom,0);y?w=C-2*(T!==0||B!==0?T+B:qe(m.left,m.right)):E=S-2*(R!==0||O!==0?R+O:qe(m.top,m.bottom))}await o({...t,availableWidth:w,availableHeight:E});const k=await b.getDimensions(r.floating);return C!==k.width||S!==k.height?{reset:{rects:!0}}:{}}}};function ms(){return typeof window<"u"}function ni(e){return Uo(e)?(e.nodeName||"").toLowerCase():"#document"}function Xe(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function mt(e){var t;return(t=(Uo(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Uo(e){return ms()?e instanceof Node||e instanceof Xe(e).Node:!1}function rt(e){return ms()?e instanceof Element||e instanceof Xe(e).Element:!1}function gt(e){return ms()?e instanceof HTMLElement||e instanceof Xe(e).HTMLElement:!1}function qr(e){return!ms()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof Xe(e).ShadowRoot}const Wa=new Set(["inline","contents"]);function Ni(e){const{overflow:t,overflowX:i,overflowY:s,display:c}=ot(e);return/auto|scroll|overlay|hidden|clip/.test(t+s+i)&&!Wa.has(c)}const Va=new Set(["table","td","th"]);function ja(e){return Va.has(ni(e))}const qa=[":popover-open",":modal"];function vs(e){return qa.some(t=>{try{return e.matches(t)}catch{return!1}})}const Ka=["transform","translate","scale","rotate","perspective"],Xa=["transform","translate","scale","rotate","perspective","filter"],Ga=["paint","layout","strict","content"];function _s(e){const t=pr(),i=rt(e)?ot(e):e;return Ka.some(s=>i[s]?i[s]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||Xa.some(s=>(i.willChange||"").includes(s))||Ga.some(s=>(i.contain||"").includes(s))}function Ya(e){let t=$t(e);for(;gt(t)&&!ii(t);){if(_s(t))return t;if(vs(t))return null;t=$t(t)}return null}function pr(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const Ja=new Set(["html","body","#document"]);function ii(e){return Ja.has(ni(e))}function ot(e){return Xe(e).getComputedStyle(e)}function bs(e){return rt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function $t(e){if(ni(e)==="html")return e;const t=e.assignedSlot||e.parentNode||qr(e)&&e.host||mt(e);return qr(t)?t.host:t}function Wo(e){const t=$t(e);return ii(t)?e.ownerDocument?e.ownerDocument.body:e.body:gt(t)&&Ni(t)?t:Wo(t)}function Bi(e,t,i){var s;t===void 0&&(t=[]),i===void 0&&(i=!0);const c=Wo(e),g=c===((s=e.ownerDocument)==null?void 0:s.body),b=Xe(c);if(g){const r=Js(b);return t.concat(b,b.visualViewport||[],Ni(c)?c:[],r&&i?Bi(r):[])}return t.concat(c,Bi(c,[],i))}function Js(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Vo(e){const t=ot(e);let i=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const c=gt(e),g=c?e.offsetWidth:i,b=c?e.offsetHeight:s,r=ls(i)!==g||ls(s)!==b;return r&&(i=g,s=b),{width:i,height:s,$:r}}function fr(e){return rt(e)?e:e.contextElement}function Qt(e){const t=fr(e);if(!gt(t))return ft(1);const i=t.getBoundingClientRect(),{width:s,height:c,$:g}=Vo(t);let b=(g?ls(i.width):i.width)/s,r=(g?ls(i.height):i.height)/c;return(!b||!Number.isFinite(b))&&(b=1),(!r||!Number.isFinite(r))&&(r=1),{x:b,y:r}}const Za=ft(0);function jo(e){const t=Xe(e);return!pr()||!t.visualViewport?Za:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Qa(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==Xe(e)?!1:t}function Vt(e,t,i,s){t===void 0&&(t=!1),i===void 0&&(i=!1);const c=e.getBoundingClientRect(),g=fr(e);let b=ft(1);t&&(s?rt(s)&&(b=Qt(s)):b=Qt(e));const r=Qa(g,i,s)?jo(g):ft(0);let o=(c.left+r.x)/b.x,u=(c.top+r.y)/b.y,m=c.width/b.x,l=c.height/b.y;if(g){const f=Xe(g),y=s&&rt(s)?Xe(s):s;let C=f,S=Js(C);for(;S&&s&&y!==C;){const n=Qt(S),d=S.getBoundingClientRect(),a=ot(S),h=d.left+(S.clientLeft+parseFloat(a.paddingLeft))*n.x,p=d.top+(S.clientTop+parseFloat(a.paddingTop))*n.y;o*=n.x,u*=n.y,m*=n.x,l*=n.y,o+=h,u+=p,C=Xe(S),S=Js(C)}}return hs({width:m,height:l,x:o,y:u})}function gr(e,t){const i=bs(e).scrollLeft;return t?t.left+i:Vt(mt(e)).left+i}function qo(e,t,i){i===void 0&&(i=!1);const s=e.getBoundingClientRect(),c=s.left+t.scrollLeft-(i?0:gr(e,s)),g=s.top+t.scrollTop;return{x:c,y:g}}function el(e){let{elements:t,rect:i,offsetParent:s,strategy:c}=e;const g=c==="fixed",b=mt(s),r=t?vs(t.floating):!1;if(s===b||r&&g)return i;let o={scrollLeft:0,scrollTop:0},u=ft(1);const m=ft(0),l=gt(s);if((l||!l&&!g)&&((ni(s)!=="body"||Ni(b))&&(o=bs(s)),gt(s))){const y=Vt(s);u=Qt(s),m.x=y.x+s.clientLeft,m.y=y.y+s.clientTop}const f=b&&!l&&!g?qo(b,o,!0):ft(0);return{width:i.width*u.x,height:i.height*u.y,x:i.x*u.x-o.scrollLeft*u.x+m.x+f.x,y:i.y*u.y-o.scrollTop*u.y+m.y+f.y}}function tl(e){return Array.from(e.getClientRects())}function il(e){const t=mt(e),i=bs(e),s=e.ownerDocument.body,c=qe(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),g=qe(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let b=-i.scrollLeft+gr(e);const r=-i.scrollTop;return ot(s).direction==="rtl"&&(b+=qe(t.clientWidth,s.clientWidth)-c),{width:c,height:g,x:b,y:r}}function sl(e,t){const i=Xe(e),s=mt(e),c=i.visualViewport;let g=s.clientWidth,b=s.clientHeight,r=0,o=0;if(c){g=c.width,b=c.height;const u=pr();(!u||u&&t==="fixed")&&(r=c.offsetLeft,o=c.offsetTop)}return{width:g,height:b,x:r,y:o}}const rl=new Set(["absolute","fixed"]);function ol(e,t){const i=Vt(e,!0,t==="fixed"),s=i.top+e.clientTop,c=i.left+e.clientLeft,g=gt(e)?Qt(e):ft(1),b=e.clientWidth*g.x,r=e.clientHeight*g.y,o=c*g.x,u=s*g.y;return{width:b,height:r,x:o,y:u}}function Kr(e,t,i){let s;if(t==="viewport")s=sl(e,i);else if(t==="document")s=il(mt(e));else if(rt(t))s=ol(t,i);else{const c=jo(e);s={x:t.x-c.x,y:t.y-c.y,width:t.width,height:t.height}}return hs(s)}function Ko(e,t){const i=$t(e);return i===t||!rt(i)||ii(i)?!1:ot(i).position==="fixed"||Ko(i,t)}function nl(e,t){const i=t.get(e);if(i)return i;let s=Bi(e,[],!1).filter(r=>rt(r)&&ni(r)!=="body"),c=null;const g=ot(e).position==="fixed";let b=g?$t(e):e;for(;rt(b)&&!ii(b);){const r=ot(b),o=_s(b);!o&&r.position==="fixed"&&(c=null),(g?!o&&!c:!o&&r.position==="static"&&!!c&&rl.has(c.position)||Ni(b)&&!o&&Ko(e,b))?s=s.filter(m=>m!==b):c=r,b=$t(b)}return t.set(e,s),s}function al(e){let{element:t,boundary:i,rootBoundary:s,strategy:c}=e;const b=[...i==="clippingAncestors"?vs(t)?[]:nl(t,this._c):[].concat(i),s],r=b[0],o=b.reduce((u,m)=>{const l=Kr(t,m,c);return u.top=qe(l.top,u.top),u.right=Tt(l.right,u.right),u.bottom=Tt(l.bottom,u.bottom),u.left=qe(l.left,u.left),u},Kr(t,r,c));return{width:o.right-o.left,height:o.bottom-o.top,x:o.left,y:o.top}}function ll(e){const{width:t,height:i}=Vo(e);return{width:t,height:i}}function cl(e,t,i){const s=gt(t),c=mt(t),g=i==="fixed",b=Vt(e,!0,g,t);let r={scrollLeft:0,scrollTop:0};const o=ft(0);function u(){o.x=gr(c)}if(s||!s&&!g)if((ni(t)!=="body"||Ni(c))&&(r=bs(t)),s){const y=Vt(t,!0,g,t);o.x=y.x+t.clientLeft,o.y=y.y+t.clientTop}else c&&u();g&&!s&&c&&u();const m=c&&!s&&!g?qo(c,r):ft(0),l=b.left+r.scrollLeft-o.x-m.x,f=b.top+r.scrollTop-o.y-m.y;return{x:l,y:f,width:b.width,height:b.height}}function Ps(e){return ot(e).position==="static"}function Xr(e,t){if(!gt(e)||ot(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return mt(e)===i&&(i=i.ownerDocument.body),i}function Xo(e,t){const i=Xe(e);if(vs(e))return i;if(!gt(e)){let c=$t(e);for(;c&&!ii(c);){if(rt(c)&&!Ps(c))return c;c=$t(c)}return i}let s=Xr(e,t);for(;s&&ja(s)&&Ps(s);)s=Xr(s,t);return s&&ii(s)&&Ps(s)&&!_s(s)?i:s||Ya(e)||i}const hl=async function(e){const t=this.getOffsetParent||Xo,i=this.getDimensions,s=await i(e.floating);return{reference:cl(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}};function dl(e){return ot(e).direction==="rtl"}const rs={convertOffsetParentRelativeRectToViewportRelativeRect:el,getDocumentElement:mt,getClippingRect:al,getOffsetParent:Xo,getElementRects:hl,getClientRects:tl,getDimensions:ll,getScale:Qt,isElement:rt,isRTL:dl};function Go(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function ul(e,t){let i=null,s;const c=mt(e);function g(){var r;clearTimeout(s),(r=i)==null||r.disconnect(),i=null}function b(r,o){r===void 0&&(r=!1),o===void 0&&(o=1),g();const u=e.getBoundingClientRect(),{left:m,top:l,width:f,height:y}=u;if(r||t(),!f||!y)return;const C=Yi(l),S=Yi(c.clientWidth-(m+f)),n=Yi(c.clientHeight-(l+y)),d=Yi(m),h={rootMargin:-C+"px "+-S+"px "+-n+"px "+-d+"px",threshold:qe(0,Tt(1,o))||1};let p=!0;function v(x){const E=x[0].intersectionRatio;if(E!==o){if(!p)return b();E?b(!1,E):s=setTimeout(()=>{b(!1,1e-7)},1e3)}E===1&&!Go(u,e.getBoundingClientRect())&&b(),p=!1}try{i=new IntersectionObserver(v,{...h,root:c.ownerDocument})}catch{i=new IntersectionObserver(v,h)}i.observe(e)}return b(!0),g}function pl(e,t,i,s){s===void 0&&(s={});const{ancestorScroll:c=!0,ancestorResize:g=!0,elementResize:b=typeof ResizeObserver=="function",layoutShift:r=typeof IntersectionObserver=="function",animationFrame:o=!1}=s,u=fr(e),m=c||g?[...u?Bi(u):[],...Bi(t)]:[];m.forEach(d=>{c&&d.addEventListener("scroll",i,{passive:!0}),g&&d.addEventListener("resize",i)});const l=u&&r?ul(u,i):null;let f=-1,y=null;b&&(y=new ResizeObserver(d=>{let[a]=d;a&&a.target===u&&y&&(y.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var h;(h=y)==null||h.observe(t)})),i()}),u&&!o&&y.observe(u),y.observe(t));let C,S=o?Vt(e):null;o&&n();function n(){const d=Vt(e);S&&!Go(S,d)&&i(),S=d,C=requestAnimationFrame(n)}return i(),()=>{var d;m.forEach(a=>{c&&a.removeEventListener("scroll",i),g&&a.removeEventListener("resize",i)}),l==null||l(),(d=y)==null||d.disconnect(),y=null,o&&cancelAnimationFrame(C)}}const fl=Ha,gl=Na,ml=Pa,Gr=Ua,vl=Ia,_l=(e,t,i)=>{const s=new Map,c={platform:rs,...i},g={...c.platform,_c:s};return Ma(e,t,{...c,platform:g})};function bl(e){return yl(e)}function zs(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function yl(e){for(let t=e;t;t=zs(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=zs(e);t;t=zs(t)){if(!(t instanceof Element))continue;const i=getComputedStyle(t);if(i.display!=="contents"&&(i.position!=="static"||_s(i)||t.tagName==="BODY"))return t}return null}function wl(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e.contextElement instanceof Element:!0)}var pe=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let s=0,c=0,g=0,b=0,r=0,o=0,u=0,m=0;i?e.top<t.top?(s=e.left,c=e.bottom,g=e.right,b=e.bottom,r=t.left,o=t.top,u=t.right,m=t.top):(s=t.left,c=t.bottom,g=t.right,b=t.bottom,r=e.left,o=e.top,u=e.right,m=e.top):e.left<t.left?(s=e.right,c=e.top,g=t.left,b=t.top,r=e.right,o=e.bottom,u=t.left,m=t.bottom):(s=t.right,c=t.top,g=e.left,b=e.top,r=t.right,o=t.bottom,u=e.left,m=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${s}px`),this.style.setProperty("--hover-bridge-top-left-y",`${c}px`),this.style.setProperty("--hover-bridge-top-right-x",`${g}px`),this.style.setProperty("--hover-bridge-top-right-y",`${b}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${o}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${u}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${m}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||wl(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=pl(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[fl({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Gr({apply:({rects:i})=>{const s=this.sync==="width"||this.sync==="both",c=this.sync==="height"||this.sync==="both";this.popup.style.width=s?`${i.reference.width}px`:"",this.popup.style.height=c?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(ml({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(gl({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Gr({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:s})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${s}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(vl({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?i=>rs.getOffsetParent(i,bl):rs.getOffsetParent;_l(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Mi(Ct({},rs),{getOffsetParent:t})}).then(({x:i,y:s,middlewareData:c,placement:g})=>{const b=this.localize.dir()==="rtl",r={top:"bottom",right:"left",bottom:"top",left:"right"}[g.split("-")[0]];if(this.setAttribute("data-current-placement",g),Object.assign(this.popup.style,{left:`${i}px`,top:`${s}px`}),this.arrow){const o=c.arrow.x,u=c.arrow.y;let m="",l="",f="",y="";if(this.arrowPlacement==="start"){const C=typeof o=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";m=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",l=b?C:"",y=b?"":C}else if(this.arrowPlacement==="end"){const C=typeof o=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";l=b?"":C,y=b?C:"",f=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(y=typeof o=="number"?"calc(50% - var(--arrow-size-diagonal))":"",m=typeof u=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(y=typeof o=="number"?`${o}px`:"",m=typeof u=="number"?`${u}px`:"");Object.assign(this.arrowEl.style,{top:m,right:l,bottom:f,left:y,[r]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return V`
...
`;function Ee(e,t,i){const s=c=>Object.is(c,-0)?0:c;return e<t?s(t):e>i?s(i):s(e)}function Yr(e,t=!1){function i(g){const b=g.getChildrenItems({includeDisabled:!1});if(b.length){const r=b.every(u=>u.selected),o=b.every(u=>!u.selected&&!u.indeterminate);g.selected=r,g.indeterminate=!r&&!o}}function s(g){const b=g.parentElement;xi.isTreeItem(b)&&(i(b),s(b))}function c(g){for(const b of g.getChildrenItems())b.selected=t?g.selected||b.selected:!b.disabled&&g.selected,c(b);t&&i(g)}c(e),s(e)}var qt=class extends J{constructor(){super(),this.selection="single",this.clickTarget=null,this.localize=new ce(this),this.initTreeItem=e=>{e.selectable=this.selection==="multiple",["expand","collapse"].filter(t=>!!this.querySelector(`[slot="${t}-icon"]`)).forEach(t=>{const i=e.querySelector(`[slot="${t}-icon"]`),s=this.getExpandButtonIcon(t);!s||(i===null?e.append(s):i.hasAttribute("data-default")&&i.replaceWith(s))})},this.handleTreeChanged=e=>{for(const t of e){const i=[...t.addedNodes].filter(xi.isTreeItem),s=[...t.removedNodes].filter(xi.isTreeItem);i.forEach(this.initTreeItem),this.lastFocusedItem&&s.includes(this.lastFocusedItem)&&(this.lastFocusedItem=null)}},this.handleFocusOut=e=>{const t=e.relatedTarget;(!t||!this.contains(t))&&(this.tabIndex=0)},this.handleFocusIn=e=>{const t=e.target;e.target===this&&this.focusItem(this.lastFocusedItem||this.getAllTreeItems()[0]),xi.isTreeItem(t)&&!t.disabled&&(this.lastFocusedItem&&(this.lastFocusedItem.tabIndex=-1),this.lastFocusedItem=t,this.tabIndex=-1,t.tabIndex=0)},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut),this.addEventListener("sl-lazy-change",this.handleSlotChange)}async connectedCallback(){super.connectedCallback(),this.setAttribute("role","tree"),this.setAttribute("tabindex","0"),await this.updateComplete,this.mutationObserver=new MutationObserver(this.handleTreeChanged),this.mutationObserver.observe(this,{childList:!0,subtree:!0})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect()}getExpandButtonIcon(e){const i=(e==="expand"?this.expandedIconSlot:this.collapsedIconSlot).assignedElements({flatten:!0})[0];if(i){const s=i.cloneNode(!0);return[s,...s.querySelectorAll("[id]")].forEach(c=>c.removeAttribute("id")),s.setAttribute("data-default",""),s.slot=`${e}-icon`,s}return null}selectItem(e){const t=[...this.selectedItems];if(this.selection==="multiple")e.selected=!e.selected,e.lazy&&(e.expanded=!0),Yr(e);else if(this.selection==="single"||e.isLeaf){const s=this.getAllTreeItems();for(const c of s)c.selected=c===e}else this.selection==="leaf"&&(e.expanded=!e.expanded);const i=this.selectedItems;(t.length!==i.length||i.some(s=>!t.includes(s)))&&Promise.all(i.map(s=>s.updateComplete)).then(()=>{this.emit("sl-selection-change",{detail:{selection:i}})})}getAllTreeItems(){return[...this.querySelectorAll("sl-tree-item")]}focusItem(e){e==null||e.focus()}handleKeyDown(e){if(!["ArrowDown","ArrowUp","ArrowRight","ArrowLeft","Home","End","Enter"," "].includes(e.key)||e.composedPath().some(c=>{var g;return["input","textarea"].includes((g=c==null?void 0:c.tagName)==null?void 0:g.toLowerCase())}))return;const t=this.getFocusableItems(),i=this.localize.dir()==="ltr",s=this.localize.dir()==="rtl";if(t.length>0){e.preventDefault();const c=t.findIndex(o=>o.matches(":focus")),g=t[c],b=o=>{const u=t[Ee(o,0,t.length-1)];this.focusItem(u)},r=o=>{g.expanded=o};e.key==="ArrowDown"?b(c+1):e.key==="ArrowUp"?b(c-1):i&&e.key==="ArrowRight"||s&&e.key==="ArrowLeft"?!g||g.disabled||g.expanded||g.isLeaf&&!g.lazy?b(c+1):r(!0):i&&e.key==="ArrowLeft"||s&&e.key==="ArrowRight"?!g||g.disabled||g.isLeaf||!g.expanded?b(c-1):r(!1):e.key==="Home"?b(0):e.key==="End"?b(t.length-1):(e.key==="Enter"||e.key===" ")&&(g.disabled||this.selectItem(g))}}handleClick(e){const t=e.target,i=t.closest("sl-tree-item"),s=e.composedPath().some(c=>{var g;return(g=c==null?void 0:c.classList)==null?void 0:g.contains("tree-item__expand-button")});!i||i.disabled||t!==this.clickTarget||(s?i.expanded=!i.expanded:this.selectItem(i))}handleMouseDown(e){this.clickTarget=e.target}handleSlotChange(){this.getAllTreeItems().forEach(this.initTreeItem)}async handleSelectionChange(){const e=this.selection==="multiple",t=this.getAllTreeItems();this.setAttribute("aria-multiselectable",e?"true":"false");for(const i of t)i.selectable=e;e&&(await this.updateComplete,[...this.querySelectorAll(":scope > sl-tree-item")].forEach(i=>Yr(i,!0)))}get selectedItems(){const e=this.getAllTreeItems(),t=i=>i.selected;return e.filter(t)}getFocusableItems(){const e=this.getAllTreeItems(),t=new Set;return e.filter(i=>{var s;if(i.disabled)return!1;const c=(s=i.parentElement)==null?void 0:s.closest("[role=treeitem]");return c&&(!c.expanded||c.loading||t.has(c))&&t.add(i),!t.has(i)})}render(){return V`
    ...
    `}};qt.styles=[ie,Sl];_([K("slot:not([name])")],qt.prototype,"defaultSlot",2);_([K("slot[name=expand-icon]")],qt.prototype,"expandedIconSlot",2);_([K("slot[name=collapse-icon]")],qt.prototype,"collapsedIconSlot",2);_([A()],qt.prototype,"selection",2);_([q("selection")],qt.prototype,"handleSelectionChange",1);qt.define("sl-tree");var Cl=Q`
...
`,kl=0,Ui=class extends J{constructor(){super(...arguments),this.attrId=++kl,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return V`
      <slot
        part="base"
        class=${te({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};Ui.styles=[ie,xl];_([A({reflect:!0})],Ui.prototype,"name",2);_([A({type:Boolean,reflect:!0})],Ui.prototype,"active",2);_([q("active")],Ui.prototype,"handleActiveChange",1);Ui.define("sl-tab-panel");var El=Q`
  :host {
    display: inline-block;
  }
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Yo=Symbol.for(""),Ll=e=>{if((e==null?void 0:e.r)===Yo)return e==null?void 0:e._$litStatic$},ds=(e,...t)=>({_$litStatic$:t.reduce((i,s,c)=>i+(g=>{if(g._$litStatic$!==void 0)return g._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${g}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+e[c+1],e[0]),r:Yo}),Jr=new Map,Dl=e=>(t,...i)=>{const s=i.length;let c,g;const b=[],r=[];let o,u=0,m=!1;for(;u<s;){for(o=t[u];u<s&&(g=i[u],(c=Ll(g))!==void 0);)o+=c+t[++u],m=!0;u!==s&&r.push(g),b.push(o),u++}if(u===s&&b.push(t[s]),m){const l=b.join("$$lit$$");(t=Jr.get(l))===void 0&&(b.raw=b,Jr.set(l,t=b)),i=r}return e(t,...i)},ki=Dl(V);var De=class extends J{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?ds`a`:ds`button`;return ki`
      <${t}
        part="base"
    ...
    `}};Bt.styles=[ie,El];Bt.dependencies={"sl-icon-button":De};_([A({reflect:!0})],Bt.prototype,"variant",2);_([A({reflect:!0})],Bt.prototype,"size",2);_([A({type:Boolean,reflect:!0})],Bt.prototype,"pill",2);_([A({type:Boolean})],Bt.prototype,"removable",2);Bt.define("sl-tag");var Tl=Q`
  :host {
    display: block;
  }
...
`,he=class extends J{constructor(){super(...arguments),this.formControlController=new xt(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new Ne(this,"help-text","label"),this.hasFocus=!1,this.title="",this.name="",this.value="",this.size="medium",this.filled=!1,this.label="",this.helpText="",this.placeholder="",this.rows=4,this.resize="vertical",this.disabled=!1,this.readonly=!1,this.form="",this.required=!1,this.spellcheck=!0,this.defaultValue=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){var e;super.disconnectedCallback(),this.input&&((e=this.resizeObserver)==null||e.unobserve(this.input))}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleInput(){this.value=this.input.value,this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}setTextareaHeight(){this.resize==="auto"?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height="auto",this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=""}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top=="number"&&(this.input.scrollTop=e.top),typeof e.left=="number"&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,i="none"){this.input.setSelectionRange(e,t,i)}setRangeText(e,t,i,s="preserve"){const c=t!=null?t:this.input.selectionStart,g=i!=null?i:this.input.selectionEnd;this.input.setRangeText(e,c,g,s),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),i=this.label?!0:!!e,s=this.helpText?!0:!!t;return V`
      <div
        part="form-control"
...
`,Wi=class extends J{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("sl-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(i=>this.resizeObserver.unobserve(i)),this.observedElements=[],t.forEach(i=>{this.resizeObserver.observe(i),this.observedElements.push(i)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return V` <slot @slotchange=${this.handleSlotChange}></slot> `}};Wi.styles=[ie,Ol];_([A({type:Boolean,reflect:!0})],Wi.prototype,"disabled",2);_([q("disabled",{waitUntilFirstUpdate:!0})],Wi.prototype,"handleDisabledChange",1);function Ml(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var Zs=new Set;function Il(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function Pl(){const e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}function Ei(e){if(Zs.add(e),!document.documentElement.classList.contains("sl-scroll-lock")){const t=Il()+Pl();let i=getComputedStyle(document.documentElement).scrollbarGutter;(!i||i==="auto")&&(i="stable"),t<2&&(i=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",i),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${t}px`)}}function Ai(e){Zs.delete(e),Zs.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function Qs(e,t,i="vertical",s="smooth"){const c=Ml(e,t),g=c.top+t.scrollTop,b=c.left+t.scrollLeft,r=t.scrollLeft,o=t.scrollLeft+t.offsetWidth,u=t.scrollTop,m=t.scrollTop+t.offsetHeight;(i==="horizontal"||i==="both")&&(b<r?t.scrollTo({left:b,behavior:s}):b+e.clientWidth>o&&t.scrollTo({left:b-t.offsetWidth+e.clientWidth,behavior:s})),(i==="vertical"||i==="both")&&(g<u?t.scrollTo({top:g,behavior:s}):g+e.clientHeight>m&&t.scrollTo({top:g-t.offsetHeight+e.clientHeight,behavior:s}))}var Me=class extends J{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new ce(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){const e=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(t=>{const i=t.filter(({target:s})=>{if(s===this)return!0;if(s.closest("sl-tab-group")!==this)return!1;const c=s.tagName.toLowerCase();return c==="sl-tab"||c==="sl-tab-panel"});if(i.length!==0){if(i.some(s=>!["aria-labelledby","aria-controls"].includes(s.attributeName))&&setTimeout(()=>this.setAriaLabels()),i.some(s=>s.attributeName==="disabled"))this.syncTabsAndPanels();else if(i.some(s=>s.attributeName==="active")){const c=i.filter(g=>g.attributeName==="active"&&g.target.tagName.toLowerCase()==="sl-tab").map(g=>g.target).find(g=>g.active);c&&this.setActiveTab(c)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:["active","disabled","name","panel"],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((i,s)=>{var c;i[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab((c=this.getActiveTab())!=null?c:this.tabs[0],{emitEvents:!1}),s.unobserve(i[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect(),this.nav&&((t=this.resizeObserver)==null||t.unobserve(this.nav))}getAllTabs(){return this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()}getAllPanels(){return[...this.body.assignedElements()].filter(e=>e.tagName.toLowerCase()==="sl-tab-panel")}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){const i=e.target.closest("sl-tab");(i==null?void 0:i.closest("sl-tab-group"))===this&&i!==null&&this.setActiveTab(i,{scrollBehavior:"smooth"})}handleKeyDown(e){const i=e.target.closest("sl-tab");if((i==null?void 0:i.closest("sl-tab-group"))===this&&(["Enter"," "].includes(e.key)&&i!==null&&(this.setActiveTab(i,{scrollBehavior:"smooth"}),e.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key))){const c=this.tabs.find(r=>r.matches(":focus")),g=this.localize.dir()==="rtl";let b=null;if((c==null?void 0:c.tagName.toLowerCase())==="sl-tab"){if(e.key==="Home")b=this.focusableTabs[0];else if(e.key==="End")b=this.focusableTabs[this.focusableTabs.length-1];else if(["top","bottom"].includes(this.placement)&&e.key===(g?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&e.key==="ArrowUp"){const r=this.tabs.findIndex(o=>o===c);b=this.findNextFocusableTab(r,"backward")}else if(["top","bottom"].includes(this.placement)&&e.key===(g?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&e.key==="ArrowDown"){const r=this.tabs.findIndex(o=>o===c);b=this.findNextFocusableTab(r,"forward")}if(!b)return;b.tabIndex=0,b.focus({preventScroll:!0}),this.activation==="auto"?this.setActiveTab(b,{scrollBehavior:"smooth"}):this.tabs.forEach(r=>{r.tabIndex=r===b?0:-1}),["top","bottom"].includes(this.placement)&&Qs(b,this.nav,"horizontal"),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(e,t){if(t=Ct({emitEvents:!0,scrollBehavior:"auto"},t),e!==this.activeTab&&!e.disabled){const i=this.activeTab;this.activeTab=e,this.tabs.forEach(s=>{s.active=s===this.activeTab,s.tabIndex=s===this.activeTab?0:-1}),this.panels.forEach(s=>{var c;return s.active=s.name===((c=this.activeTab)==null?void 0:c.panel)}),this.syncIndicator(),["top","bottom"].includes(this.placement)&&Qs(this.activeTab,this.nav,"horizontal",t.scrollBehavior),t.emitEvents&&(i&&this.emit("sl-tab-hide",{detail:{name:i.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{const t=this.panels.find(i=>i.name===e.panel);t&&(e.setAttribute("aria-controls",t.getAttribute("id")),t.setAttribute("aria-labelledby",e.getAttribute("id")))})}repositionIndicator(){const e=this.getActiveTab();if(!e)return;const t=e.clientWidth,i=e.clientHeight,s=this.localize.dir()==="rtl",c=this.getAllTabs(),b=c.slice(0,c.indexOf(e)).reduce((r,o)=>({left:r.left+o.clientWidth,top:r.top+o.clientHeight}),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${t}px`,this.indicator.style.height="auto",this.indicator.style.translate=s?`${-1*b.left}px`:`${b.left}px`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${i}px`,this.indicator.style.translate=`0 ${b.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let i=null;const s=t==="forward"?1:-1;let c=e+s;for(;e<this.tabs.length;){if(i=this.tabs[c]||null,i===null){t==="forward"?i=this.focusableTabs[0]:i=this.focusableTabs[this.focusableTabs.length-1];break}if(!i.disabled)break;c+=s}return i}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(e){const t=this.tabs.find(i=>i.panel===e);t&&this.setActiveTab(t,{scrollBehavior:"smooth"})}render(){const e=this.localize.dir()==="rtl";return V`
      <div
        part="base"
    ...
    `}};Me.styles=[ie,Bl];Me.dependencies={"sl-icon-button":De,"sl-resize-observer":Wi};_([K(".tab-group")],Me.prototype,"tabGroup",2);_([K(".tab-group__body")],Me.prototype,"body",2);_([K(".tab-group__nav")],Me.prototype,"nav",2);_([K(".tab-group__indicator")],Me.prototype,"indicator",2);_([ee()],Me.prototype,"hasScrollControls",2);_([ee()],Me.prototype,"shouldHideScrollStartButton",2);_([ee()],Me.prototype,"shouldHideScrollEndButton",2);_([A()],Me.prototype,"placement",2);_([A()],Me.prototype,"activation",2);_([A({attribute:"no-scroll-controls",type:Boolean})],Me.prototype,"noScrollControls",2);_([A({attribute:"fixed-scroll-controls",type:Boolean})],Me.prototype,"fixedScrollControls",2);_([Pi({passive:!0})],Me.prototype,"updateScrollButtons",1);_([q("noScrollControls",{waitUntilFirstUpdate:!0})],Me.prototype,"updateScrollControls",1);_([q("placement",{waitUntilFirstUpdate:!0})],Me.prototype,"syncIndicator",1);Me.define("sl-tab-group");var zl=Q`
  :host {
    --border-radius: var(--sl-border-radius-pill);
...
`,ze=class extends J{constructor(){super(...arguments),this.formControlController=new xt(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new Ne(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("sl-change"),this.emit("sl-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("sl-change"),this.emit("sl-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return V`
    ...
    `}};ze.styles=[ie,jt,Hl];_([K('input[type="checkbox"]')],ze.prototype,"input",2);_([ee()],ze.prototype,"hasFocus",2);_([A()],ze.prototype,"title",2);_([A()],ze.prototype,"name",2);_([A()],ze.prototype,"value",2);_([A({reflect:!0})],ze.prototype,"size",2);_([A({type:Boolean,reflect:!0})],ze.prototype,"disabled",2);_([A({type:Boolean,reflect:!0})],ze.prototype,"checked",2);_([si("checked")],ze.prototype,"defaultChecked",2);_([A({reflect:!0})],ze.prototype,"form",2);_([A({type:Boolean,reflect:!0})],ze.prototype,"required",2);_([A({attribute:"help-text"})],ze.prototype,"helpText",2);_([q("checked",{waitUntilFirstUpdate:!0})],ze.prototype,"handleCheckedChange",1);_([q("disabled",{waitUntilFirstUpdate:!0})],ze.prototype,"handleDisabledChange",1);ze.define("sl-switch");Wi.define("sl-resize-observer");var Nl=Q`
  :host {
    display: block;
  }
...
`,we=class extends J{constructor(){super(...arguments),this.formControlController=new xt(this),this.hasSlotController=new Ne(this,"help-text","label"),this.localize=new ce(this),this.hasFocus=!1,this.hasTooltip=!1,this.title="",this.name="",this.value=0,this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.tooltip="top",this.tooltipFormatter=e=>e.toString(),this.form="",this.defaultValue=0}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.syncRange()),this.value<this.min&&(this.value=this.min),this.value>this.max&&(this.value=this.max),this.updateComplete.then(()=>{this.syncRange(),this.resizeObserver.observe(this.input)})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.resizeObserver)==null||e.unobserve(this.input)}handleChange(){this.emit("sl-change")}handleInput(){this.value=parseFloat(this.input.value),this.emit("sl-input"),this.syncRange()}handleBlur(){this.hasFocus=!1,this.hasTooltip=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.hasTooltip=!0,this.emit("sl-focus")}handleThumbDragStart(){this.hasTooltip=!0}handleThumbDragEnd(){this.hasTooltip=!1}syncProgress(e){this.input.style.setProperty("--percent",`${e*100}%`)}syncTooltip(e){if(this.output!==null){const t=this.input.offsetWidth,i=this.output.offsetWidth,s=getComputedStyle(this.input).getPropertyValue("--thumb-size"),c=this.localize.dir()==="rtl",g=t*e;if(c){const b=`${t-g}px + ${e} * ${s}`;this.output.style.translate=`calc((${b} - ${i/2}px - ${s} / 2))`}else{const b=`${g}px - ${e} * ${s}`;this.output.style.translate=`calc(${b} - ${i/2}px + ${s} / 2)`}}}handleValueChange(){this.formControlController.updateValidity(),this.input.value=this.value.toString(),this.value=parseFloat(this.input.value),this.syncRange()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}syncRange(){const e=Math.max(0,(this.value-this.min)/(this.max-this.min));this.syncProgress(e),this.tooltip!=="none"&&this.hasTooltip&&this.updateComplete.then(()=>this.syncTooltip(e))}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}focus(e){this.input.focus(e)}blur(){this.input.blur()}stepUp(){this.input.stepUp(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value))}stepDown(){this.input.stepDown(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value))}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),i=this.label?!0:!!e,s=this.helpText?!0:!!t;return V`
    ...
    `}};we.styles=[ie,jt,Ul];_([K(".range__control")],we.prototype,"input",2);_([K(".range__tooltip")],we.prototype,"output",2);_([ee()],we.prototype,"hasFocus",2);_([ee()],we.prototype,"hasTooltip",2);_([A()],we.prototype,"title",2);_([A()],we.prototype,"name",2);_([A({type:Number})],we.prototype,"value",2);_([A()],we.prototype,"label",2);_([A({attribute:"help-text"})],we.prototype,"helpText",2);_([A({type:Boolean,reflect:!0})],we.prototype,"disabled",2);_([A({type:Number})],we.prototype,"min",2);_([A({type:Number})],we.prototype,"max",2);_([A({type:Number})],we.prototype,"step",2);_([A()],we.prototype,"tooltip",2);_([A({attribute:!1})],we.prototype,"tooltipFormatter",2);_([A({reflect:!0})],we.prototype,"form",2);_([si()],we.prototype,"defaultValue",2);_([Pi({passive:!0})],we.prototype,"handleThumbDragStart",1);_([q("value",{waitUntilFirstUpdate:!0})],we.prototype,"handleValueChange",1);_([q("disabled",{waitUntilFirstUpdate:!0})],we.prototype,"handleDisabledChange",1);_([q("hasTooltip",{waitUntilFirstUpdate:!0})],we.prototype,"syncRange",1);we.define("sl-range");var Wl=Q`
  :host {
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jo="important",Vl=" !"+Jo,We=zi(class extends Fi{constructor(e){var t;if(super(e),e.type!==pt.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return s==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const s of this.ft)t[s]==null&&(this.ft.delete(s),s.includes("-")?i.removeProperty(s):i[s]=null);for(const s in t){const c=t[s];if(c!=null){this.ft.add(s);const g=typeof c=="string"&&c.endsWith(Vl);s.includes("-")||g?i.setProperty(s,g?c.slice(0,-11):c,g?Jo:""):i[s]=c}}return Ke}});var Fe=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.hoverValue=0,this.isHovering=!1,this.label="",this.value=0,this.max=5,this.precision=1,this.readonly=!1,this.disabled=!1,this.getSymbol=()=>'<sl-icon name="star-fill" library="system"></sl-icon>'}getValueFromMousePosition(e){return this.getValueFromXCoordinate(e.clientX)}getValueFromTouchPosition(e){return this.getValueFromXCoordinate(e.touches[0].clientX)}getValueFromXCoordinate(e){const t=this.localize.dir()==="rtl",{left:i,right:s,width:c}=this.rating.getBoundingClientRect(),g=t?this.roundToPrecision((s-e)/c*this.max,this.precision):this.roundToPrecision((e-i)/c*this.max,this.precision);return Ee(g,0,this.max)}handleClick(e){this.disabled||(this.setValue(this.getValueFromMousePosition(e)),this.emit("sl-change"))}setValue(e){this.disabled||this.readonly||(this.value=e===this.value?0:e,this.isHovering=!1)}handleKeyDown(e){const t=this.localize.dir()==="ltr",i=this.localize.dir()==="rtl",s=this.value;if(!(this.disabled||this.readonly)){if(e.key==="ArrowDown"||t&&e.key==="ArrowLeft"||i&&e.key==="ArrowRight"){const c=e.shiftKey?1:this.precision;this.value=Math.max(0,this.value-c),e.preventDefault()}if(e.key==="ArrowUp"||t&&e.key==="ArrowRight"||i&&e.key==="ArrowLeft"){const c=e.shiftKey?1:this.precision;this.value=Math.min(this.max,this.value+c),e.preventDefault()}e.key==="Home"&&(this.value=0,e.preventDefault()),e.key==="End"&&(this.value=this.max,e.preventDefault()),this.value!==s&&this.emit("sl-change")}}handleMouseEnter(e){this.isHovering=!0,this.hoverValue=this.getValueFromMousePosition(e)}handleMouseMove(e){this.hoverValue=this.getValueFromMousePosition(e)}handleMouseLeave(){this.isHovering=!1}handleTouchStart(e){this.isHovering=!0,this.hoverValue=this.getValueFromTouchPosition(e),e.preventDefault()}handleTouchMove(e){this.hoverValue=this.getValueFromTouchPosition(e)}handleTouchEnd(e){this.isHovering=!1,this.setValue(this.hoverValue),this.emit("sl-change"),e.preventDefault()}roundToPrecision(e,t=.5){const i=1/t;return Math.ceil(e*i)/i}handleHoverValueChange(){this.emit("sl-hover",{detail:{phase:"move",value:this.hoverValue}})}handleIsHoveringChange(){this.emit("sl-hover",{detail:{phase:this.isHovering?"start":"end",value:this.hoverValue}})}focus(e){this.rating.focus(e)}blur(){this.rating.blur()}render(){const e=this.localize.dir()==="rtl",t=Array.from(Array(this.max).keys());let i=0;return this.disabled||this.readonly?i=this.value:i=this.isHovering?this.hoverValue:this.value,V`
      <div
        part="base"
...
`,Xt=class extends J{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(e){const t=bi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(e){const t=bi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(e){const t=bi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(e){const t=bi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const i=e.indexOf(t),s=bi(t);s&&(s.toggleAttribute("data-sl-button-group__button",!0),s.toggleAttribute("data-sl-button-group__button--first",i===0),s.toggleAttribute("data-sl-button-group__button--inner",i>0&&i<e.length-1),s.toggleAttribute("data-sl-button-group__button--last",i===e.length-1),s.toggleAttribute("data-sl-button-group__button--radio",s.tagName.toLowerCase()==="sl-radio-button"))})}render(){return V`
    ...
    `}};Ie.styles=[ie,jt,Kl];Ie.dependencies={"sl-button-group":Xt};_([K("slot:not([name])")],Ie.prototype,"defaultSlot",2);_([K(".radio-group__validation-input")],Ie.prototype,"validationInput",2);_([ee()],Ie.prototype,"hasButtonGroup",2);_([ee()],Ie.prototype,"errorMessage",2);_([ee()],Ie.prototype,"defaultValue",2);_([A()],Ie.prototype,"label",2);_([A({attribute:"help-text"})],Ie.prototype,"helpText",2);_([A()],Ie.prototype,"name",2);_([A({reflect:!0})],Ie.prototype,"value",2);_([A({reflect:!0})],Ie.prototype,"size",2);_([A({reflect:!0})],Ie.prototype,"form",2);_([A({type:Boolean,reflect:!0})],Ie.prototype,"required",2);_([q("size",{waitUntilFirstUpdate:!0})],Ie.prototype,"handleSizeChange",1);_([q("value")],Ie.prototype,"handleValueChange",1);Ie.define("sl-radio-group");var Gl=Q`
  :host {
    --size: 128px;
    --track-width: 4px;
    --track-color: var(--sl-color-neutral-200);
...
`;let Qo=null;class en{}en.render=function(e,t){Qo(e,t)};self.QrCreator=en;(function(e){function t(r,o,u,m){var l={},f=e(u,o);f.u(r),f.J(),m=m||0;var y=f.h(),C=f.h()+2*m;return l.text=r,l.level=o,l.version=u,l.O=C,l.a=function(S,n){return S-=m,n-=m,0>S||S>=y||0>n||n>=y?!1:f.a(S,n)},l}function i(r,o,u,m,l,f,y,C,S,n){function d(a,h,p,v,x,E,w){a?(r.lineTo(h+E,p+w),r.arcTo(h,p,v,x,f)):r.lineTo(h,p)}y?r.moveTo(o+f,u):r.moveTo(o,u),d(C,m,u,m,l,-f,0),d(S,m,l,o,l,0,-f),d(n,o,l,o,u,f,0),d(y,o,u,m,u,0,f)}function s(r,o,u,m,l,f,y,C,S,n){function d(a,h,p,v){r.moveTo(a+p,h),r.lineTo(a,h),r.lineTo(a,h+v),r.arcTo(a,h,a+p,h,f)}y&&d(o,u,f,f),C&&d(m,u,-f,f),S&&d(m,l,-f,-f),n&&d(o,l,f,-f)}function c(r,o){var u=o.fill;if(typeof u=="string")r.fillStyle=u;else{var m=u.type,l=u.colorStops;if(u=u.position.map(y=>Math.round(y*o.size)),m==="linear-gradient")var f=r.createLinearGradient.apply(r,u);else if(m==="radial-gradient")f=r.createRadialGradient.apply(r,u);else throw Error("Unsupported fill");l.forEach(([y,C])=>{f.addColorStop(y,C)}),r.fillStyle=f}}function g(r,o){e:{var u=o.text,m=o.v,l=o.N,f=o.K,y=o.P;for(l=Math.max(1,l||1),f=Math.min(40,f||40);l<=f;l+=1)try{var C=t(u,m,l,y);break e}catch{}C=void 0}if(!C)return null;for(u=r.getContext("2d"),o.background&&(u.fillStyle=o.background,u.fillRect(o.left,o.top,o.size,o.size)),m=C.O,f=o.size/m,u.beginPath(),y=0;y<m;y+=1)for(l=0;l<m;l+=1){var S=u,n=o.left+l*f,d=o.top+y*f,a=y,h=l,p=C.a,v=n+f,x=d+f,E=a-1,w=a+1,k=h-1,T=h+1,B=Math.floor(Math.min(.5,Math.max(0,o.R))*f),R=p(a,h),O=p(E,k),z=p(E,h);E=p(E,T);var F=p(a,T);T=p(w,T),h=p(w,h),w=p(w,k),a=p(a,k),n=Math.round(n),d=Math.round(d),v=Math.round(v),x=Math.round(x),R?i(S,n,d,v,x,B,!z&&!a,!z&&!F,!h&&!F,!h&&!a):s(S,n,d,v,x,B,z&&a&&O,z&&F&&E,h&&F&&T,h&&a&&w)}return c(u,o),u.fill(),r}var b={minVersion:1,maxVersion:40,ecLevel:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",radius:.5,quiet:0};Qo=function(r,o){var u={};Object.assign(u,b,r),u.N=u.minVersion,u.K=u.maxVersion,u.v=u.ecLevel,u.left=u.left,u.top=u.top,u.size=u.size,u.fill=u.fill,u.background=u.background,u.text=u.text,u.R=u.radius,u.P=u.quiet,o instanceof HTMLCanvasElement?((o.width!==u.size||o.height!==u.size)&&(o.width=u.size,o.height=u.size),o.getContext("2d").clearRect(0,0,o.width,o.height),g(o,u)):(r=document.createElement("canvas"),r.width=u.size,r.height=u.size,u=g(r,u),o.appendChild(u))}})(function(){function e(o){var u=i.s(o);return{S:function(){return 4},b:function(){return u.length},write:function(m){for(var l=0;l<u.length;l+=1)m.put(u[l],8)}}}function t(){var o=[],u=0,m={B:function(){return o},c:function(l){return(o[Math.floor(l/8)]>>>7-l%8&1)==1},put:function(l,f){for(var y=0;y<f;y+=1)m.m((l>>>f-y-1&1)==1)},f:function(){return u},m:function(l){var f=Math.floor(u/8);o.length<=f&&o.push(0),l&&(o[f]|=128>>>u%8),u+=1}};return m}function i(o,u){function m(a,h){for(var p=-1;7>=p;p+=1)if(!(-1>=a+p||C<=a+p))for(var v=-1;7>=v;v+=1)-1>=h+v||C<=h+v||(y[a+p][h+v]=0<=p&&6>=p&&(v==0||v==6)||0<=v&&6>=v&&(p==0||p==6)||2<=p&&4>=p&&2<=v&&4>=v)}function l(a,h){for(var p=C=4*o+17,v=Array(p),x=0;x<p;x+=1){v[x]=Array(p);for(var E=0;E<p;E+=1)v[x][E]=null}for(y=v,m(0,0),m(C-7,0),m(0,C-7),p=g.G(o),v=0;v<p.length;v+=1)for(x=0;x<p.length;x+=1){E=p[v];var w=p[x];if(y[E][w]==null)for(var k=-2;2>=k;k+=1)for(var T=-2;2>=T;T+=1)y[E+k][w+T]=k==-2||k==2||T==-2||T==2||k==0&&T==0}for(p=8;p<C-8;p+=1)y[p][6]==null&&(y[p][6]=p%2==0);for(p=8;p<C-8;p+=1)y[6][p]==null&&(y[6][p]=p%2==0);for(p=g.w(f<<3|h),v=0;15>v;v+=1)x=!a&&(p>>v&1)==1,y[6>v?v:8>v?v+1:C-15+v][8]=x,y[8][8>v?C-v-1:9>v?15-v:14-v]=x;if(y[C-8][8]=!a,7<=o){for(p=g.A(o),v=0;18>v;v+=1)x=!a&&(p>>v&1)==1,y[Math.floor(v/3)][v%3+C-8-3]=x;for(v=0;18>v;v+=1)x=!a&&(p>>v&1)==1,y[v%3+C-8-3][Math.floor(v/3)]=x}if(S==null){for(a=r.I(o,f),p=t(),v=0;v<n.length;v+=1)x=n[v],p.put(4,4),p.put(x.b(),g.f(4,o)),x.write(p);for(v=x=0;v<a.length;v+=1)x+=a[v].j;if(p.f()>8*x)throw Error("code length overflow. ("+p.f()+">"+8*x+")");for(p.f()+4<=8*x&&p.put(0,4);p.f()%8!=0;)p.m(!1);for(;!(p.f()>=8*x)&&(p.put(236,8),!(p.f()>=8*x));)p.put(17,8);var B=0;for(x=v=0,E=Array(a.length),w=Array(a.length),k=0;k<a.length;k+=1){var R=a[k].j,O=a[k].o-R;for(v=Math.max(v,R),x=Math.max(x,O),E[k]=Array(R),T=0;T<E[k].length;T+=1)E[k][T]=255&p.B()[T+B];for(B+=R,T=g.C(O),R=s(E[k],T.b()-1).l(T),w[k]=Array(T.b()-1),T=0;T<w[k].length;T+=1)O=T+R.b()-w[k].length,w[k][T]=0<=O?R.c(O):0}for(T=p=0;T<a.length;T+=1)p+=a[T].o;for(p=Array(p),T=B=0;T<v;T+=1)for(k=0;k<a.length;k+=1)T<E[k].length&&(p[B]=E[k][T],B+=1);for(T=0;T<x;T+=1)for(k=0;k<a.length;k+=1)T<w[k].length&&(p[B]=w[k][T],B+=1);S=p}for(a=S,p=-1,v=C-1,x=7,E=0,h=g.F(h),w=C-1;0<w;w-=2)for(w==6&&--w;;){for(k=0;2>k;k+=1)y[v][w-k]==null&&(T=!1,E<a.length&&(T=(a[E]>>>x&1)==1),h(v,w-k)&&(T=!T),y[v][w-k]=T,--x,x==-1&&(E+=1,x=7));if(v+=p,0>v||C<=v){v-=p,p=-p;break}}}var f=c[u],y=null,C=0,S=null,n=[],d={u:function(a){a=e(a),n.push(a),S=null},a:function(a,h){if(0>a||C<=a||0>h||C<=h)throw Error(a+","+h);return y[a][h]},h:function(){return C},J:function(){for(var a=0,h=0,p=0;8>p;p+=1){l(!0,p);var v=g.D(d);(p==0||a>v)&&(a=v,h=p)}l(!1,h)}};return d}function s(o,u){if(typeof o.length>"u")throw Error(o.length+"/"+u);var m=function(){for(var f=0;f<o.length&&o[f]==0;)f+=1;for(var y=Array(o.length-f+u),C=0;C<o.length-f;C+=1)y[C]=o[C+f];return y}(),l={c:function(f){return m[f]},b:function(){return m.length},multiply:function(f){for(var y=Array(l.b()+f.b()-1),C=0;C<l.b();C+=1)for(var S=0;S<f.b();S+=1)y[C+S]^=b.i(b.g(l.c(C))+b.g(f.c(S)));return s(y,0)},l:function(f){if(0>l.b()-f.b())return l;for(var y=b.g(l.c(0))-b.g(f.c(0)),C=Array(l.b()),S=0;S<l.b();S+=1)C[S]=l.c(S);for(S=0;S<f.b();S+=1)C[S]^=b.i(b.g(f.c(S))+y);return s(C,0).l(f)}};return l}i.s=function(o){for(var u=[],m=0;m<o.length;m++){var l=o.charCodeAt(m);128>l?u.push(l):2048>l?u.push(192|l>>6,128|l&63):55296>l||57344<=l?u.push(224|l>>12,128|l>>6&63,128|l&63):(m++,l=65536+((l&1023)<<10|o.charCodeAt(m)&1023),u.push(240|l>>18,128|l>>12&63,128|l>>6&63,128|l&63))}return u};var c={L:1,M:0,Q:3,H:2},g=function(){function o(l){for(var f=0;l!=0;)f+=1,l>>>=1;return f}var u=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],m={w:function(l){for(var f=l<<10;0<=o(f)-o(1335);)f^=1335<<o(f)-o(1335);return(l<<10|f)^21522},A:function(l){for(var f=l<<12;0<=o(f)-o(7973);)f^=7973<<o(f)-o(7973);return l<<12|f},G:function(l){return u[l-1]},F:function(l){switch(l){case 0:return function(f,y){return(f+y)%2==0};case 1:return function(f){return f%2==0};case 2:return function(f,y){return y%3==0};case 3:return function(f,y){return(f+y)%3==0};case 4:return function(f,y){return(Math.floor(f/2)+Math.floor(y/3))%2==0};case 5:return function(f,y){return f*y%2+f*y%3==0};case 6:return function(f,y){return(f*y%2+f*y%3)%2==0};case 7:return function(f,y){return(f*y%3+(f+y)%2)%2==0};default:throw Error("bad maskPattern:"+l)}},C:function(l){for(var f=s([1],0),y=0;y<l;y+=1)f=f.multiply(s([1,b.i(y)],0));return f},f:function(l,f){if(l!=4||1>f||40<f)throw Error("mode: "+l+"; type: "+f);return 10>f?8:16},D:function(l){for(var f=l.h(),y=0,C=0;C<f;C+=1)for(var S=0;S<f;S+=1){for(var n=0,d=l.a(C,S),a=-1;1>=a;a+=1)if(!(0>C+a||f<=C+a))for(var h=-1;1>=h;h+=1)0>S+h||f<=S+h||(a!=0||h!=0)&&d==l.a(C+a,S+h)&&(n+=1);5<n&&(y+=3+n-5)}for(C=0;C<f-1;C+=1)for(S=0;S<f-1;S+=1)n=0,l.a(C,S)&&(n+=1),l.a(C+1,S)&&(n+=1),l.a(C,S+1)&&(n+=1),l.a(C+1,S+1)&&(n+=1),(n==0||n==4)&&(y+=3);for(C=0;C<f;C+=1)for(S=0;S<f-6;S+=1)l.a(C,S)&&!l.a(C,S+1)&&l.a(C,S+2)&&l.a(C,S+3)&&l.a(C,S+4)&&!l.a(C,S+5)&&l.a(C,S+6)&&(y+=40);for(S=0;S<f;S+=1)for(C=0;C<f-6;C+=1)l.a(C,S)&&!l.a(C+1,S)&&l.a(C+2,S)&&l.a(C+3,S)&&l.a(C+4,S)&&!l.a(C+5,S)&&l.a(C+6,S)&&(y+=40);for(S=n=0;S<f;S+=1)for(C=0;C<f;C+=1)l.a(C,S)&&(n+=1);return y+=Math.abs(100*n/f/f-50)/5*10}};return m}(),b=function(){for(var o=Array(256),u=Array(256),m=0;8>m;m+=1)o[m]=1<<m;for(m=8;256>m;m+=1)o[m]=o[m-4]^o[m-5]^o[m-6]^o[m-8];for(m=0;255>m;m+=1)u[o[m]]=m;return{g:function(l){if(1>l)throw Error("glog("+l+")");return u[l]},i:function(l){for(;0>l;)l+=255;for(;256<=l;)l-=255;return o[l]}}}(),r=function(){function o(l,f){switch(f){case c.L:return u[4*(l-1)];case c.M:return u[4*(l-1)+1];case c.Q:return u[4*(l-1)+2];case c.H:return u[4*(l-1)+3]}}var u=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],m={I:function(l,f){var y=o(l,f);if(typeof y>"u")throw Error("bad rs block @ typeNumber:"+l+"/errorCorrectLevel:"+f);l=y.length/3,f=[];for(var C=0;C<l;C+=1)for(var S=y[3*C],n=y[3*C+1],d=y[3*C+2],a=0;a<S;a+=1){var h=d,p={};p.o=n,p.j=h,f.push(p)}return f}};return m}();return i}());const Jl=QrCreator;var lt=class extends J{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H"}firstUpdated(){this.generate()}generate(){!this.hasUpdated||Jl.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:this.background,size:this.size*2},this.canvas)}render(){var e;return V`
      <canvas
        part="base"
        class="qr-code"
        role="img"
...
`,Vi=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return V`
      <div
        part="base"
    ...
    `}};Vi.styles=[ie,ec];_([A({type:Number,reflect:!0})],Vi.prototype,"value",2);_([A({type:Boolean,reflect:!0})],Vi.prototype,"indeterminate",2);_([A()],Vi.prototype,"label",2);Vi.define("sl-progress-bar");var tc=Q`
  :host {
    display: block;
  }
...
`,_r=class extends J{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),s=i.find(r=>{var o;return t.includes(((o=r==null?void 0:r.getAttribute)==null?void 0:o.call(r,"role"))||"")});if(!s||i.find(r=>{var o;return((o=r==null?void 0:r.getAttribute)==null?void 0:o.call(r,"role"))==="menu"})!==this)return;const b=s;b.type==="checkbox"&&(b.checked=!b.checked),this.emit("sl-select",{detail:{item:b}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t==null||t.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let s=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?s++:e.key==="ArrowUp"?s--:e.key==="Home"?s=0:e.key==="End"&&(s=t.length-1),s<0&&(s=t.length-1),s>t.length-1&&(s=0),this.setCurrentItem(t[s]),t[s].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return V`
      <slot
...
`,Gt=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.position=50}handleDrag(e){const{width:t}=this.base.getBoundingClientRect(),i=this.localize.dir()==="rtl";e.preventDefault(),Li(this.base,{onMove:s=>{this.position=parseFloat(Ee(s/t*100,0,100).toFixed(2)),i&&(this.position=100-this.position)},initialEvent:e})}handleKeyDown(e){const t=this.localize.dir()==="ltr",i=this.localize.dir()==="rtl";if(["ArrowLeft","ArrowRight","Home","End"].includes(e.key)){const s=e.shiftKey?10:1;let c=this.position;e.preventDefault(),(t&&e.key==="ArrowLeft"||i&&e.key==="ArrowRight")&&(c-=s),(t&&e.key==="ArrowRight"||i&&e.key==="ArrowLeft")&&(c+=s),e.key==="Home"&&(c=0),e.key==="End"&&(c=100),c=Ee(c,0,100),this.position=c}}handlePositionChange(){this.emit("sl-change")}render(){const e=this.localize.dir()==="rtl";return V`
    ...
    `}};Gt.styles=[ie,fc];Gt.scopedElement={"sl-icon":me};_([K(".image-comparer")],Gt.prototype,"base",2);_([K(".image-comparer__handle")],Gt.prototype,"handle",2);_([A({type:Number,reflect:!0})],Gt.prototype,"position",2);_([q("position",{waitUntilFirstUpdate:!0})],Gt.prototype,"handlePositionChange",1);Gt.define("sl-image-comparer");var gc=Q`
  :host {
    display: block;
  }
`,Hs=new Map;function mc(e,t="cors"){const i=Hs.get(e);if(i!==void 0)return Promise.resolve(i);const s=fetch(e,{mode:t}).then(async c=>{const g={ok:c.ok,status:c.status,html:await c.text()};return Hs.set(e,g),g});return Hs.set(e,s),s}var li=class extends J{constructor(){super(...arguments),this.mode="cors",this.allowScripts=!1}executeScript(e){const t=document.createElement("script");[...e.attributes].forEach(i=>t.setAttribute(i.name,i.value)),t.textContent=e.textContent,e.parentNode.replaceChild(t,e)}async handleSrcChange(){try{const e=this.src,t=await mc(e,this.mode);if(e!==this.src)return;if(!t.ok){this.emit("sl-error",{detail:{status:t.status}});return}this.innerHTML=t.html,this.allowScripts&&[...this.querySelectorAll("script")].forEach(i=>this.executeScript(i)),this.emit("sl-load")}catch{this.emit("sl-error",{detail:{status:-1}})}}render(){return V`<slot></slot>`}};li.styles=[ie,gc];_([A()],li.prototype,"src",2);_([A()],li.prototype,"mode",2);_([A({attribute:"allow-scripts",type:Boolean})],li.prototype,"allowScripts",2);_([q("src")],li.prototype,"handleSrcChange",1);li.define("sl-include");me.define("sl-icon");De.define("sl-icon-button");var ys=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.value=0,this.unit="byte",this.display="short"}render(){if(isNaN(this.value))return"";const e=["","kilo","mega","giga","tera"],t=["","kilo","mega","giga","tera","peta"],i=this.unit==="bit"?e:t,s=Math.max(0,Math.min(Math.floor(Math.log10(this.value)/3),i.length-1)),c=i[s]+this.unit,g=parseFloat((this.value/Math.pow(1e3,s)).toPrecision(3));return this.localize.number(g,{style:"unit",unit:c,unitDisplay:this.display})}};_([A({type:Number})],ys.prototype,"value",2);_([A()],ys.prototype,"unit",2);_([A()],ys.prototype,"display",2);ys.define("sl-format-bytes");var Je=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.date=new Date,this.hourFormat="auto"}render(){const e=new Date(this.date),t=this.hourFormat==="auto"?void 0:this.hourFormat==="12";if(!isNaN(e.getMilliseconds()))return V`
...
`,Pe=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{var t;if(e.key==="Escape"&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key==="Tab"){if(this.open&&((t=document.activeElement)==null?void 0:t.tagName.toLowerCase())==="sl-menu-item"){e.preventDefault(),this.hide(),this.focusOnTrigger();return}const i=(s,c)=>{if(!s)return null;const g=s.closest(c);if(g)return g;const b=s.getRootNode();return b instanceof ShadowRoot?i(b.host,c):null};setTimeout(()=>{var s;const c=((s=this.containingElement)==null?void 0:s.getRootNode())instanceof ShadowRoot?rn():document.activeElement;(!this.containingElement||i(c,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{const t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{const t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const e=this.trigger.assignedElements({flatten:!0})[0];typeof(e==null?void 0:e.focus)=="function"&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([" ","Enter"].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}const t=this.getMenu();if(t){const i=t.getAllItems(),s=i[0],c=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(e.key==="ArrowDown"||e.key==="Home")&&(t.setCurrentItem(s),s.focus()),(e.key==="ArrowUp"||e.key==="End")&&(t.setCurrentItem(c),c.focus())}))}}handleTriggerKeyUp(e){e.key===" "&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const t=this.trigger.assignedElements({flatten:!0}).find(s=>Sc(s).start);let i;if(t){switch(t.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=t.button;break;default:i=t}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,He(this,"sl-after-show")}async hide(){if(!!this.open)return this.open=!1,He(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var e;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var e;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await Ae(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=_e(this,"dropdown.show",{dir:this.localize.dir()});await Ce(this.popup.popup,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await Ae(this);const{keyframes:e,options:t}=_e(this,"dropdown.hide",{dir:this.localize.dir()});await Ce(this.popup.popup,e,t),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return V`
      <sl-popup
        part="base"
...
`,Re=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.isCopying=!1,this.status="rest",this.value="",this.from="",this.disabled=!1,this.copyLabel="",this.successLabel="",this.errorLabel="",this.feedbackDuration=1e3,this.tooltipPlacement="top",this.hoist=!1}async handleCopy(){if(this.disabled||this.isCopying)return;this.isCopying=!0;let e=this.value;if(this.from){const t=this.getRootNode(),i=this.from.includes("."),s=this.from.includes("[")&&this.from.includes("]");let c=this.from,g="";i?[c,g]=this.from.trim().split("."):s&&([c,g]=this.from.trim().replace(/\]$/,"").split("["));const b="getElementById"in t?t.getElementById(c):null;b?s?e=b.getAttribute(g)||"":i?e=b[g]||"":e=b.textContent||"":(this.showStatus("error"),this.emit("sl-error"))}if(!e)this.showStatus("error"),this.emit("sl-error");else try{await navigator.clipboard.writeText(e),this.showStatus("success"),this.emit("sl-copy",{detail:{value:e}})}catch{this.showStatus("error"),this.emit("sl-error")}}async showStatus(e){const t=this.copyLabel||this.localize.term("copy"),i=this.successLabel||this.localize.term("copied"),s=this.errorLabel||this.localize.term("error"),c=e==="success"?this.successIcon:this.errorIcon,g=_e(this,"copy.in",{dir:"ltr"}),b=_e(this,"copy.out",{dir:"ltr"});this.tooltip.content=e==="success"?i:s,await this.copyIcon.animate(b.keyframes,b.options).finished,this.copyIcon.hidden=!0,this.status=e,c.hidden=!1,await c.animate(g.keyframes,g.options).finished,setTimeout(async()=>{await c.animate(b.keyframes,b.options).finished,c.hidden=!0,this.status="rest",this.copyIcon.hidden=!1,await this.copyIcon.animate(g.keyframes,g.options).finished,this.tooltip.content=t,this.isCopying=!1},this.feedbackDuration)}render(){const e=this.copyLabel||this.localize.term("copy");return V`
      <sl-tooltip
...
`,fe=class extends J{constructor(){super(...arguments),this.formControlController=new xt(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new Ne(this,"[default]","prefix","suffix"),this.localize=new ce(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:fs}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?ds`a`:ds`button`;return ki`
    ...
    `}};fe.styles=[ie,Zo];fe.dependencies={"sl-icon":me,"sl-spinner":Hi};_([K(".button")],fe.prototype,"button",2);_([ee()],fe.prototype,"hasFocus",2);_([ee()],fe.prototype,"invalid",2);_([A()],fe.prototype,"title",2);_([A({reflect:!0})],fe.prototype,"variant",2);_([A({reflect:!0})],fe.prototype,"size",2);_([A({type:Boolean,reflect:!0})],fe.prototype,"caret",2);_([A({type:Boolean,reflect:!0})],fe.prototype,"disabled",2);_([A({type:Boolean,reflect:!0})],fe.prototype,"loading",2);_([A({type:Boolean,reflect:!0})],fe.prototype,"outline",2);_([A({type:Boolean,reflect:!0})],fe.prototype,"pill",2);_([A({type:Boolean,reflect:!0})],fe.prototype,"circle",2);_([A()],fe.prototype,"type",2);_([A()],fe.prototype,"name",2);_([A()],fe.prototype,"value",2);_([A()],fe.prototype,"href",2);_([A()],fe.prototype,"target",2);_([A()],fe.prototype,"rel",2);_([A()],fe.prototype,"download",2);_([A()],fe.prototype,"form",2);_([A({attribute:"formaction"})],fe.prototype,"formAction",2);_([A({attribute:"formenctype"})],fe.prototype,"formEnctype",2);_([A({attribute:"formmethod"})],fe.prototype,"formMethod",2);_([A({attribute:"formnovalidate",type:Boolean})],fe.prototype,"formNoValidate",2);_([A({attribute:"formtarget"})],fe.prototype,"formTarget",2);_([q("disabled",{waitUntilFirstUpdate:!0})],fe.prototype,"handleDisabledChange",1);function Oe(e,t){Dc(e)&&(e="100%");const i=Tc(e);return e=t===360?e:Math.min(t,Math.max(0,parseFloat(e))),i&&(e=parseInt(String(e*t),10)/100),Math.abs(e-t)<1e-6?1:(t===360?e=(e<0?e%t+t:e%t)/parseFloat(String(t)):e=e%t/parseFloat(String(t)),e)}function Zi(e){return Math.min(1,Math.max(0,e))}function Dc(e){return typeof e=="string"&&e.indexOf(".")!==-1&&parseFloat(e)===1}function Tc(e){return typeof e=="string"&&e.indexOf("%")!==-1}function an(e){return e=parseFloat(e),(isNaN(e)||e<0||e>1)&&(e=1),e}function Qi(e){return Number(e)<=1?`${Number(e)*100}%`:e}function Ht(e){return e.length===1?"0"+e:String(e)}function Rc(e,t,i){return{r:Oe(e,255)*255,g:Oe(t,255)*255,b:Oe(i,255)*255}}function to(e,t,i){e=Oe(e,255),t=Oe(t,255),i=Oe(i,255);const s=Math.max(e,t,i),c=Math.min(e,t,i);let g=0,b=0;const r=(s+c)/2;if(s===c)b=0,g=0;else{const o=s-c;switch(b=r>.5?o/(2-s-c):o/(s+c),s){case e:g=(t-i)/o+(t<i?6:0);break;case t:g=(i-e)/o+2;break;case i:g=(e-t)/o+4;break}g/=6}return{h:g,s:b,l:r}}function Ns(e,t,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?e+(t-e)*(6*i):i<1/2?t:i<2/3?e+(t-e)*(2/3-i)*6:e}function $c(e,t,i){let s,c,g;if(e=Oe(e,360),t=Oe(t,100),i=Oe(i,100),t===0)c=i,g=i,s=i;else{const b=i<.5?i*(1+t):i+t-i*t,r=2*i-b;s=Ns(r,b,e+1/3),c=Ns(r,b,e),g=Ns(r,b,e-1/3)}return{r:s*255,g:c*255,b:g*255}}function io(e,t,i){e=Oe(e,255),t=Oe(t,255),i=Oe(i,255);const s=Math.max(e,t,i),c=Math.min(e,t,i);let g=0;const b=s,r=s-c,o=s===0?0:r/s;if(s===c)g=0;else{switch(s){case e:g=(t-i)/r+(t<i?6:0);break;case t:g=(i-e)/r+2;break;case i:g=(e-t)/r+4;break}g/=6}return{h:g,s:o,v:b}}function Bc(e,t,i){e=Oe(e,360)*6,t=Oe(t,100),i=Oe(i,100);const s=Math.floor(e),c=e-s,g=i*(1-t),b=i*(1-c*t),r=i*(1-(1-c)*t),o=s%6,u=[i,b,g,g,r,i][o],m=[r,i,i,b,g,g][o],l=[g,g,r,i,i,b][o];return{r:u*255,g:m*255,b:l*255}}function so(e,t,i,s){const c=[Ht(Math.round(e).toString(16)),Ht(Math.round(t).toString(16)),Ht(Math.round(i).toString(16))];return s&&c[0].startsWith(c[0].charAt(1))&&c[1].startsWith(c[1].charAt(1))&&c[2].startsWith(c[2].charAt(1))?c[0].charAt(0)+c[1].charAt(0)+c[2].charAt(0):c.join("")}function Oc(e,t,i,s,c){const g=[Ht(Math.round(e).toString(16)),Ht(Math.round(t).toString(16)),Ht(Math.round(i).toString(16)),Ht(Ic(s))];return c&&g[0].startsWith(g[0].charAt(1))&&g[1].startsWith(g[1].charAt(1))&&g[2].startsWith(g[2].charAt(1))&&g[3].startsWith(g[3].charAt(1))?g[0].charAt(0)+g[1].charAt(0)+g[2].charAt(0)+g[3].charAt(0):g.join("")}function Mc(e,t,i,s){const c=e/100,g=t/100,b=i/100,r=s/100,o=255*(1-c)*(1-r),u=255*(1-g)*(1-r),m=255*(1-b)*(1-r);return{r:o,g:u,b:m}}function ro(e,t,i){let s=1-e/255,c=1-t/255,g=1-i/255,b=Math.min(s,c,g);return b===1?(s=0,c=0,g=0):(s=(s-b)/(1-b)*100,c=(c-b)/(1-b)*100,g=(g-b)/(1-b)*100),b*=100,{c:Math.round(s),m:Math.round(c),y:Math.round(g),k:Math.round(b)}}function Ic(e){return Math.round(parseFloat(e)*255).toString(16)}function oo(e){return je(e)/255}function je(e){return parseInt(e,16)}function Pc(e){return{r:e>>16,g:(e&65280)>>8,b:e&255}}const ir={aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#00ffff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000000",blanchedalmond:"#ffebcd",blue:"#0000ff",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",cyan:"#00ffff",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgreen:"#006400",darkgrey:"#a9a9a9",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#ff00ff",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",goldenrod:"#daa520",gold:"#ffd700",gray:"#808080",green:"#008000",greenyellow:"#adff2f",grey:"#808080",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavenderblush:"#fff0f5",lavender:"#e6e6fa",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgreen:"#90ee90",lightgrey:"#d3d3d3",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#778899",lightslategrey:"#778899",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#00ff00",limegreen:"#32cd32",linen:"#faf0e6",magenta:"#ff00ff",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370db",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#db7093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",rebeccapurple:"#663399",red:"#ff0000",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#ffffff",whitesmoke:"#f5f5f5",yellow:"#ffff00",yellowgreen:"#9acd32"};function zc(e){let t={r:0,g:0,b:0},i=1,s=null,c=null,g=null,b=!1,r=!1;return typeof e=="string"&&(e=Nc(e)),typeof e=="object"&&(Ve(e.r)&&Ve(e.g)&&Ve(e.b)?(t=Rc(e.r,e.g,e.b),b=!0,r=String(e.r).substr(-1)==="%"?"prgb":"rgb"):Ve(e.h)&&Ve(e.s)&&Ve(e.v)?(s=Qi(e.s),c=Qi(e.v),t=Bc(e.h,s,c),b=!0,r="hsv"):Ve(e.h)&&Ve(e.s)&&Ve(e.l)?(s=Qi(e.s),g=Qi(e.l),t=$c(e.h,s,g),b=!0,r="hsl"):Ve(e.c)&&Ve(e.m)&&Ve(e.y)&&Ve(e.k)&&(t=Mc(e.c,e.m,e.y,e.k),b=!0,r="cmyk"),Object.prototype.hasOwnProperty.call(e,"a")&&(i=e.a)),i=an(i),{ok:b,format:e.format||r,r:Math.min(255,Math.max(t.r,0)),g:Math.min(255,Math.max(t.g,0)),b:Math.min(255,Math.max(t.b,0)),a:i}}const Fc="[-\\+]?\\d+%?",Hc="[-\\+]?\\d*\\.\\d+%?",Lt="(?:"+Hc+")|(?:"+Fc+")",Us="[\\s|\\(]+("+Lt+")[,|\\s]+("+Lt+")[,|\\s]+("+Lt+")\\s*\\)?",es="[\\s|\\(]+("+Lt+")[,|\\s]+("+Lt+")[,|\\s]+("+Lt+")[,|\\s]+("+Lt+")\\s*\\)?",tt={CSS_UNIT:new RegExp(Lt),rgb:new RegExp("rgb"+Us),rgba:new RegExp("rgba"+es),hsl:new RegExp("hsl"+Us),hsla:new RegExp("hsla"+es),hsv:new RegExp("hsv"+Us),hsva:new RegExp("hsva"+es),cmyk:new RegExp("cmyk"+es),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};function Nc(e){if(e=e.trim().toLowerCase(),e.length===0)return!1;let t=!1;if(ir[e])e=ir[e],t=!0;else if(e==="transparent")return{r:0,g:0,b:0,a:0,format:"name"};let i=tt.rgb.exec(e);return i?{r:i[1],g:i[2],b:i[3]}:(i=tt.rgba.exec(e),i?{r:i[1],g:i[2],b:i[3],a:i[4]}:(i=tt.hsl.exec(e),i?{h:i[1],s:i[2],l:i[3]}:(i=tt.hsla.exec(e),i?{h:i[1],s:i[2],l:i[3],a:i[4]}:(i=tt.hsv.exec(e),i?{h:i[1],s:i[2],v:i[3]}:(i=tt.hsva.exec(e),i?{h:i[1],s:i[2],v:i[3],a:i[4]}:(i=tt.cmyk.exec(e),i?{c:i[1],m:i[2],y:i[3],k:i[4]}:(i=tt.hex8.exec(e),i?{r:je(i[1]),g:je(i[2]),b:je(i[3]),a:oo(i[4]),format:t?"name":"hex8"}:(i=tt.hex6.exec(e),i?{r:je(i[1]),g:je(i[2]),b:je(i[3]),format:t?"name":"hex"}:(i=tt.hex4.exec(e),i?{r:je(i[1]+i[1]),g:je(i[2]+i[2]),b:je(i[3]+i[3]),a:oo(i[4]+i[4]),format:t?"name":"hex8"}:(i=tt.hex3.exec(e),i?{r:je(i[1]+i[1]),g:je(i[2]+i[2]),b:je(i[3]+i[3]),format:t?"name":"hex"}:!1))))))))))}function Ve(e){return typeof e=="number"?!Number.isNaN(e):tt.CSS_UNIT.test(e)}class Se{constructor(t="",i={}){var c;if(t instanceof Se)return t;typeof t=="number"&&(t=Pc(t)),this.originalInput=t;const s=zc(t);this.originalInput=t,this.r=s.r,this.g=s.g,this.b=s.b,this.a=s.a,this.roundA=Math.round(100*this.a)/100,this.format=(c=i.format)!=null?c:s.format,this.gradientType=i.gradientType,this.r<1&&(this.r=Math.round(this.r)),this.g<1&&(this.g=Math.round(this.g)),this.b<1&&(this.b=Math.round(this.b)),this.isValid=s.ok}isDark(){return this.getBrightness()<128}isLight(){return!this.isDark()}getBrightness(){const t=this.toRgb();return(t.r*299+t.g*587+t.b*114)/1e3}getLuminance(){const t=this.toRgb();let i,s,c;const g=t.r/255,b=t.g/255,r=t.b/255;return g<=.03928?i=g/12.92:i=Math.pow((g+.055)/1.055,2.4),b<=.03928?s=b/12.92:s=Math.pow((b+.055)/1.055,2.4),r<=.03928?c=r/12.92:c=Math.pow((r+.055)/1.055,2.4),.2126*i+.7152*s+.0722*c}getAlpha(){return this.a}setAlpha(t){return this.a=an(t),this.roundA=Math.round(100*this.a)/100,this}isMonochrome(){const{s:t}=this.toHsl();return t===0}toHsv(){const t=io(this.r,this.g,this.b);return{h:t.h*360,s:t.s,v:t.v,a:this.a}}toHsvString(){const t=io(this.r,this.g,this.b),i=Math.round(t.h*360),s=Math.round(t.s*100),c=Math.round(t.v*100);return this.a===1?`hsv(${i}, ${s}%, ${c}%)`:`hsva(${i}, ${s}%, ${c}%, ${this.roundA})`}toHsl(){const t=to(this.r,this.g,this.b);return{h:t.h*360,s:t.s,l:t.l,a:this.a}}toHslString(){const t=to(this.r,this.g,this.b),i=Math.round(t.h*360),s=Math.round(t.s*100),c=Math.round(t.l*100);return this.a===1?`hsl(${i}, ${s}%, ${c}%)`:`hsla(${i}, ${s}%, ${c}%, ${this.roundA})`}toHex(t=!1){return so(this.r,this.g,this.b,t)}toHexString(t=!1){return"#"+this.toHex(t)}toHex8(t=!1){return Oc(this.r,this.g,this.b,this.a,t)}toHex8String(t=!1){return"#"+this.toHex8(t)}toHexShortString(t=!1){return this.a===1?this.toHexString(t):this.toHex8String(t)}toRgb(){return{r:Math.round(this.r),g:Math.round(this.g),b:Math.round(this.b),a:this.a}}toRgbString(){const t=Math.round(this.r),i=Math.round(this.g),s=Math.round(this.b);return this.a===1?`rgb(${t}, ${i}, ${s})`:`rgba(${t}, ${i}, ${s}, ${this.roundA})`}toPercentageRgb(){const t=i=>`${Math.round(Oe(i,255)*100)}%`;return{r:t(this.r),g:t(this.g),b:t(this.b),a:this.a}}toPercentageRgbString(){const t=i=>Math.round(Oe(i,255)*100);return this.a===1?`rgb(${t(this.r)}%, ${t(this.g)}%, ${t(this.b)}%)`:`rgba(${t(this.r)}%, ${t(this.g)}%, ${t(this.b)}%, ${this.roundA})`}toCmyk(){return{...ro(this.r,this.g,this.b)}}toCmykString(){const{c:t,m:i,y:s,k:c}=ro(this.r,this.g,this.b);return`cmyk(${t}, ${i}, ${s}, ${c})`}toName(){if(this.a===0)return"transparent";if(this.a<1)return!1;const t="#"+so(this.r,this.g,this.b,!1);for(const[i,s]of Object.entries(ir))if(t===s)return i;return!1}toString(t){const i=Boolean(t);t=t!=null?t:this.format;let s=!1;const c=this.a<1&&this.a>=0;return!i&&c&&(t.startsWith("hex")||t==="name")?t==="name"&&this.a===0?this.toName():this.toRgbString():(t==="rgb"&&(s=this.toRgbString()),t==="prgb"&&(s=this.toPercentageRgbString()),(t==="hex"||t==="hex6")&&(s=this.toHexString()),t==="hex3"&&(s=this.toHexString(!0)),t==="hex4"&&(s=this.toHex8String(!0)),t==="hex8"&&(s=this.toHex8String()),t==="name"&&(s=this.toName()),t==="hsl"&&(s=this.toHslString()),t==="hsv"&&(s=this.toHsvString()),t==="cmyk"&&(s=this.toCmykString()),s||this.toHexString())}toNumber(){return(Math.round(this.r)<<16)+(Math.round(this.g)<<8)+Math.round(this.b)}clone(){return new Se(this.toString())}lighten(t=10){const i=this.toHsl();return i.l+=t/100,i.l=Zi(i.l),new Se(i)}brighten(t=10){const i=this.toRgb();return i.r=Math.max(0,Math.min(255,i.r-Math.round(255*-(t/100)))),i.g=Math.max(0,Math.min(255,i.g-Math.round(255*-(t/100)))),i.b=Math.max(0,Math.min(255,i.b-Math.round(255*-(t/100)))),new Se(i)}darken(t=10){const i=this.toHsl();return i.l-=t/100,i.l=Zi(i.l),new Se(i)}tint(t=10){return this.mix("white",t)}shade(t=10){return this.mix("black",t)}desaturate(t=10){const i=this.toHsl();return i.s-=t/100,i.s=Zi(i.s),new Se(i)}saturate(t=10){const i=this.toHsl();return i.s+=t/100,i.s=Zi(i.s),new Se(i)}greyscale(){return this.desaturate(100)}spin(t){const i=this.toHsl(),s=(i.h+t)%360;return i.h=s<0?360+s:s,new Se(i)}mix(t,i=50){const s=this.toRgb(),c=new Se(t).toRgb(),g=i/100,b={r:(c.r-s.r)*g+s.r,g:(c.g-s.g)*g+s.g,b:(c.b-s.b)*g+s.b,a:(c.a-s.a)*g+s.a};return new Se(b)}analogous(t=6,i=30){const s=this.toHsl(),c=360/i,g=[this];for(s.h=(s.h-(c*t>>1)+720)%360;--t;)s.h=(s.h+c)%360,g.push(new Se(s));return g}complement(){const t=this.toHsl();return t.h=(t.h+180)%360,new Se(t)}monochromatic(t=6){const i=this.toHsv(),{h:s}=i,{s:c}=i;let{v:g}=i;const b=[],r=1/t;for(;t--;)b.push(new Se({h:s,s:c,v:g})),g=(g+r)%1;return b}splitcomplement(){const t=this.toHsl(),{h:i}=t;return[this,new Se({h:(i+72)%360,s:t.s,l:t.l}),new Se({h:(i+216)%360,s:t.s,l:t.l})]}onBackground(t){const i=this.toRgb(),s=new Se(t).toRgb(),c=i.a+s.a*(1-i.a);return new Se({r:(i.r*i.a+s.r*s.a*(1-i.a))/c,g:(i.g*i.a+s.g*s.a*(1-i.a))/c,b:(i.b*i.a+s.b*s.a*(1-i.a))/c,a:c})}triad(){return this.polyad(3)}tetrad(){return this.polyad(4)}polyad(t){const i=this.toHsl(),{h:s}=i,c=[this],g=360/t;for(let b=1;b<t;b++)c.push(new Se({h:(s+b*g)%360,s:i.s,l:i.l}));return c}equals(t){const i=new Se(t);return this.format==="cmyk"||i.format==="cmyk"?this.toCmykString()===i.toCmykString():this.toRgbString()===i.toRgbString()}}var no="EyeDropper"in window,le=class extends J{constructor(){super(),this.formControlController=new xt(this),this.isSafeValue=!1,this.localize=new ce(this),this.hasFocus=!1,this.isDraggingGridHandle=!1,this.isEmpty=!1,this.inputValue="",this.hue=0,this.saturation=100,this.brightness=100,this.alpha=100,this.value="",this.defaultValue="",this.label="",this.format="hex",this.inline=!1,this.size="medium",this.noFormatToggle=!1,this.name="",this.disabled=!1,this.hoist=!1,this.opacity=!1,this.uppercase=!1,this.swatches="",this.form="",this.required=!1,this.handleFocusIn=()=>{this.hasFocus=!0,this.emit("sl-focus")},this.handleFocusOut=()=>{this.hasFocus=!1,this.emit("sl-blur")},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.input.updateComplete.then(()=>{this.formControlController.updateValidity()})}handleCopy(){this.input.select(),document.execCommand("copy"),this.previewButton.focus(),this.previewButton.classList.add("color-picker__preview-color--copied"),this.previewButton.addEventListener("animationend",()=>{this.previewButton.classList.remove("color-picker__preview-color--copied")})}handleFormatToggle(){const e=["hex","rgb","hsl","hsv"],t=(e.indexOf(this.format)+1)%e.length;this.format=e[t],this.setColor(this.value),this.emit("sl-change"),this.emit("sl-input")}handleAlphaDrag(e){const t=this.shadowRoot.querySelector(".color-picker__slider.color-picker__alpha"),i=t.querySelector(".color-picker__slider-handle"),{width:s}=t.getBoundingClientRect();let c=this.value,g=this.value;i.focus(),e.preventDefault(),Li(t,{onMove:b=>{this.alpha=Ee(b/s*100,0,100),this.syncValues(),this.value!==g&&(g=this.value,this.emit("sl-input"))},onStop:()=>{this.value!==c&&(c=this.value,this.emit("sl-change"))},initialEvent:e})}handleHueDrag(e){const t=this.shadowRoot.querySelector(".color-picker__slider.color-picker__hue"),i=t.querySelector(".color-picker__slider-handle"),{width:s}=t.getBoundingClientRect();let c=this.value,g=this.value;i.focus(),e.preventDefault(),Li(t,{onMove:b=>{this.hue=Ee(b/s*360,0,360),this.syncValues(),this.value!==g&&(g=this.value,this.emit("sl-input"))},onStop:()=>{this.value!==c&&(c=this.value,this.emit("sl-change"))},initialEvent:e})}handleGridDrag(e){const t=this.shadowRoot.querySelector(".color-picker__grid"),i=t.querySelector(".color-picker__grid-handle"),{width:s,height:c}=t.getBoundingClientRect();let g=this.value,b=this.value;i.focus(),e.preventDefault(),this.isDraggingGridHandle=!0,Li(t,{onMove:(r,o)=>{this.saturation=Ee(r/s*100,0,100),this.brightness=Ee(100-o/c*100,0,100),this.syncValues(),this.value!==b&&(b=this.value,this.emit("sl-input"))},onStop:()=>{this.isDraggingGridHandle=!1,this.value!==g&&(g=this.value,this.emit("sl-change"))},initialEvent:e})}handleAlphaKeyDown(e){const t=e.shiftKey?10:1,i=this.value;e.key==="ArrowLeft"&&(e.preventDefault(),this.alpha=Ee(this.alpha-t,0,100),this.syncValues()),e.key==="ArrowRight"&&(e.preventDefault(),this.alpha=Ee(this.alpha+t,0,100),this.syncValues()),e.key==="Home"&&(e.preventDefault(),this.alpha=0,this.syncValues()),e.key==="End"&&(e.preventDefault(),this.alpha=100,this.syncValues()),this.value!==i&&(this.emit("sl-change"),this.emit("sl-input"))}handleHueKeyDown(e){const t=e.shiftKey?10:1,i=this.value;e.key==="ArrowLeft"&&(e.preventDefault(),this.hue=Ee(this.hue-t,0,360),this.syncValues()),e.key==="ArrowRight"&&(e.preventDefault(),this.hue=Ee(this.hue+t,0,360),this.syncValues()),e.key==="Home"&&(e.preventDefault(),this.hue=0,this.syncValues()),e.key==="End"&&(e.preventDefault(),this.hue=360,this.syncValues()),this.value!==i&&(this.emit("sl-change"),this.emit("sl-input"))}handleGridKeyDown(e){const t=e.shiftKey?10:1,i=this.value;e.key==="ArrowLeft"&&(e.preventDefault(),this.saturation=Ee(this.saturation-t,0,100),this.syncValues()),e.key==="ArrowRight"&&(e.preventDefault(),this.saturation=Ee(this.saturation+t,0,100),this.syncValues()),e.key==="ArrowUp"&&(e.preventDefault(),this.brightness=Ee(this.brightness+t,0,100),this.syncValues()),e.key==="ArrowDown"&&(e.preventDefault(),this.brightness=Ee(this.brightness-t,0,100),this.syncValues()),this.value!==i&&(this.emit("sl-change"),this.emit("sl-input"))}handleInputChange(e){const t=e.target,i=this.value;e.stopPropagation(),this.input.value?(this.setColor(t.value),t.value=this.value):this.value="",this.value!==i&&(this.emit("sl-change"),this.emit("sl-input"))}handleInputInput(e){this.formControlController.updateValidity(),e.stopPropagation()}handleInputKeyDown(e){if(e.key==="Enter"){const t=this.value;this.input.value?(this.setColor(this.input.value),this.input.value=this.value,this.value!==t&&(this.emit("sl-change"),this.emit("sl-input")),setTimeout(()=>this.input.select())):this.hue=0}}handleInputInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleTouchMove(e){e.preventDefault()}parseColor(e){const t=new Se(e);if(!t.isValid)return null;const i=t.toHsl(),s={h:i.h,s:i.s*100,l:i.l*100,a:i.a},c=t.toRgb(),g=t.toHexString(),b=t.toHex8String(),r=t.toHsv(),o={h:r.h,s:r.s*100,v:r.v*100,a:r.a};return{hsl:{h:s.h,s:s.s,l:s.l,string:this.setLetterCase(`hsl(${Math.round(s.h)}, ${Math.round(s.s)}%, ${Math.round(s.l)}%)`)},hsla:{h:s.h,s:s.s,l:s.l,a:s.a,string:this.setLetterCase(`hsla(${Math.round(s.h)}, ${Math.round(s.s)}%, ${Math.round(s.l)}%, ${s.a.toFixed(2).toString()})`)},hsv:{h:o.h,s:o.s,v:o.v,string:this.setLetterCase(`hsv(${Math.round(o.h)}, ${Math.round(o.s)}%, ${Math.round(o.v)}%)`)},hsva:{h:o.h,s:o.s,v:o.v,a:o.a,string:this.setLetterCase(`hsva(${Math.round(o.h)}, ${Math.round(o.s)}%, ${Math.round(o.v)}%, ${o.a.toFixed(2).toString()})`)},rgb:{r:c.r,g:c.g,b:c.b,string:this.setLetterCase(`rgb(${Math.round(c.r)}, ${Math.round(c.g)}, ${Math.round(c.b)})`)},rgba:{r:c.r,g:c.g,b:c.b,a:c.a,string:this.setLetterCase(`rgba(${Math.round(c.r)}, ${Math.round(c.g)}, ${Math.round(c.b)}, ${c.a.toFixed(2).toString()})`)},hex:this.setLetterCase(g),hexa:this.setLetterCase(b)}}setColor(e){const t=this.parseColor(e);return t===null?!1:(this.hue=t.hsva.h,this.saturation=t.hsva.s,this.brightness=t.hsva.v,this.alpha=this.opacity?t.hsva.a*100:100,this.syncValues(),!0)}setLetterCase(e){return typeof e!="string"?"":this.uppercase?e.toUpperCase():e.toLowerCase()}async syncValues(){const e=this.parseColor(`hsva(${this.hue}, ${this.saturation}%, ${this.brightness}%, ${this.alpha/100})`);e!==null&&(this.format==="hsl"?this.inputValue=this.opacity?e.hsla.string:e.hsl.string:this.format==="rgb"?this.inputValue=this.opacity?e.rgba.string:e.rgb.string:this.format==="hsv"?this.inputValue=this.opacity?e.hsva.string:e.hsv.string:this.inputValue=this.opacity?e.hexa:e.hex,this.isSafeValue=!0,this.value=this.inputValue,await this.updateComplete,this.isSafeValue=!1)}handleAfterHide(){this.previewButton.classList.remove("color-picker__preview-color--copied")}handleEyeDropper(){if(!no)return;new EyeDropper().open().then(t=>{const i=this.value;this.setColor(t.sRGBHex),this.value!==i&&(this.emit("sl-change"),this.emit("sl-input"))}).catch(()=>{})}selectSwatch(e){const t=this.value;this.disabled||(this.setColor(e),this.value!==t&&(this.emit("sl-change"),this.emit("sl-input")))}getHexString(e,t,i,s=100){const c=new Se(`hsva(${e}, ${t}%, ${i}%, ${s/100})`);return c.isValid?c.toHex8String():""}stopNestedEventPropagation(e){e.stopImmediatePropagation()}handleFormatChange(){this.syncValues()}handleOpacityChange(){this.alpha=100}handleValueChange(e,t){if(this.isEmpty=!t,t||(this.hue=0,this.saturation=0,this.brightness=100,this.alpha=100),!this.isSafeValue){const i=this.parseColor(t);i!==null?(this.inputValue=this.value,this.hue=i.hsva.h,this.saturation=i.hsva.s,this.brightness=i.hsva.v,this.alpha=i.hsva.a*100,this.syncValues()):this.inputValue=e!=null?e:""}}focus(e){this.inline?this.base.focus(e):this.trigger.focus(e)}blur(){var e;const t=this.inline?this.base:this.trigger;this.hasFocus&&(t.focus({preventScroll:!0}),t.blur()),(e=this.dropdown)!=null&&e.open&&this.dropdown.hide()}getFormattedValue(e="hex"){const t=this.parseColor(`hsva(${this.hue}, ${this.saturation}%, ${this.brightness}%, ${this.alpha/100})`);if(t===null)return"";switch(e){case"hex":return t.hex;case"hexa":return t.hexa;case"rgb":return t.rgb.string;case"rgba":return t.rgba.string;case"hsl":return t.hsl.string;case"hsla":return t.hsla.string;case"hsv":return t.hsv.string;case"hsva":return t.hsva.string;default:return""}}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return!this.inline&&!this.validity.valid?(this.dropdown.show(),this.addEventListener("sl-after-show",()=>this.input.reportValidity(),{once:!0}),this.disabled||this.formControlController.emitInvalidEvent(),!1):this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.saturation,t=100-this.brightness,i=Array.isArray(this.swatches)?this.swatches:this.swatches.split(";").filter(c=>c.trim()!==""),s=V`
      <div
        part="base"
      ...
      >
        ...
        ${i.length>0?V`
              <div part="swatches" class="color-picker__swatches">
                ${i.map(c=>{const g=this.parseColor(c);return g?V`
                    <div
                      part="swatch"
                      ...
                      @keydown=${b=>!this.disabled&&b.key==="Enter"&&this.setColor(g.hexa)}
                    >
                      <div
                        class="color-picker__swatch-color"
                        style=${We({backgroundColor:g.hexa})}
                      ></div>
                    </div>
    ...
    `}};le.styles=[ie,Lc];le.dependencies={"sl-button-group":Xt,"sl-button":fe,"sl-dropdown":Pe,"sl-icon":me,"sl-input":oe,"sl-visually-hidden":mr};_([K('[part~="base"]')],le.prototype,"base",2);_([K('[part~="input"]')],le.prototype,"input",2);_([K(".color-dropdown")],le.prototype,"dropdown",2);_([K('[part~="preview"]')],le.prototype,"previewButton",2);_([K('[part~="trigger"]')],le.prototype,"trigger",2);_([ee()],le.prototype,"hasFocus",2);_([ee()],le.prototype,"isDraggingGridHandle",2);_([ee()],le.prototype,"isEmpty",2);_([ee()],le.prototype,"inputValue",2);_([ee()],le.prototype,"hue",2);_([ee()],le.prototype,"saturation",2);_([ee()],le.prototype,"brightness",2);_([ee()],le.prototype,"alpha",2);_([A()],le.prototype,"value",2);_([si()],le.prototype,"defaultValue",2);_([A()],le.prototype,"label",2);_([A()],le.prototype,"format",2);_([A({type:Boolean,reflect:!0})],le.prototype,"inline",2);_([A({reflect:!0})],le.prototype,"size",2);_([A({attribute:"no-format-toggle",type:Boolean})],le.prototype,"noFormatToggle",2);_([A()],le.prototype,"name",2);_([A({type:Boolean,reflect:!0})],le.prototype,"disabled",2);_([A({type:Boolean})],le.prototype,"hoist",2);_([A({type:Boolean})],le.prototype,"opacity",2);_([A({type:Boolean})],le.prototype,"uppercase",2);_([A()],le.prototype,"swatches",2);_([A({reflect:!0})],le.prototype,"form",2);_([A({type:Boolean,reflect:!0})],le.prototype,"required",2);_([Pi({passive:!1})],le.prototype,"handleTouchMove",1);_([q("format",{waitUntilFirstUpdate:!0})],le.prototype,"handleFormatChange",1);_([q("opacity",{waitUntilFirstUpdate:!0})],le.prototype,"handleOpacityChange",1);_([q("value")],le.prototype,"handleValueChange",1);le.define("sl-color-picker");var Uc=Q`
  :host {
    --border-color: var(--sl-color-neutral-200);
    --border-radius: var(--sl-border-radius-medium);
    --border-width: 1px;
      ...
      <div part="base" class="carousel">
        ...
        ${this.navigation?V`
              <div part="navigation" class="carousel__navigation">
                ...
                <button
                  ...
                  class=${te({"carousel__navigation-button":!0,"carousel__navigation-button--next":!0,"carousel__navigation-button--disabled":!g})}
                  aria-label="${this.localize.term("nextSlide")}"
                  aria-controls="scroll-container"
                  aria-disabled="${g?"false":"true"}"
                  @click=${g?()=>this.next():null}
                >
                  <slot name="next-icon">
        ...
        ${this.pagination?V`
              <div part="pagination" role="tablist" class="carousel__pagination">
                ${jc(qc(i),r=>{const o=r===s;return V`
                    <button
...
`,Ot=class extends J{constructor(){super(...arguments),this.hasSlotController=new Ne(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="sl-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return V`
    ...
    `}};Ot.styles=[ie,Gc];_([K("slot:not([name])")],Ot.prototype,"defaultSlot",2);_([ee()],Ot.prototype,"renderType",2);_([A()],Ot.prototype,"href",2);_([A()],Ot.prototype,"target",2);_([A()],Ot.prototype,"rel",2);_([q("href",{waitUntilFirstUpdate:!0})],Ot.prototype,"hrefChanged",1);Ot.define("sl-breadcrumb-item");Xt.define("sl-button-group");var Yc=Q`
  :host {
    display: inline-block;
...
`,ji=class extends J{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return V`
      <span
        part="base"
    ...
    `}};ji.styles=[ie,Qc];_([A({reflect:!0})],ji.prototype,"variant",2);_([A({type:Boolean,reflect:!0})],ji.prototype,"pill",2);_([A({type:Boolean,reflect:!0})],ji.prototype,"pulse",2);ji.define("sl-badge");var eh=Q`
  :host {
    display: contents;
