var un=Object.defineProperty;var pn=(e,t,i)=>t in e?un(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i;var me=(e,t,i)=>(pn(e,typeof t!="symbol"?t+"":t,i),i);import{e as ts,K as fn,a as gn}from"./monaco-editor.6e4fa376.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))s(h);new MutationObserver(h=>{for(const m of h)if(m.type==="childList")for(const w of m.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&s(w)}).observe(document,{childList:!0,subtree:!0});function i(h){const m={};return h.integrity&&(m.integrity=h.integrity),h.referrerpolicy&&(m.referrerPolicy=h.referrerpolicy),h.crossorigin==="use-credentials"?m.credentials="include":h.crossorigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function s(h){if(h.ep)return;h.ep=!0;const m=i(h);fetch(h.href,m)}})();const Cr=class{constructor(t){me(this,"serialPortManager");me(this,"isTerminalOutput",!1);me(this,"terminalOutputCallback",null);me(this,"leftoverData","");me(this,"replStatus","REPL");this.serialPortManager=t}updateStatus(t){this.replStatus!==t&&(this.replStatus=t,console.log(`Status changed to: ${t}`),document.dispatchEvent(new CustomEvent(Cr.EVENT_STATUS_CHANGED,{detail:{status:t}})))}async startTerminalOutput(t){console.log("startTerminalOutput"),await this.serialPortManager.reopen(),this.serialPortManager.getWritablePort(),this.terminalOutputCallback=t,this.isTerminalOutput=!0,await this.serialPortManager.getReadablePort(),this.processReaderData(!1)}async processReaderData(t){let i=this.leftoverData;this.leftoverData="";const s=1e4;try{for(;;){const{value:h,done:m}=await this.serialPortManager.streamRead();if(m&&console.log("Stream closed",this.isTerminalOutput),m)break;const w=new TextDecoder("utf-8").decode(h);if(i+=w,i.slice(-6).includes(">>>")?(console.log("!REPL prompt detected."),this.updateStatus("REPL")):(console.log("!REPL prompt NOT detected."),this.updateStatus("RUNNING")),this.isTerminalOutput&&this.terminalOutputCallback){const n=w.replace(/[^\x20-\x7E\u3000-\u9FFF\uFF00-\uFFEF\r\n]/g,"");this.terminalOutputCallback(n)}if(!t&&i.length>s&&(i=i.slice(i.length-s),console.error("Result size exceeded maximum limit. Trimming...")),t&&i.includes(t)){const[n,u]=i.split(t);i=n,this.leftoverData=u,console.log("Target string found, processing complete.");break}}}catch(h){console.error("Error processing reader data:",h)}return i}async resetReader(){await this.serialPortManager.resetReader()}async enterRawMode(){this.replStatus!=="REPL"&&console.error("Not in REPL mode. Exiting..."),console.log("Entering RAW mode..."),this.isTerminalOutput=!1,await this.write("")}async exitRawMode(){this.isTerminalOutput=!0,await this.write("")}async executeCommand(t){console.log("executeCommand:",t);try{await this.enterRawMode(),await this.write(t),await this.write("")}catch(i){console.error("Error executing command:",i)}finally{await this.exitRawMode()}}async sendCommand(t){console.log("sendCommand:",t);try{await this.write(t)}catch(i){console.error("Error executing sendCommand:",i)}}async writeFile(t,i){console.log("writeFile:",t);try{await this.enterRawMode(),await this.write(`with open("${t}", "wb") as f:\r`);const s=JSON.stringify(Array.from(i));await this.write(`  f.write(bytes(${s}))\r`),await this.write(""),console.log("Verifying written file...");const h=await this.readFile(t);if(!this.verifyContent(i,h))throw new Error("File verification failed: Written content does not match.");console.log("File verification succeeded.")}catch(s){const h=s;throw console.error("Error writing file:",h.message),new Error(`Failed to write file "${t}": ${h.message}`)}finally{}}verifyContent(t,i){if(t.length!==i.length)return!1;for(let s=0;s<t.length;s++)if(t[s]!==i[s])return!1;return!0}async readFile(t){var s;console.log("readFile:",t);let i=new Uint8Array;try{await this.resetReader(),await this.enterRawMode(),await this.write(`with open("${t}", "rb") as f:\r`),await this.write("  import ubinascii\r"),await this.write("  print(ubinascii.hexlify(f.read()).decode())\r"),await this.write(""),await this.processReaderData(">OK");const h=await this.processReaderData("");this.processReaderData(!1),i=new Uint8Array(((s=h.match(/.{1,2}/g))==null?void 0:s.map(w=>parseInt(w,16)))||[])}catch(h){console.error("Error reading file:",h)}finally{await this.exitRawMode()}return i}async getPyFileList(){console.log("getPyFileList");try{await this.resetReader(),await this.enterRawMode(),await this.write("import os\r"),await this.write("print(os.listdir())\r"),await this.write(""),console.log("Command sent:");const t=await this.processReaderData(">OK");console.log("Skip:",t);const i=await this.processReaderData("");return this.processReaderData(!1),console.log("Received content:",i),await this.exitRawMode(),i.replace(/[\[\]'\s]/g,"").split(",").filter(h=>h.endsWith(".py")||h.endsWith(".txt"))}catch(t){return console.error("Error fetching file list:",t),[]}}async write(t){await this.serialPortManager.picowrite(new TextEncoder().encode(t))}async writeDevice(t){this.write(t)}};let Si=Cr;me(Si,"EVENT_STATUS_CHANGED","repl-status-changed");class mn{constructor(t,i){me(this,"device");me(this,"terminal");me(this,"selectedFile",null);me(this,"fileTreeDisplayed",!1);me(this,"files",[]);this.device=t,this.terminal=i}async initialize(){document.addEventListener(Si.EVENT_STATUS_CHANGED,async t=>{const i=document.getElementById("refreshFileList"),s=document.getElementById("saveFileButton"),h=document.getElementById("newFileButton"),m=document.getElementById("runCodeButton"),w=t,{status:r}=w.detail,n=[i,s,h,m];r==="REPL"?(this.fileTreeDisplayed||await this.fileList(),n.forEach(u=>u.disabled=!1)):n.forEach(u=>u.disabled=!0)}),this.disableAllButtons()}disableAllButtons(){const t=document.getElementById("refreshFileList"),i=document.getElementById("saveFileButton"),s=document.getElementById("newFileButton"),h=document.getElementById("runCodeButton");t.disabled=!0,i.disabled=!0,s.disabled=!0,h.disabled=!0}async fileList(){const t=document.getElementById("file-tree");!t||(this.files=await this.device.getPyFileList(),t.innerHTML="",this.files.forEach(i=>{const s=document.createElement("sl-tree-item");s.textContent=i,s.value=i,t.appendChild(s)}),this.fileTreeDisplayed=!0)}fileExists(t){return this.files.includes(t)}async fileRead(t){try{const i=await this.device.readFile(t);return new TextDecoder("utf-8").decode(i)}catch(i){return console.error(`Error reading file ${t}:`,i),null}}async fileWrite(t,i){const s=new TextEncoder().encode(i);try{await this.device.writeFile(t,s),console.log(`File saved: ${t}`),this.terminal.logToTerminal(`File saved successfully: ${t}`,"info")}catch(h){const m=h;console.error(`Error saving file ${this.selectedFile}:`,m),this.terminal.logToTerminal(`Error saving file "${this.selectedFile}": ${m.message}`,"error")}}}var So={exports:{}};(function(e,t){(function(i,s){e.exports=s()})(self,()=>(()=>{var i={4567:function(w,r,n){var u=this&&this.__decorate||function(c,p,v,x){var E,y=arguments.length,k=y<3?p:x===null?x=Object.getOwnPropertyDescriptor(p,v):x;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")k=Reflect.decorate(c,p,v,x);else for(var T=c.length-1;T>=0;T--)(E=c[T])&&(k=(y<3?E(k):y>3?E(p,v,k):E(p,v))||k);return y>3&&k&&Object.defineProperty(p,v,k),k},g=this&&this.__param||function(c,p){return function(v,x){p(v,x,c)}};Object.defineProperty(r,"__esModule",{value:!0}),r.AccessibilityManager=void 0;const l=n(9042),f=n(6114),b=n(9924),C=n(844),S=n(5596),o=n(4725),d=n(3656);let a=r.AccessibilityManager=class extends C.Disposable{constructor(c,p){super(),this._terminal=c,this._renderService=p,this._liveRegionLineCount=0,this._charsToConsume=[],this._charsToAnnounce="",this._accessibilityContainer=document.createElement("div"),this._accessibilityContainer.classList.add("xterm-accessibility"),this._rowContainer=document.createElement("div"),this._rowContainer.setAttribute("role","list"),this._rowContainer.classList.add("xterm-accessibility-tree"),this._rowElements=[];for(let v=0;v<this._terminal.rows;v++)this._rowElements[v]=this._createAccessibilityTreeNode(),this._rowContainer.appendChild(this._rowElements[v]);if(this._topBoundaryFocusListener=v=>this._handleBoundaryFocus(v,0),this._bottomBoundaryFocusListener=v=>this._handleBoundaryFocus(v,1),this._rowElements[0].addEventListener("focus",this._topBoundaryFocusListener),this._rowElements[this._rowElements.length-1].addEventListener("focus",this._bottomBoundaryFocusListener),this._refreshRowsDimensions(),this._accessibilityContainer.appendChild(this._rowContainer),this._liveRegion=document.createElement("div"),this._liveRegion.classList.add("live-region"),this._liveRegion.setAttribute("aria-live","assertive"),this._accessibilityContainer.appendChild(this._liveRegion),this._liveRegionDebouncer=this.register(new b.TimeBasedDebouncer(this._renderRows.bind(this))),!this._terminal.element)throw new Error("Cannot enable accessibility before Terminal.open");this._terminal.element.insertAdjacentElement("afterbegin",this._accessibilityContainer),this.register(this._terminal.onResize(v=>this._handleResize(v.rows))),this.register(this._terminal.onRender(v=>this._refreshRows(v.start,v.end))),this.register(this._terminal.onScroll(()=>this._refreshRows())),this.register(this._terminal.onA11yChar(v=>this._handleChar(v))),this.register(this._terminal.onLineFeed(()=>this._handleChar(`
...
\f\r]`,_i=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Rr=/-->/g,$r=/>/g,Mt=RegExp(`>|${Rs}(?:([^\\s"'>=/]+)(${Rs}*=${Rs}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Br=/'/g,Or=/"/g,Ro=/^(?:script|style|textarea|title)$/i,Vn=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),V=Vn(1),Ke=Symbol.for("lit-noChange"),ve=Symbol.for("lit-nothing"),Mr=new WeakMap,zt=Nt.createTreeWalker(Nt,129);function $o(e,t){if(!nr(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Tr!==void 0?Tr.createHTML(t):t}const jn=(e,t)=>{const i=e.length-1,s=[];let h,m=t===2?"<svg>":t===3?"<math>":"",w=_i;for(let r=0;r<i;r++){const n=e[r];let u,g,l=-1,f=0;for(;f<n.length&&(w.lastIndex=f,g=w.exec(n),g!==null);)f=w.lastIndex,w===_i?g[1]==="!--"?w=Rr:g[1]!==void 0?w=$r:g[2]!==void 0?(Ro.test(g[2])&&(h=RegExp("</"+g[2],"g")),w=Mt):g[3]!==void 0&&(w=Mt):w===Mt?g[0]===">"?(w=h!=null?h:_i,l=-1):g[1]===void 0?l=-2:(l=w.lastIndex-g[2].length,u=g[1],w=g[3]===void 0?Mt:g[3]==='"'?Or:Br):w===Or||w===Br?w=Mt:w===Rr||w===$r?w=_i:(w=Mt,h=void 0);const b=w===Mt&&e[r+1].startsWith("/>")?" ":"";m+=w===_i?n+Un:l>=0?(s.push(u),n.slice(0,l)+Do+n.slice(l)+Et+b):n+Et+(l===-2?r:b)}return[$o(e,m+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class Oi{constructor({strings:t,_$litType$:i},s){let h;this.parts=[];let m=0,w=0;const r=t.length-1,n=this.parts,[u,g]=jn(t,i);if(this.el=Oi.createElement(u,s),zt.currentNode=this.el.content,i===2||i===3){const l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(h=zt.nextNode())!==null&&n.length<r;){if(h.nodeType===1){if(h.hasAttributes())for(const l of h.getAttributeNames())if(l.endsWith(Do)){const f=g[w++],b=h.getAttribute(l).split(Et),C=/([.?@])?(.*)/.exec(f);n.push({type:1,index:m,name:C[2],strings:b,ctor:C[1]==="."?Kn:C[1]==="?"?Xn:C[1]==="@"?Gn:fs}),h.removeAttribute(l)}else l.startsWith(Et)&&(n.push({type:6,index:m}),h.removeAttribute(l));if(Ro.test(h.tagName)){const l=h.textContent.split(Et),f=l.length-1;if(f>0){h.textContent=ns?ns.emptyScript:"";for(let b=0;b<f;b++)h.append(l[b],$i()),zt.nextNode(),n.push({type:2,index:++m});h.append(l[f],$i())}}}else if(h.nodeType===8)if(h.data===To)n.push({type:2,index:m});else{let l=-1;for(;(l=h.data.indexOf(Et,l+1))!==-1;)n.push({type:7,index:m}),l+=Et.length-1}m++}}static createElement(t,i){const s=Nt.createElement("template");return s.innerHTML=t,s}}function ti(e,t,i=e,s){var w,r,n;if(t===Ke)return t;let h=s!==void 0?(w=i._$Co)==null?void 0:w[s]:i._$Cl;const m=Bi(t)?void 0:t._$litDirective$;return(h==null?void 0:h.constructor)!==m&&((r=h==null?void 0:h._$AO)==null||r.call(h,!1),m===void 0?h=void 0:(h=new m(e),h._$AT(e,i,s)),s!==void 0?((n=i._$Co)!=null?n:i._$Co=[])[s]=h:i._$Cl=h),h!==void 0&&(t=ti(e,h._$AS(e,t.values),h,s)),t}class qn{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var u;const{el:{content:i},parts:s}=this._$AD,h=((u=t==null?void 0:t.creationScope)!=null?u:Nt).importNode(i,!0);zt.currentNode=h;let m=zt.nextNode(),w=0,r=0,n=s[0];for(;n!==void 0;){if(w===n.index){let g;n.type===2?g=new Ii(m,m.nextSibling,this,t):n.type===1?g=new n.ctor(m,n.name,n.strings,this,t):n.type===6&&(g=new Yn(m,this,t)),this._$AV.push(g),n=s[++r]}w!==(n==null?void 0:n.index)&&(m=zt.nextNode(),w++)}return zt.currentNode=Nt,h}p(t){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class Ii{get _$AU(){var t,i;return(i=(t=this._$AM)==null?void 0:t._$AU)!=null?i:this._$Cv}constructor(t,i,s,h){var m;this.type=2,this._$AH=ve,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=h,this._$Cv=(m=h==null?void 0:h.isConnected)!=null?m:!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=ti(this,t,i),Bi(t)?t===ve||t==null||t===""?(this._$AH!==ve&&this._$AR(),this._$AH=ve):t!==this._$AH&&t!==Ke&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Wn(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==ve&&Bi(this._$AH)?this._$AA.nextSibling.data=t:this.T(Nt.createTextNode(t)),this._$AH=t}$(t){var m;const{values:i,_$litType$:s}=t,h=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Oi.createElement($o(s.h,s.h[0]),this.options)),s);if(((m=this._$AH)==null?void 0:m._$AD)===h)this._$AH.p(i);else{const w=new qn(h,this),r=w.u(this.options);w.p(i),this.T(r),this._$AH=w}}_$AC(t){let i=Mr.get(t.strings);return i===void 0&&Mr.set(t.strings,i=new Oi(t)),i}k(t){nr(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,h=0;for(const m of t)h===i.length?i.push(s=new Ii(this.O($i()),this.O($i()),this,this.options)):s=i[h],s._$AI(m),h++;h<i.length&&(this._$AR(s&&s._$AB.nextSibling,h),i.length=h)}_$AR(t=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);t!==this._$AB;){const h=t.nextSibling;t.remove(),t=h}}setConnected(t){var i;this._$AM===void 0&&(this._$Cv=t,(i=this._$AP)==null||i.call(this,t))}}class fs{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,h,m){this.type=1,this._$AH=ve,this._$AN=void 0,this.element=t,this.name=i,this._$AM=h,this.options=m,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ve}_$AI(t,i=this,s,h){const m=this.strings;let w=!1;if(m===void 0)t=ti(this,t,i,0),w=!Bi(t)||t!==this._$AH&&t!==Ke,w&&(this._$AH=t);else{const r=t;let n,u;for(t=m[0],n=0;n<m.length-1;n++)u=ti(this,r[s+n],i,n),u===Ke&&(u=this._$AH[n]),w||(w=!Bi(u)||u!==this._$AH[n]),u===ve?t=ve:t!==ve&&(t+=(u!=null?u:"")+m[n+1]),this._$AH[n]=u}w&&!h&&this.j(t)}j(t){t===ve?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t!=null?t:"")}}class Kn extends fs{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===ve?void 0:t}}class Xn extends fs{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==ve)}}class Gn extends fs{constructor(t,i,s,h,m){super(t,i,s,h,m),this.type=5}_$AI(t,i=this){var w;if((t=(w=ti(this,t,i,0))!=null?w:ve)===Ke)return;const s=this._$AH,h=t===ve&&s!==ve||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,m=t!==ve&&(s===ve||h);h&&this.element.removeEventListener(this.name,this,s),m&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i,s;typeof this._$AH=="function"?this._$AH.call((s=(i=this.options)==null?void 0:i.host)!=null?s:this.element,t):this._$AH.handleEvent(t)}}class Yn{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){ti(this,t)}}const $s=xi.litHtmlPolyfillSupport;var ho;$s==null||$s(Oi,Ii),((ho=xi.litHtmlVersions)!=null?ho:xi.litHtmlVersions=[]).push("3.3.1");const Jn=(e,t,i)=>{var m,w;const s=(m=i==null?void 0:i.renderBefore)!=null?m:t;let h=s._$litPart$;if(h===void 0){const r=(w=i==null?void 0:i.renderBefore)!=null?w:null;s._$litPart$=h=new Ii(t.insertBefore($i(),r),r,void 0,i!=null?i:{})}return h._$AI(e),h};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ri=(e="value")=>(t,i)=>{const s=t.constructor,h=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(m,w,r){var n;const u=s.getPropertyOptions(e),g=typeof u.attribute=="string"?u.attribute:e;if(m===g){const l=u.converter||ei,b=(typeof l=="function"?l:(n=l==null?void 0:l.fromAttribute)!=null?n:ei.fromAttribute)(r,u.type);this[e]!==b&&(this[i]=b)}h.call(this,m,w,r)}},Vt=Q`
...
`,Ne=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=i=>{const s=i.target;(this.slotNames.includes("[default]")&&!s.name||s.name&&this.slotNames.includes(s.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function ea(e){if(!e)return"";const t=e.assignedNodes({flatten:!0});let i="";return[...t].forEach(s=>{s.nodeType===Node.TEXT_NODE&&(i+=s.textContent)}),i}var Us="";function Pr(e){Us=e}function ta(e=""){if(!Us){const t=[...document.getElementsByTagName("script")],i=t.find(s=>s.hasAttribute("data-shoelace"));if(i)Pr(i.getAttribute("data-shoelace"));else{const s=t.find(m=>/shoelace(\.min)?\.js($|\?)/.test(m.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(m.src));let h="";s&&(h=s.getAttribute("src")),Pr(h.split("/").slice(0,-1).join("/"))}}return Us.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var ia={name:"default",resolver:e=>ta(`assets/icons/${e}.svg`)},sa=ia,Ir={caret:`
...
`;function q(e,t){const i=St({waitUntilFirstUpdate:!1},t);return(s,h)=>{const{update:m}=s,w=Array.isArray(e)?e:[e];s.update=function(r){w.forEach(n=>{const u=n;if(r.has(u)){const g=r.get(u),l=this[u];g!==l&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[h](g,l)}}),m.call(this,r)}}}var ie=Q`
  :host {
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ha={attribute:!0,type:String,converter:ei,reflect:!1,hasChanged:or},da=(e=ha,t,i)=>{const{kind:s,metadata:h}=i;let m=globalThis.litPropertyMetadata.get(h);if(m===void 0&&globalThis.litPropertyMetadata.set(h,m=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),m.set(i.name,e),s==="accessor"){const{name:w}=i;return{set(r){const n=t.get.call(this);t.set.call(this,r),this.requestUpdate(w,n,e)},init(r){return r!==void 0&&this.C(w,void 0,e,r),r}}}if(s==="setter"){const{name:w}=i;return function(r){const n=this[w];t.call(this,r),this.requestUpdate(w,n,e)}}throw Error("Unsupported decorator location: "+s)};function A(e){return(t,i)=>typeof i=="object"?da(e,t,i):((s,h,m)=>{const w=h.hasOwnProperty(m);return h.constructor.createProperty(m,s),w?Object.getOwnPropertyDescriptor(h,m):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function K(e,t){return(i,s,h)=>{const m=w=>{var r,n;return(n=(r=w.renderRoot)==null?void 0:r.querySelector(e))!=null?n:null};if(t){const{get:w,set:r}=typeof s=="object"?i:h!=null?h:(()=>{const n=Symbol();return{get(){return this[n]},set(u){this[n]=u}}})();return Vs(i,s,{get(){let n=w.call(this);return n===void 0&&(n=m(this),(n!==null||this.hasUpdated)&&r.call(this,n)),n}})}return Vs(i,s,{get(){return m(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ua(e){return(t,i)=>Vs(t,i,{async get(){var s,h;return await this.updateComplete,(h=(s=this.renderRoot)==null?void 0:s.querySelector(e))!=null?h:null}})}var ss,J=class extends ki{constructor(){super(),An(this,ss,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){const i=new CustomEvent(e,St({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){const s=customElements.get(e);if(!s){try{customElements.define(e,t,i)}catch{customElements.define(e,class extends t{},i)}return}let h=" (unknown version)",m=h;"version"in t&&t.version&&(h=" v"+t.version),"version"in s&&s.version&&(m=" v"+s.version),!(h&&m&&h===m)&&console.warn(`Attempted to register <${e}>${h}, but <${e}>${m} has already been registered.`)}attributeChangedCallback(e,t,i){En(this,ss)||(this.constructor.elementProperties.forEach((s,h)=>{s.reflect&&this[h]!=null&&this.initialReflectedProperties.set(h,this[h])}),Ln(this,ss,!0)),super.attributeChangedCallback(e,t,i)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,i)=>{e.has(i)&&this[i]==null&&(this[i]=t)})}};ss=new WeakMap;J.version="2.20.1";J.dependencies={};_([A()],J.prototype,"dir",2);_([A()],J.prototype,"lang",2);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pa=(e,t)=>t===void 0?(e==null?void 0:e._$litType$)!==void 0:(e==null?void 0:e._$litType$)===t,Bo=e=>e.strings===void 0,fa={},ga=(e,t=fa)=>e._$AH=t;var bi=Symbol(),Gi=Symbol(),Os,Ms=new Map,ge=class extends J{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var i;let s;if(t!=null&&t.spriteSheet)return this.svg=V`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(s=await fetch(e,{mode:"cors"}),!s.ok)return s.status===410?bi:Gi}catch{return Gi}try{const h=document.createElement("div");h.innerHTML=await s.text();const m=h.firstElementChild;if(((i=m==null?void 0:m.tagName)==null?void 0:i.toLowerCase())!=="svg")return bi;Os||(Os=new DOMParser);const r=Os.parseFromString(m.outerHTML,"text/html").body.querySelector("svg");return r?(r.part.add("svg"),document.adoptNode(r)):bi}catch{return bi}}connectedCallback(){super.connectedCallback(),aa(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),la(this)}getIconSource(){const e=zr(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:i}=this.getIconSource(),s=i?zr(this.library):void 0;if(!t){this.svg=null;return}let h=Ms.get(t);if(h||(h=this.resolveIcon(t,s),Ms.set(t,h)),!this.initialRender)return;const m=await h;if(m===Gi&&Ms.delete(t),t===this.getIconSource().url){if(pa(m)){if(this.svg=m,s){await this.updateComplete;const w=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&w&&s.mutator(w)}return}switch(m){case Gi:case bi:this.svg=null,this.emit("sl-error");break;default:this.svg=m.cloneNode(!0),(e=s==null?void 0:s.mutator)==null||e.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};ge.styles=[ie,ca];_([ee()],ge.prototype,"svg",2);_([A({reflect:!0})],ge.prototype,"name",2);_([A()],ge.prototype,"src",2);_([A()],ge.prototype,"label",2);_([A({reflect:!0})],ge.prototype,"library",2);_([q("label")],ge.prototype,"handleLabelChange",1);_([q(["name","src","library"])],ge.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const te=Fi(class extends Hi{constructor(e){var t;if(super(e),e.type!==pt.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var s,h;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(m=>m!=="")));for(const m in t)t[m]&&!((s=this.nt)!=null&&s.has(m))&&this.st.add(m);return this.render(t)}const i=e.element.classList;for(const m of this.st)m in t||(i.remove(m),this.st.delete(m));for(const m in t){const w=!!t[m];w===this.st.has(m)||((h=this.nt)==null?void 0:h.has(m))||(w?(i.add(m),this.st.add(m)):(i.remove(m),this.st.delete(m)))}return Ke}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;const js=new Set,Jt=new Map;let It,ar="ltr",lr="en";const Oo=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(Oo){const e=new MutationObserver(Po);ar=document.documentElement.dir||"ltr",lr=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Mo(...e){e.map(t=>{const i=t.$code.toLowerCase();Jt.has(i)?Jt.set(i,Object.assign(Object.assign({},Jt.get(i)),t)):Jt.set(i,t),It||(It=t)}),Po()}function Po(){Oo&&(ar=document.documentElement.dir||"ltr",lr=document.documentElement.lang||navigator.language),[...js.keys()].map(e=>{typeof e.requestUpdate=="function"&&e.requestUpdate()})}class va{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){js.add(this.host)}hostDisconnected(){js.delete(this.host)}dir(){return`${this.host.dir||ar}`.toLowerCase()}lang(){return`${this.host.lang||lr}`.toLowerCase()}getTranslationData(t){var i,s;const h=new Intl.Locale(t.replace(/_/g,"-")),m=h==null?void 0:h.language.toLowerCase(),w=(s=(i=h==null?void 0:h.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&s!==void 0?s:"",r=Jt.get(`${m}-${w}`),n=Jt.get(m);return{locale:h,language:m,region:w,primary:r,secondary:n}}exists(t,i){var s;const{primary:h,secondary:m}=this.getTranslationData((s=i.lang)!==null&&s!==void 0?s:this.lang());return i=Object.assign({includeFallback:!1},i),!!(h&&h[t]||m&&m[t]||i.includeFallback&&It&&It[t])}term(t,...i){const{primary:s,secondary:h}=this.getTranslationData(this.lang());let m;if(s&&s[t])m=s[t];else if(h&&h[t])m=h[t];else if(It&&It[t])m=It[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof m=="function"?m(...i):m}date(t,i){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),i).format(t)}number(t,i){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),i).format(t)}relativeTime(t,i,s){return new Intl.RelativeTimeFormat(this.lang(),s).format(t,i)}}var Io={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>e===0?"No options selected":e===1?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};Mo(Io);var _a=Io,ce=class extends va{};Mo(_a);var Ni=class extends J{constructor(){super(...arguments),this.localize=new ce(this)}render(){return V`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};Ni.styles=[ie,ma];var zo=new Map,ba=new WeakMap;function ya(e){return e!=null?e:{keyframes:[],options:{duration:0}}}function Fr(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function de(e,t){zo.set(e,ya(t))}function _e(e,t,i){const s=ba.get(e);if(s!=null&&s[t])return Fr(s[t],i.dir);const h=zo.get(t);return h?Fr(h,i.dir):{keyframes:[],options:{duration:0}}}function Ce(e,t,i){return new Promise(s=>{if((i==null?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const h=e.animate(t,Pi(St({},i),{duration:qs()?0:i.duration}));h.addEventListener("cancel",s,{once:!0}),h.addEventListener("finish",s,{once:!0})})}function Hr(e){return e=e.toString().toLowerCase(),e.indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?parseFloat(e)*1e3:parseFloat(e)}function qs(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Ae(e){return Promise.all(e.getAnimations().map(t=>new Promise(i=>{t.cancel(),requestAnimationFrame(i)})))}function as(e,t){return e.map(i=>Pi(St({},i),{height:i.height==="auto"?`${t}px`:i.height}))}/**
 * @license
...
`;const Tt=Math.min,qe=Math.max,ls=Math.round,Yi=Math.floor,ft=e=>({x:e,y:e}),Ca={left:"right",right:"left",bottom:"top",top:"bottom"},xa={start:"end",end:"start"};function Xs(e,t,i){return qe(e,Tt(t,i))}function oi(e,t){return typeof e=="function"?e(t):e}function Rt(e){return e.split("-")[0]}function ni(e){return e.split("-")[1]}function Fo(e){return e==="x"?"y":"x"}function cr(e){return e==="y"?"height":"width"}const ka=new Set(["top","bottom"]);function wt(e){return ka.has(Rt(e))?"y":"x"}function hr(e){return Fo(wt(e))}function Ea(e,t,i){i===void 0&&(i=!1);const s=ni(e),h=hr(e),m=cr(h);let w=h==="x"?s===(i?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[m]>t.floating[m]&&(w=cs(w)),[w,cs(w)]}function Aa(e){const t=cs(e);return[Gs(e),t,Gs(t)]}function Gs(e){return e.replace(/start|end/g,t=>xa[t])}const Ur=["left","right"],Wr=["right","left"],La=["top","bottom"],Da=["bottom","top"];function Ta(e,t,i){switch(e){case"top":case"bottom":return i?t?Wr:Ur:t?Ur:Wr;case"left":case"right":return t?La:Da;default:return[]}}function Ra(e,t,i,s){const h=ni(e);let m=Ta(Rt(e),i==="start",s);return h&&(m=m.map(w=>w+"-"+h),t&&(m=m.concat(m.map(Gs)))),m}function cs(e){return e.replace(/left|right|bottom|top/g,t=>Ca[t])}function $a(e){return{top:0,right:0,bottom:0,left:0,...e}}function Ho(e){return typeof e!="number"?$a(e):{top:e,right:e,bottom:e,left:e}}function hs(e){const{x:t,y:i,width:s,height:h}=e;return{width:s,height:h,top:i,left:t,right:t+s,bottom:i+h,x:t,y:i}}function Vr(e,t,i){let{reference:s,floating:h}=e;const m=wt(t),w=hr(t),r=cr(w),n=Rt(t),u=m==="y",g=s.x+s.width/2-h.width/2,l=s.y+s.height/2-h.height/2,f=s[r]/2-h[r]/2;let b;switch(n){case"top":b={x:g,y:s.y-h.height};break;case"bottom":b={x:g,y:s.y+s.height};break;case"right":b={x:s.x+s.width,y:l};break;case"left":b={x:s.x-h.width,y:l};break;default:b={x:s.x,y:s.y}}switch(ni(t)){case"start":b[w]-=f*(i&&u?-1:1);break;case"end":b[w]+=f*(i&&u?-1:1);break}return b}const Ba=async(e,t,i)=>{const{placement:s="bottom",strategy:h="absolute",middleware:m=[],platform:w}=i,r=m.filter(Boolean),n=await(w.isRTL==null?void 0:w.isRTL(t));let u=await w.getElementRects({reference:e,floating:t,strategy:h}),{x:g,y:l}=Vr(u,s,n),f=s,b={},C=0;for(let S=0;S<r.length;S++){const{name:o,fn:d}=r[S],{x:a,y:c,data:p,reset:v}=await d({x:g,y:l,initialPlacement:s,placement:f,strategy:h,middlewareData:b,rects:u,platform:w,elements:{reference:e,floating:t}});g=a!=null?a:g,l=c!=null?c:l,b={...b,[o]:{...b[o],...p}},v&&C<=50&&(C++,typeof v=="object"&&(v.placement&&(f=v.placement),v.rects&&(u=v.rects===!0?await w.getElementRects({reference:e,floating:t,strategy:h}):v.rects),{x:g,y:l}=Vr(u,f,n)),S=-1)}return{x:g,y:l,placement:f,strategy:h,middlewareData:b}};async function dr(e,t){var i;t===void 0&&(t={});const{x:s,y:h,platform:m,rects:w,elements:r,strategy:n}=e,{boundary:u="clippingAncestors",rootBoundary:g="viewport",elementContext:l="floating",altBoundary:f=!1,padding:b=0}=oi(t,e),C=Ho(b),o=r[f?l==="floating"?"reference":"floating":l],d=hs(await m.getClippingRect({element:(i=await(m.isElement==null?void 0:m.isElement(o)))==null||i?o:o.contextElement||await(m.getDocumentElement==null?void 0:m.getDocumentElement(r.floating)),boundary:u,rootBoundary:g,strategy:n})),a=l==="floating"?{x:s,y:h,width:w.floating.width,height:w.floating.height}:w.reference,c=await(m.getOffsetParent==null?void 0:m.getOffsetParent(r.floating)),p=await(m.isElement==null?void 0:m.isElement(c))?await(m.getScale==null?void 0:m.getScale(c))||{x:1,y:1}:{x:1,y:1},v=hs(m.convertOffsetParentRelativeRectToViewportRelativeRect?await m.convertOffsetParentRelativeRectToViewportRelativeRect({elements:r,rect:a,offsetParent:c,strategy:n}):a);return{top:(d.top-v.top+C.top)/p.y,bottom:(v.bottom-d.bottom+C.bottom)/p.y,left:(d.left-v.left+C.left)/p.x,right:(v.right-d.right+C.right)/p.x}}const Oa=e=>({name:"arrow",options:e,async fn(t){const{x:i,y:s,placement:h,rects:m,platform:w,elements:r,middlewareData:n}=t,{element:u,padding:g=0}=oi(e,t)||{};if(u==null)return{};const l=Ho(g),f={x:i,y:s},b=hr(h),C=cr(b),S=await w.getDimensions(u),o=b==="y",d=o?"top":"left",a=o?"bottom":"right",c=o?"clientHeight":"clientWidth",p=m.reference[C]+m.reference[b]-f[b]-m.floating[C],v=f[b]-m.reference[b],x=await(w.getOffsetParent==null?void 0:w.getOffsetParent(u));let E=x?x[c]:0;(!E||!await(w.isElement==null?void 0:w.isElement(x)))&&(E=r.floating[c]||m.floating[C]);const y=p/2-v/2,k=E/2-S[C]/2-1,T=Tt(l[d],k),B=Tt(l[a],k),R=T,O=E-S[C]-B,z=E/2-S[C]/2+y,F=Xs(R,z,O),W=!n.arrow&&ni(h)!=null&&z!==F&&m.reference[C]/2-(z<R?T:B)-S[C]/2<0,N=W?z<R?z-R:z-O:0;return{[b]:f[b]+N,data:{[b]:F,centerOffset:z-F-N,...W&&{alignmentOffset:N}},reset:W}}});const Ma=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,s;const{placement:h,middlewareData:m,rects:w,initialPlacement:r,platform:n,elements:u}=t,{mainAxis:g=!0,crossAxis:l=!0,fallbackPlacements:f,fallbackStrategy:b="bestFit",fallbackAxisSideDirection:C="none",flipAlignment:S=!0,...o}=oi(e,t);if((i=m.arrow)!=null&&i.alignmentOffset)return{};const d=Rt(h),a=wt(r),c=Rt(r)===r,p=await(n.isRTL==null?void 0:n.isRTL(u.floating)),v=f||(c||!S?[cs(r)]:Aa(r)),x=C!=="none";!f&&x&&v.push(...Ra(r,S,C,p));const E=[r,...v],y=await dr(t,o),k=[];let T=((s=m.flip)==null?void 0:s.overflows)||[];if(g&&k.push(y[d]),l){const z=Ea(h,w,p);k.push(y[z[0]],y[z[1]])}if(T=[...T,{placement:h,overflows:k}],!k.every(z=>z<=0)){var B,R;const z=(((B=m.flip)==null?void 0:B.index)||0)+1,F=E[z];if(F&&(!(l==="alignment"?a!==wt(F):!1)||T.every(L=>wt(L.placement)===a?L.overflows[0]>0:!0)))return{data:{index:z,overflows:T},reset:{placement:F}};let W=(R=T.filter(N=>N.overflows[0]<=0).sort((N,L)=>N.overflows[1]-L.overflows[1])[0])==null?void 0:R.placement;if(!W)switch(b){case"bestFit":{var O;const N=(O=T.filter(L=>{if(x){const $=wt(L.placement);return $===a||$==="y"}return!0}).map(L=>[L.placement,L.overflows.filter($=>$>0).reduce(($,M)=>$+M,0)]).sort((L,$)=>L[1]-$[1])[0])==null?void 0:O[0];N&&(W=N);break}case"initialPlacement":W=r;break}if(h!==W)return{reset:{placement:W}}}return{}}}};const Pa=new Set(["left","top"]);async function Ia(e,t){const{placement:i,platform:s,elements:h}=e,m=await(s.isRTL==null?void 0:s.isRTL(h.floating)),w=Rt(i),r=ni(i),n=wt(i)==="y",u=Pa.has(w)?-1:1,g=m&&n?-1:1,l=oi(t,e);let{mainAxis:f,crossAxis:b,alignmentAxis:C}=typeof l=="number"?{mainAxis:l,crossAxis:0,alignmentAxis:null}:{mainAxis:l.mainAxis||0,crossAxis:l.crossAxis||0,alignmentAxis:l.alignmentAxis};return r&&typeof C=="number"&&(b=r==="end"?C*-1:C),n?{x:b*g,y:f*u}:{x:f*u,y:b*g}}const za=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var i,s;const{x:h,y:m,placement:w,middlewareData:r}=t,n=await Ia(t,e);return w===((i=r.offset)==null?void 0:i.placement)&&(s=r.arrow)!=null&&s.alignmentOffset?{}:{x:h+n.x,y:m+n.y,data:{...n,placement:w}}}}},Fa=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:s,placement:h}=t,{mainAxis:m=!0,crossAxis:w=!1,limiter:r={fn:o=>{let{x:d,y:a}=o;return{x:d,y:a}}},...n}=oi(e,t),u={x:i,y:s},g=await dr(t,n),l=wt(Rt(h)),f=Fo(l);let b=u[f],C=u[l];if(m){const o=f==="y"?"top":"left",d=f==="y"?"bottom":"right",a=b+g[o],c=b-g[d];b=Xs(a,b,c)}if(w){const o=l==="y"?"top":"left",d=l==="y"?"bottom":"right",a=C+g[o],c=C-g[d];C=Xs(a,C,c)}const S=r.fn({...t,[f]:b,[l]:C});return{...S,data:{x:S.x-i,y:S.y-s,enabled:{[f]:m,[l]:w}}}}}};const Ha=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var i,s;const{placement:h,rects:m,platform:w,elements:r}=t,{apply:n=()=>{},...u}=oi(e,t),g=await dr(t,u),l=Rt(h),f=ni(h),b=wt(h)==="y",{width:C,height:S}=m.floating;let o,d;l==="top"||l==="bottom"?(o=l,d=f===(await(w.isRTL==null?void 0:w.isRTL(r.floating))?"start":"end")?"left":"right"):(d=l,o=f==="end"?"top":"bottom");const a=S-g.top-g.bottom,c=C-g.left-g.right,p=Tt(S-g[o],a),v=Tt(C-g[d],c),x=!t.middlewareData.shift;let E=p,y=v;if((i=t.middlewareData.shift)!=null&&i.enabled.x&&(y=c),(s=t.middlewareData.shift)!=null&&s.enabled.y&&(E=a),x&&!f){const T=qe(g.left,0),B=qe(g.right,0),R=qe(g.top,0),O=qe(g.bottom,0);b?y=C-2*(T!==0||B!==0?T+B:qe(g.left,g.right)):E=S-2*(R!==0||O!==0?R+O:qe(g.top,g.bottom))}await n({...t,availableWidth:y,availableHeight:E});const k=await w.getDimensions(r.floating);return C!==k.width||S!==k.height?{reset:{rects:!0}}:{}}}};function gs(){return typeof window<"u"}function ai(e){return No(e)?(e.nodeName||"").toLowerCase():"#document"}function Xe(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function mt(e){var t;return(t=(No(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function No(e){return gs()?e instanceof Node||e instanceof Xe(e).Node:!1}function rt(e){return gs()?e instanceof Element||e instanceof Xe(e).Element:!1}function gt(e){return gs()?e instanceof HTMLElement||e instanceof Xe(e).HTMLElement:!1}function jr(e){return!gs()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof Xe(e).ShadowRoot}const Na=new Set(["inline","contents"]);function Ui(e){const{overflow:t,overflowX:i,overflowY:s,display:h}=ot(e);return/auto|scroll|overlay|hidden|clip/.test(t+s+i)&&!Na.has(h)}const Ua=new Set(["table","td","th"]);function Wa(e){return Ua.has(ai(e))}const Va=[":popover-open",":modal"];function ms(e){return Va.some(t=>{try{return e.matches(t)}catch{return!1}})}const ja=["transform","translate","scale","rotate","perspective"],qa=["transform","translate","scale","rotate","perspective","filter"],Ka=["paint","layout","strict","content"];function vs(e){const t=ur(),i=rt(e)?ot(e):e;return ja.some(s=>i[s]?i[s]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||qa.some(s=>(i.willChange||"").includes(s))||Ka.some(s=>(i.contain||"").includes(s))}function Xa(e){let t=$t(e);for(;gt(t)&&!ii(t);){if(vs(t))return t;if(ms(t))return null;t=$t(t)}return null}function ur(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const Ga=new Set(["html","body","#document"]);function ii(e){return Ga.has(ai(e))}function ot(e){return Xe(e).getComputedStyle(e)}function _s(e){return rt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function $t(e){if(ai(e)==="html")return e;const t=e.assignedSlot||e.parentNode||jr(e)&&e.host||mt(e);return jr(t)?t.host:t}function Uo(e){const t=$t(e);return ii(t)?e.ownerDocument?e.ownerDocument.body:e.body:gt(t)&&Ui(t)?t:Uo(t)}function Mi(e,t,i){var s;t===void 0&&(t=[]),i===void 0&&(i=!0);const h=Uo(e),m=h===((s=e.ownerDocument)==null?void 0:s.body),w=Xe(h);if(m){const r=Ys(w);return t.concat(w,w.visualViewport||[],Ui(h)?h:[],r&&i?Mi(r):[])}return t.concat(h,Mi(h,[],i))}function Ys(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Wo(e){const t=ot(e);let i=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const h=gt(e),m=h?e.offsetWidth:i,w=h?e.offsetHeight:s,r=ls(i)!==m||ls(s)!==w;return r&&(i=m,s=w),{width:i,height:s,$:r}}function pr(e){return rt(e)?e:e.contextElement}function Qt(e){const t=pr(e);if(!gt(t))return ft(1);const i=t.getBoundingClientRect(),{width:s,height:h,$:m}=Wo(t);let w=(m?ls(i.width):i.width)/s,r=(m?ls(i.height):i.height)/h;return(!w||!Number.isFinite(w))&&(w=1),(!r||!Number.isFinite(r))&&(r=1),{x:w,y:r}}const Ya=ft(0);function Vo(e){const t=Xe(e);return!ur()||!t.visualViewport?Ya:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Ja(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==Xe(e)?!1:t}function Wt(e,t,i,s){t===void 0&&(t=!1),i===void 0&&(i=!1);const h=e.getBoundingClientRect(),m=pr(e);let w=ft(1);t&&(s?rt(s)&&(w=Qt(s)):w=Qt(e));const r=Ja(m,i,s)?Vo(m):ft(0);let n=(h.left+r.x)/w.x,u=(h.top+r.y)/w.y,g=h.width/w.x,l=h.height/w.y;if(m){const f=Xe(m),b=s&&rt(s)?Xe(s):s;let C=f,S=Ys(C);for(;S&&s&&b!==C;){const o=Qt(S),d=S.getBoundingClientRect(),a=ot(S),c=d.left+(S.clientLeft+parseFloat(a.paddingLeft))*o.x,p=d.top+(S.clientTop+parseFloat(a.paddingTop))*o.y;n*=o.x,u*=o.y,g*=o.x,l*=o.y,n+=c,u+=p,C=Xe(S),S=Ys(C)}}return hs({width:g,height:l,x:n,y:u})}function fr(e,t){const i=_s(e).scrollLeft;return t?t.left+i:Wt(mt(e)).left+i}function jo(e,t,i){i===void 0&&(i=!1);const s=e.getBoundingClientRect(),h=s.left+t.scrollLeft-(i?0:fr(e,s)),m=s.top+t.scrollTop;return{x:h,y:m}}function Za(e){let{elements:t,rect:i,offsetParent:s,strategy:h}=e;const m=h==="fixed",w=mt(s),r=t?ms(t.floating):!1;if(s===w||r&&m)return i;let n={scrollLeft:0,scrollTop:0},u=ft(1);const g=ft(0),l=gt(s);if((l||!l&&!m)&&((ai(s)!=="body"||Ui(w))&&(n=_s(s)),gt(s))){const b=Wt(s);u=Qt(s),g.x=b.x+s.clientLeft,g.y=b.y+s.clientTop}const f=w&&!l&&!m?jo(w,n,!0):ft(0);return{width:i.width*u.x,height:i.height*u.y,x:i.x*u.x-n.scrollLeft*u.x+g.x+f.x,y:i.y*u.y-n.scrollTop*u.y+g.y+f.y}}function Qa(e){return Array.from(e.getClientRects())}function el(e){const t=mt(e),i=_s(e),s=e.ownerDocument.body,h=qe(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),m=qe(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let w=-i.scrollLeft+fr(e);const r=-i.scrollTop;return ot(s).direction==="rtl"&&(w+=qe(t.clientWidth,s.clientWidth)-h),{width:h,height:m,x:w,y:r}}function tl(e,t){const i=Xe(e),s=mt(e),h=i.visualViewport;let m=s.clientWidth,w=s.clientHeight,r=0,n=0;if(h){m=h.width,w=h.height;const u=ur();(!u||u&&t==="fixed")&&(r=h.offsetLeft,n=h.offsetTop)}return{width:m,height:w,x:r,y:n}}const il=new Set(["absolute","fixed"]);function sl(e,t){const i=Wt(e,!0,t==="fixed"),s=i.top+e.clientTop,h=i.left+e.clientLeft,m=gt(e)?Qt(e):ft(1),w=e.clientWidth*m.x,r=e.clientHeight*m.y,n=h*m.x,u=s*m.y;return{width:w,height:r,x:n,y:u}}function qr(e,t,i){let s;if(t==="viewport")s=tl(e,i);else if(t==="document")s=el(mt(e));else if(rt(t))s=sl(t,i);else{const h=Vo(e);s={x:t.x-h.x,y:t.y-h.y,width:t.width,height:t.height}}return hs(s)}function qo(e,t){const i=$t(e);return i===t||!rt(i)||ii(i)?!1:ot(i).position==="fixed"||qo(i,t)}function rl(e,t){const i=t.get(e);if(i)return i;let s=Mi(e,[],!1).filter(r=>rt(r)&&ai(r)!=="body"),h=null;const m=ot(e).position==="fixed";let w=m?$t(e):e;for(;rt(w)&&!ii(w);){const r=ot(w),n=vs(w);!n&&r.position==="fixed"&&(h=null),(m?!n&&!h:!n&&r.position==="static"&&!!h&&il.has(h.position)||Ui(w)&&!n&&qo(e,w))?s=s.filter(g=>g!==w):h=r,w=$t(w)}return t.set(e,s),s}function ol(e){let{element:t,boundary:i,rootBoundary:s,strategy:h}=e;const w=[...i==="clippingAncestors"?ms(t)?[]:rl(t,this._c):[].concat(i),s],r=w[0],n=w.reduce((u,g)=>{const l=qr(t,g,h);return u.top=qe(l.top,u.top),u.right=Tt(l.right,u.right),u.bottom=Tt(l.bottom,u.bottom),u.left=qe(l.left,u.left),u},qr(t,r,h));return{width:n.right-n.left,height:n.bottom-n.top,x:n.left,y:n.top}}function nl(e){const{width:t,height:i}=Wo(e);return{width:t,height:i}}function al(e,t,i){const s=gt(t),h=mt(t),m=i==="fixed",w=Wt(e,!0,m,t);let r={scrollLeft:0,scrollTop:0};const n=ft(0);function u(){n.x=fr(h)}if(s||!s&&!m)if((ai(t)!=="body"||Ui(h))&&(r=_s(t)),s){const b=Wt(t,!0,m,t);n.x=b.x+t.clientLeft,n.y=b.y+t.clientTop}else h&&u();m&&!s&&h&&u();const g=h&&!s&&!m?jo(h,r):ft(0),l=w.left+r.scrollLeft-n.x-g.x,f=w.top+r.scrollTop-n.y-g.y;return{x:l,y:f,width:w.width,height:w.height}}function Ps(e){return ot(e).position==="static"}function Kr(e,t){if(!gt(e)||ot(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return mt(e)===i&&(i=i.ownerDocument.body),i}function Ko(e,t){const i=Xe(e);if(ms(e))return i;if(!gt(e)){let h=$t(e);for(;h&&!ii(h);){if(rt(h)&&!Ps(h))return h;h=$t(h)}return i}let s=Kr(e,t);for(;s&&Wa(s)&&Ps(s);)s=Kr(s,t);return s&&ii(s)&&Ps(s)&&!vs(s)?i:s||Xa(e)||i}const ll=async function(e){const t=this.getOffsetParent||Ko,i=this.getDimensions,s=await i(e.floating);return{reference:al(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:s.width,height:s.height}}};function cl(e){return ot(e).direction==="rtl"}const rs={convertOffsetParentRelativeRectToViewportRelativeRect:Za,getDocumentElement:mt,getClippingRect:ol,getOffsetParent:Ko,getElementRects:ll,getClientRects:Qa,getDimensions:nl,getScale:Qt,isElement:rt,isRTL:cl};function Xo(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function hl(e,t){let i=null,s;const h=mt(e);function m(){var r;clearTimeout(s),(r=i)==null||r.disconnect(),i=null}function w(r,n){r===void 0&&(r=!1),n===void 0&&(n=1),m();const u=e.getBoundingClientRect(),{left:g,top:l,width:f,height:b}=u;if(r||t(),!f||!b)return;const C=Yi(l),S=Yi(h.clientWidth-(g+f)),o=Yi(h.clientHeight-(l+b)),d=Yi(g),c={rootMargin:-C+"px "+-S+"px "+-o+"px "+-d+"px",threshold:qe(0,Tt(1,n))||1};let p=!0;function v(x){const E=x[0].intersectionRatio;if(E!==n){if(!p)return w();E?w(!1,E):s=setTimeout(()=>{w(!1,1e-7)},1e3)}E===1&&!Xo(u,e.getBoundingClientRect())&&w(),p=!1}try{i=new IntersectionObserver(v,{...c,root:h.ownerDocument})}catch{i=new IntersectionObserver(v,c)}i.observe(e)}return w(!0),m}function dl(e,t,i,s){s===void 0&&(s={});const{ancestorScroll:h=!0,ancestorResize:m=!0,elementResize:w=typeof ResizeObserver=="function",layoutShift:r=typeof IntersectionObserver=="function",animationFrame:n=!1}=s,u=pr(e),g=h||m?[...u?Mi(u):[],...Mi(t)]:[];g.forEach(d=>{h&&d.addEventListener("scroll",i,{passive:!0}),m&&d.addEventListener("resize",i)});const l=u&&r?hl(u,i):null;let f=-1,b=null;w&&(b=new ResizeObserver(d=>{let[a]=d;a&&a.target===u&&b&&(b.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var c;(c=b)==null||c.observe(t)})),i()}),u&&!n&&b.observe(u),b.observe(t));let C,S=n?Wt(e):null;n&&o();function o(){const d=Wt(e);S&&!Xo(S,d)&&i(),S=d,C=requestAnimationFrame(o)}return i(),()=>{var d;g.forEach(a=>{h&&a.removeEventListener("scroll",i),m&&a.removeEventListener("resize",i)}),l==null||l(),(d=b)==null||d.disconnect(),b=null,n&&cancelAnimationFrame(C)}}const ul=za,pl=Fa,fl=Ma,Xr=Ha,gl=Oa,ml=(e,t,i)=>{const s=new Map,h={platform:rs,...i},m={...h.platform,_c:s};return Ba(e,t,{...h,platform:m})};function vl(e){return _l(e)}function Is(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function _l(e){for(let t=e;t;t=Is(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=Is(e);t;t=Is(t)){if(!(t instanceof Element))continue;const i=getComputedStyle(t);if(i.display!=="contents"&&(i.position!=="static"||vs(i)||t.tagName==="BODY"))return t}return null}function bl(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e.contextElement instanceof Element:!0)}var ue=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let s=0,h=0,m=0,w=0,r=0,n=0,u=0,g=0;i?e.top<t.top?(s=e.left,h=e.bottom,m=e.right,w=e.bottom,r=t.left,n=t.top,u=t.right,g=t.top):(s=t.left,h=t.bottom,m=t.right,w=t.bottom,r=e.left,n=e.top,u=e.right,g=e.top):e.left<t.left?(s=e.right,h=e.top,m=t.left,w=t.top,r=e.right,n=e.bottom,u=t.left,g=t.bottom):(s=t.right,h=t.top,m=e.left,w=e.top,r=t.right,n=t.bottom,u=e.left,g=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${s}px`),this.style.setProperty("--hover-bridge-top-left-y",`${h}px`),this.style.setProperty("--hover-bridge-top-right-x",`${m}px`),this.style.setProperty("--hover-bridge-top-right-y",`${w}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${r}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${u}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${g}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||bl(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=dl(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[ul({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Xr({apply:({rects:i})=>{const s=this.sync==="width"||this.sync==="both",h=this.sync==="height"||this.sync==="both";this.popup.style.width=s?`${i.reference.width}px`:"",this.popup.style.height=h?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(fl({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(pl({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Xr({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:s})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${s}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(gl({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?i=>rs.getOffsetParent(i,vl):rs.getOffsetParent;ml(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Pi(St({},rs),{getOffsetParent:t})}).then(({x:i,y:s,middlewareData:h,placement:m})=>{const w=this.localize.dir()==="rtl",r={top:"bottom",right:"left",bottom:"top",left:"right"}[m.split("-")[0]];if(this.setAttribute("data-current-placement",m),Object.assign(this.popup.style,{left:`${i}px`,top:`${s}px`}),this.arrow){const n=h.arrow.x,u=h.arrow.y;let g="",l="",f="",b="";if(this.arrowPlacement==="start"){const C=typeof n=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";g=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",l=w?C:"",b=w?"":C}else if(this.arrowPlacement==="end"){const C=typeof n=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";l=w?"":C,b=w?C:"",f=typeof u=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(b=typeof n=="number"?"calc(50% - var(--arrow-size-diagonal))":"",g=typeof u=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(b=typeof n=="number"?`${n}px`:"",g=typeof u=="number"?`${u}px`:"");Object.assign(this.arrowEl.style,{top:g,right:l,bottom:f,left:b,[r]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return V`
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Go=Symbol.for(""),El=e=>{if((e==null?void 0:e.r)===Go)return e==null?void 0:e._$litStatic$},ds=(e,...t)=>({_$litStatic$:t.reduce((i,s,h)=>i+(m=>{if(m._$litStatic$!==void 0)return m._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${m}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+e[h+1],e[0]),r:Go}),Yr=new Map,Al=e=>(t,...i)=>{const s=i.length;let h,m;const w=[],r=[];let n,u=0,g=!1;for(;u<s;){for(n=t[u];u<s&&(m=i[u],(h=El(m))!==void 0);)n+=h+t[++u],g=!0;u!==s&&r.push(m),w.push(n),u++}if(u===s&&w.push(t[s]),g){const l=w.join("$$lit$$");(t=Yr.get(l))===void 0&&(w.raw=w,Yr.set(l,t=w)),i=r}return e(t,...i)},Ai=Al(V);var De=class extends J{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?ds`a`:ds`button`;return Ai`
      <${t}
        part="base"
...
`,Vi=class extends J{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("sl-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(i=>this.resizeObserver.unobserve(i)),this.observedElements=[],t.forEach(i=>{this.resizeObserver.observe(i),this.observedElements.push(i)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return V` <slot @slotchange=${this.handleSlotChange}></slot> `}};Vi.styles=[ie,$l];_([A({type:Boolean,reflect:!0})],Vi.prototype,"disabled",2);_([q("disabled",{waitUntilFirstUpdate:!0})],Vi.prototype,"handleDisabledChange",1);function Bl(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var Js=new Set;function Ol(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function Ml(){const e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}function Li(e){if(Js.add(e),!document.documentElement.classList.contains("sl-scroll-lock")){const t=Ol()+Ml();let i=getComputedStyle(document.documentElement).scrollbarGutter;(!i||i==="auto")&&(i="stable"),t<2&&(i=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",i),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${t}px`)}}function Di(e){Js.delete(e),Js.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function Zs(e,t,i="vertical",s="smooth"){const h=Bl(e,t),m=h.top+t.scrollTop,w=h.left+t.scrollLeft,r=t.scrollLeft,n=t.scrollLeft+t.offsetWidth,u=t.scrollTop,g=t.scrollTop+t.offsetHeight;(i==="horizontal"||i==="both")&&(w<r?t.scrollTo({left:w,behavior:s}):w+e.clientWidth>n&&t.scrollTo({left:w-t.offsetWidth+e.clientWidth,behavior:s})),(i==="vertical"||i==="both")&&(m<u?t.scrollTo({top:m,behavior:s}):m+e.clientHeight>g&&t.scrollTo({top:m-t.offsetHeight+e.clientHeight,behavior:s}))}var Me=class extends J{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new ce(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){const e=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(t=>{const i=t.filter(({target:s})=>{if(s===this)return!0;if(s.closest("sl-tab-group")!==this)return!1;const h=s.tagName.toLowerCase();return h==="sl-tab"||h==="sl-tab-panel"});if(i.length!==0){if(i.some(s=>!["aria-labelledby","aria-controls"].includes(s.attributeName))&&setTimeout(()=>this.setAriaLabels()),i.some(s=>s.attributeName==="disabled"))this.syncTabsAndPanels();else if(i.some(s=>s.attributeName==="active")){const h=i.filter(m=>m.attributeName==="active"&&m.target.tagName.toLowerCase()==="sl-tab").map(m=>m.target).find(m=>m.active);h&&this.setActiveTab(h)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:["active","disabled","name","panel"],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((i,s)=>{var h;i[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab((h=this.getActiveTab())!=null?h:this.tabs[0],{emitEvents:!1}),s.unobserve(i[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect(),this.nav&&((t=this.resizeObserver)==null||t.unobserve(this.nav))}getAllTabs(){return this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()}getAllPanels(){return[...this.body.assignedElements()].filter(e=>e.tagName.toLowerCase()==="sl-tab-panel")}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){const i=e.target.closest("sl-tab");(i==null?void 0:i.closest("sl-tab-group"))===this&&i!==null&&this.setActiveTab(i,{scrollBehavior:"smooth"})}handleKeyDown(e){const i=e.target.closest("sl-tab");if((i==null?void 0:i.closest("sl-tab-group"))===this&&(["Enter"," "].includes(e.key)&&i!==null&&(this.setActiveTab(i,{scrollBehavior:"smooth"}),e.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key))){const h=this.tabs.find(r=>r.matches(":focus")),m=this.localize.dir()==="rtl";let w=null;if((h==null?void 0:h.tagName.toLowerCase())==="sl-tab"){if(e.key==="Home")w=this.focusableTabs[0];else if(e.key==="End")w=this.focusableTabs[this.focusableTabs.length-1];else if(["top","bottom"].includes(this.placement)&&e.key===(m?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&e.key==="ArrowUp"){const r=this.tabs.findIndex(n=>n===h);w=this.findNextFocusableTab(r,"backward")}else if(["top","bottom"].includes(this.placement)&&e.key===(m?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&e.key==="ArrowDown"){const r=this.tabs.findIndex(n=>n===h);w=this.findNextFocusableTab(r,"forward")}if(!w)return;w.tabIndex=0,w.focus({preventScroll:!0}),this.activation==="auto"?this.setActiveTab(w,{scrollBehavior:"smooth"}):this.tabs.forEach(r=>{r.tabIndex=r===w?0:-1}),["top","bottom"].includes(this.placement)&&Zs(w,this.nav,"horizontal"),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(e,t){if(t=St({emitEvents:!0,scrollBehavior:"auto"},t),e!==this.activeTab&&!e.disabled){const i=this.activeTab;this.activeTab=e,this.tabs.forEach(s=>{s.active=s===this.activeTab,s.tabIndex=s===this.activeTab?0:-1}),this.panels.forEach(s=>{var h;return s.active=s.name===((h=this.activeTab)==null?void 0:h.panel)}),this.syncIndicator(),["top","bottom"].includes(this.placement)&&Zs(this.activeTab,this.nav,"horizontal",t.scrollBehavior),t.emitEvents&&(i&&this.emit("sl-tab-hide",{detail:{name:i.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{const t=this.panels.find(i=>i.name===e.panel);t&&(e.setAttribute("aria-controls",t.getAttribute("id")),t.setAttribute("aria-labelledby",e.getAttribute("id")))})}repositionIndicator(){const e=this.getActiveTab();if(!e)return;const t=e.clientWidth,i=e.clientHeight,s=this.localize.dir()==="rtl",h=this.getAllTabs(),w=h.slice(0,h.indexOf(e)).reduce((r,n)=>({left:r.left+n.clientWidth,top:r.top+n.clientHeight}),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${t}px`,this.indicator.style.height="auto",this.indicator.style.translate=s?`${-1*w.left}px`:`${w.left}px`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${i}px`,this.indicator.style.translate=`0 ${w.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let i=null;const s=t==="forward"?1:-1;let h=e+s;for(;e<this.tabs.length;){if(i=this.tabs[h]||null,i===null){t==="forward"?i=this.focusableTabs[0]:i=this.focusableTabs[this.focusableTabs.length-1];break}if(!i.disabled)break;h+=s}return i}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(e){const t=this.tabs.find(i=>i.panel===e);t&&this.setActiveTab(t,{scrollBehavior:"smooth"})}render(){const e=this.localize.dir()==="rtl";return V`
    ...
    `}};Me.styles=[ie,Rl];Me.dependencies={"sl-icon-button":De,"sl-resize-observer":Vi};_([K(".tab-group")],Me.prototype,"tabGroup",2);_([K(".tab-group__body")],Me.prototype,"body",2);_([K(".tab-group__nav")],Me.prototype,"nav",2);_([K(".tab-group__indicator")],Me.prototype,"indicator",2);_([ee()],Me.prototype,"hasScrollControls",2);_([ee()],Me.prototype,"shouldHideScrollStartButton",2);_([ee()],Me.prototype,"shouldHideScrollEndButton",2);_([A()],Me.prototype,"placement",2);_([A()],Me.prototype,"activation",2);_([A({attribute:"no-scroll-controls",type:Boolean})],Me.prototype,"noScrollControls",2);_([A({attribute:"fixed-scroll-controls",type:Boolean})],Me.prototype,"fixedScrollControls",2);_([zi({passive:!0})],Me.prototype,"updateScrollButtons",1);_([q("noScrollControls",{waitUntilFirstUpdate:!0})],Me.prototype,"updateScrollControls",1);_([q("placement",{waitUntilFirstUpdate:!0})],Me.prototype,"syncIndicator",1);Me.define("sl-tab-group");var Pl=Q`
  :host {
    --border-radius: var(--sl-border-radius-pill);
...
`,mr=class extends J{constructor(){super(...arguments),this.effect="none"}render(){return V`
    ...
    `}};mr.styles=[ie,Pl];_([A()],mr.prototype,"effect",2);mr.define("sl-skeleton");var Il=Q`
  :host {
    --divider-width: 4px;
...
`;function Ti(e,t){function i(h){const m=e.getBoundingClientRect(),w=e.ownerDocument.defaultView,r=m.left+w.scrollX,n=m.top+w.scrollY,u=h.pageX-r,g=h.pageY-n;t!=null&&t.onMove&&t.onMove(u,g)}function s(){document.removeEventListener("pointermove",i),document.removeEventListener("pointerup",s),t!=null&&t.onStop&&t.onStop()}document.addEventListener("pointermove",i,{passive:!0}),document.addEventListener("pointerup",s),(t==null?void 0:t.initialEvent)instanceof PointerEvent&&i(t.initialEvent)}var Jr=()=>null,Ge=class extends J{constructor(){super(...arguments),this.isCollapsed=!1,this.localize=new ce(this),this.positionBeforeCollapsing=0,this.position=50,this.vertical=!1,this.disabled=!1,this.snapValue="",this.snapFunction=Jr,this.snapThreshold=12}toSnapFunction(e){const t=e.split(" ");return({pos:i,size:s,snapThreshold:h,isRtl:m,vertical:w})=>{let r=i,n=Number.POSITIVE_INFINITY;return t.forEach(u=>{let g;if(u.startsWith("repeat(")){const f=e.substring(7,e.length-1),b=f.endsWith("%"),C=Number.parseFloat(f),S=b?s*(C/100):C;g=Math.round((m&&!w?s-i:i)/S)*S}else u.endsWith("%")?g=s*(Number.parseFloat(u)/100):g=Number.parseFloat(u);m&&!w&&(g=s-g);const l=Math.abs(i-g);l<=h&&l<n&&(r=g,n=l)}),r}}set snap(e){this.snapValue=e!=null?e:"",e?this.snapFunction=typeof e=="string"?this.toSnapFunction(e):e:this.snapFunction=Jr}get snap(){return this.snapValue}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>this.handleResize(e)),this.updateComplete.then(()=>this.resizeObserver.observe(this)),this.detectSize(),this.cachedPositionInPixels=this.percentageToPixels(this.position)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.resizeObserver)==null||e.unobserve(this)}detectSize(){const{width:e,height:t}=this.getBoundingClientRect();this.size=this.vertical?t:e}percentageToPixels(e){return this.size*(e/100)}pixelsToPercentage(e){return e/this.size*100}handleDrag(e){const t=this.localize.dir()==="rtl";this.disabled||(e.cancelable&&e.preventDefault(),Ti(this,{onMove:(i,s)=>{var h;let m=this.vertical?s:i;this.primary==="end"&&(m=this.size-m),m=(h=this.snapFunction({pos:m,size:this.size,snapThreshold:this.snapThreshold,isRtl:t,vertical:this.vertical}))!=null?h:m,this.position=Ee(this.pixelsToPercentage(m),0,100)},initialEvent:e}))}handleKeyDown(e){if(!this.disabled&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End","Enter"].includes(e.key)){let t=this.position;const i=(e.shiftKey?10:1)*(this.primary==="end"?-1:1);if(e.preventDefault(),(e.key==="ArrowLeft"&&!this.vertical||e.key==="ArrowUp"&&this.vertical)&&(t-=i),(e.key==="ArrowRight"&&!this.vertical||e.key==="ArrowDown"&&this.vertical)&&(t+=i),e.key==="Home"&&(t=this.primary==="end"?100:0),e.key==="End"&&(t=this.primary==="end"?0:100),e.key==="Enter")if(this.isCollapsed)t=this.positionBeforeCollapsing,this.isCollapsed=!1;else{const s=this.position;t=0,requestAnimationFrame(()=>{this.isCollapsed=!0,this.positionBeforeCollapsing=s})}this.position=Ee(t,0,100)}}handleResize(e){const{width:t,height:i}=e[0].contentRect;this.size=this.vertical?i:t,(isNaN(this.cachedPositionInPixels)||this.position===1/0)&&(this.cachedPositionInPixels=Number(this.getAttribute("position-in-pixels")),this.positionInPixels=Number(this.getAttribute("position-in-pixels")),this.position=this.pixelsToPercentage(this.positionInPixels)),this.primary&&(this.position=this.pixelsToPercentage(this.cachedPositionInPixels))}handlePositionChange(){this.cachedPositionInPixels=this.percentageToPixels(this.position),this.isCollapsed=!1,this.positionBeforeCollapsing=0,this.positionInPixels=this.percentageToPixels(this.position),this.emit("sl-reposition")}handlePositionInPixelsChange(){this.position=this.pixelsToPercentage(this.positionInPixels)}handleVerticalChange(){this.detectSize()}render(){const e=this.vertical?"gridTemplateRows":"gridTemplateColumns",t=this.vertical?"gridTemplateColumns":"gridTemplateRows",i=this.localize.dir()==="rtl",s=`
    ...
    `,h="auto";return this.primary==="end"?i&&!this.vertical?this.style[e]=`${s} var(--divider-width) ${h}`:this.style[e]=`${h} var(--divider-width) ${s}`:i&&!this.vertical?this.style[e]=`${h} var(--divider-width) ${s}`:this.style[e]=`${s} var(--divider-width) ${h}`,this.style[t]="",V`
...
`,Kt=class extends J{constructor(){super(...arguments),this.disableRole=!1,this.label=""}handleFocus(e){const t=yi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--focus",!0)}handleBlur(e){const t=yi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--focus",!1)}handleMouseOver(e){const t=yi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--hover",!0)}handleMouseOut(e){const t=yi(e.target);t==null||t.toggleAttribute("data-sl-button-group__button--hover",!1)}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})];e.forEach(t=>{const i=e.indexOf(t),s=yi(t);s&&(s.toggleAttribute("data-sl-button-group__button",!0),s.toggleAttribute("data-sl-button-group__button--first",i===0),s.toggleAttribute("data-sl-button-group__button--inner",i>0&&i<e.length-1),s.toggleAttribute("data-sl-button-group__button--last",i===e.length-1),s.toggleAttribute("data-sl-button-group__button--radio",s.tagName.toLowerCase()==="sl-radio-button"))})}render(){return V`
    ...
    `}};Pe.styles=[ie,Vt,jl];Pe.dependencies={"sl-button-group":Kt};_([K("slot:not([name])")],Pe.prototype,"defaultSlot",2);_([K(".radio-group__validation-input")],Pe.prototype,"validationInput",2);_([ee()],Pe.prototype,"hasButtonGroup",2);_([ee()],Pe.prototype,"errorMessage",2);_([ee()],Pe.prototype,"defaultValue",2);_([A()],Pe.prototype,"label",2);_([A({attribute:"help-text"})],Pe.prototype,"helpText",2);_([A()],Pe.prototype,"name",2);_([A({reflect:!0})],Pe.prototype,"value",2);_([A({reflect:!0})],Pe.prototype,"size",2);_([A({reflect:!0})],Pe.prototype,"form",2);_([A({type:Boolean,reflect:!0})],Pe.prototype,"required",2);_([q("size",{waitUntilFirstUpdate:!0})],Pe.prototype,"handleSizeChange",1);_([q("value")],Pe.prototype,"handleValueChange",1);Pe.define("sl-radio-group");var Kl=Q`
  :host {
    --size: 128px;
    --track-width: 4px;
    --track-color: var(--sl-color-neutral-200);
...
`,Fs=new Map;function fc(e,t="cors"){const i=Fs.get(e);if(i!==void 0)return Promise.resolve(i);const s=fetch(e,{mode:t}).then(async h=>{const m={ok:h.ok,status:h.status,html:await h.text()};return Fs.set(e,m),m});return Fs.set(e,s),s}var ci=class extends J{constructor(){super(...arguments),this.mode="cors",this.allowScripts=!1}executeScript(e){const t=document.createElement("script");[...e.attributes].forEach(i=>t.setAttribute(i.name,i.value)),t.textContent=e.textContent,e.parentNode.replaceChild(t,e)}async handleSrcChange(){try{const e=this.src,t=await fc(e,this.mode);if(e!==this.src)return;if(!t.ok){this.emit("sl-error",{detail:{status:t.status}});return}this.innerHTML=t.html,this.allowScripts&&[...this.querySelectorAll("script")].forEach(i=>this.executeScript(i)),this.emit("sl-load")}catch{this.emit("sl-error",{detail:{status:-1}})}}render(){return V`<slot></slot>`}};ci.styles=[ie,pc];_([A()],ci.prototype,"src",2);_([A()],ci.prototype,"mode",2);_([A({attribute:"allow-scripts",type:Boolean})],ci.prototype,"allowScripts",2);_([q("src")],ci.prototype,"handleSrcChange",1);ci.define("sl-include");ge.define("sl-icon");De.define("sl-icon-button");var bs=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.value=0,this.unit="byte",this.display="short"}render(){if(isNaN(this.value))return"";const e=["","kilo","mega","giga","tera"],t=["","kilo","mega","giga","tera","peta"],i=this.unit==="bit"?e:t,s=Math.max(0,Math.min(Math.floor(Math.log10(this.value)/3),i.length-1)),h=i[s]+this.unit,m=parseFloat((this.value/Math.pow(1e3,s)).toPrecision(3));return this.localize.number(m,{style:"unit",unit:h,unitDisplay:this.display})}};_([A({type:Number})],bs.prototype,"value",2);_([A()],bs.prototype,"unit",2);_([A()],bs.prototype,"display",2);bs.define("sl-format-bytes");var Je=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.date=new Date,this.hourFormat="auto"}render(){const e=new Date(this.date),t=this.hourFormat==="auto"?void 0:this.hourFormat==="12";if(!isNaN(e.getMilliseconds()))return V`
...
`,Ie=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.open=!1,this.placement="bottom-start",this.disabled=!1,this.stayOpenOnSelect=!1,this.distance=0,this.skidding=0,this.hoist=!1,this.sync=void 0,this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&(e.stopPropagation(),this.hide(),this.focusOnTrigger())},this.handleDocumentKeyDown=e=>{var t;if(e.key==="Escape"&&this.open&&!this.closeWatcher){e.stopPropagation(),this.focusOnTrigger(),this.hide();return}if(e.key==="Tab"){if(this.open&&((t=document.activeElement)==null?void 0:t.tagName.toLowerCase())==="sl-menu-item"){e.preventDefault(),this.hide(),this.focusOnTrigger();return}const i=(s,h)=>{if(!s)return null;const m=s.closest(h);if(m)return m;const w=s.getRootNode();return w instanceof ShadowRoot?i(w.host,h):null};setTimeout(()=>{var s;const h=((s=this.containingElement)==null?void 0:s.getRootNode())instanceof ShadowRoot?sn():document.activeElement;(!this.containingElement||i(h,this.containingElement.tagName.toLowerCase())!==this.containingElement)&&this.hide()})}},this.handleDocumentMouseDown=e=>{const t=e.composedPath();this.containingElement&&!t.includes(this.containingElement)&&this.hide()},this.handlePanelSelect=e=>{const t=e.target;!this.stayOpenOnSelect&&t.tagName.toLowerCase()==="sl-menu"&&(this.hide(),this.focusOnTrigger())}}connectedCallback(){super.connectedCallback(),this.containingElement||(this.containingElement=this)}firstUpdated(){this.panel.hidden=!this.open,this.open&&(this.addOpenListeners(),this.popup.active=!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeOpenListeners(),this.hide()}focusOnTrigger(){const e=this.trigger.assignedElements({flatten:!0})[0];typeof(e==null?void 0:e.focus)=="function"&&e.focus()}getMenu(){return this.panel.assignedElements({flatten:!0}).find(e=>e.tagName.toLowerCase()==="sl-menu")}handleTriggerClick(){this.open?this.hide():(this.show(),this.focusOnTrigger())}async handleTriggerKeyDown(e){if([" ","Enter"].includes(e.key)){e.preventDefault(),this.handleTriggerClick();return}const t=this.getMenu();if(t){const i=t.getAllItems(),s=i[0],h=i[i.length-1];["ArrowDown","ArrowUp","Home","End"].includes(e.key)&&(e.preventDefault(),this.open||(this.show(),await this.updateComplete),i.length>0&&this.updateComplete.then(()=>{(e.key==="ArrowDown"||e.key==="Home")&&(t.setCurrentItem(s),s.focus()),(e.key==="ArrowUp"||e.key==="End")&&(t.setCurrentItem(h),h.focus())}))}}handleTriggerKeyUp(e){e.key===" "&&e.preventDefault()}handleTriggerSlotChange(){this.updateAccessibleTrigger()}updateAccessibleTrigger(){const t=this.trigger.assignedElements({flatten:!0}).find(s=>yc(s).start);let i;if(t){switch(t.tagName.toLowerCase()){case"sl-button":case"sl-icon-button":i=t.button;break;default:i=t}i.setAttribute("aria-haspopup","true"),i.setAttribute("aria-expanded",this.open?"true":"false")}}async show(){if(!this.open)return this.open=!0,He(this,"sl-after-show")}async hide(){if(!!this.open)return this.open=!1,He(this,"sl-after-hide")}reposition(){this.popup.reposition()}addOpenListeners(){var e;this.panel.addEventListener("sl-select",this.handlePanelSelect),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide(),this.focusOnTrigger()}):this.panel.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){var e;this.panel&&(this.panel.removeEventListener("sl-select",this.handlePanelSelect),this.panel.removeEventListener("keydown",this.handleKeyDown)),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.disabled){this.open=!1;return}if(this.updateAccessibleTrigger(),this.open){this.emit("sl-show"),this.addOpenListeners(),await Ae(this),this.panel.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=_e(this,"dropdown.show",{dir:this.localize.dir()});await Ce(this.popup.popup,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await Ae(this);const{keyframes:e,options:t}=_e(this,"dropdown.hide",{dir:this.localize.dir()});await Ce(this.popup.popup,e,t),this.panel.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}render(){return V`
      <sl-popup
        part="base"
...
`,Re=class extends J{constructor(){super(...arguments),this.localize=new ce(this),this.isCopying=!1,this.status="rest",this.value="",this.from="",this.disabled=!1,this.copyLabel="",this.successLabel="",this.errorLabel="",this.feedbackDuration=1e3,this.tooltipPlacement="top",this.hoist=!1}async handleCopy(){if(this.disabled||this.isCopying)return;this.isCopying=!0;let e=this.value;if(this.from){const t=this.getRootNode(),i=this.from.includes("."),s=this.from.includes("[")&&this.from.includes("]");let h=this.from,m="";i?[h,m]=this.from.trim().split("."):s&&([h,m]=this.from.trim().replace(/\]$/,"").split("["));const w="getElementById"in t?t.getElementById(h):null;w?s?e=w.getAttribute(m)||"":i?e=w[m]||"":e=w.textContent||"":(this.showStatus("error"),this.emit("sl-error"))}if(!e)this.showStatus("error"),this.emit("sl-error");else try{await navigator.clipboard.writeText(e),this.showStatus("success"),this.emit("sl-copy",{detail:{value:e}})}catch{this.showStatus("error"),this.emit("sl-error")}}async showStatus(e){const t=this.copyLabel||this.localize.term("copy"),i=this.successLabel||this.localize.term("copied"),s=this.errorLabel||this.localize.term("error"),h=e==="success"?this.successIcon:this.errorIcon,m=_e(this,"copy.in",{dir:"ltr"}),w=_e(this,"copy.out",{dir:"ltr"});this.tooltip.content=e==="success"?i:s,await this.copyIcon.animate(w.keyframes,w.options).finished,this.copyIcon.hidden=!0,this.status=e,h.hidden=!1,await h.animate(m.keyframes,m.options).finished,setTimeout(async()=>{await h.animate(w.keyframes,w.options).finished,h.hidden=!0,this.status="rest",this.copyIcon.hidden=!1,await this.copyIcon.animate(m.keyframes,m.options).finished,this.tooltip.content=t,this.isCopying=!1},this.feedbackDuration)}render(){const e=this.copyLabel||this.localize.term("copy");return V`
      <sl-tooltip
      ...
      >
        ...
        ${i.length>0?V`
              <div part="swatches" class="color-picker__swatches">
                ${i.map(h=>{const m=this.parseColor(h);return m?V`
                    <div
                      part="swatch"
